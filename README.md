...
unified-ai/
├── src/
│   ├── orchestrator/      # Brain logic & Automation Gateways
│   │   ├── workflows/     # n8n ecosystem
│   │   ├── activepieces/  # Activepieces nodes
│   │   ├── huginn/        # Huginn web agents
│   │   ├── agents/        # Claude-agents marketplace
│   │   ├── MetaGPT/       # MetaGPT multi-agent framework
│   │   └── awesome-llm-apps/ # Streamlit templates
│   ├── memory/            # RAG & Semantic Search (claude-context + RAG-Anything)
│   ├── skills/            # Domain toolkits (Hackingtool + ml-intern + mattpocock-skills)
