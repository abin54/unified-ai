...
* **Source**: `src/orchestrator`, `src/orchestrator/huginn`, `src/orchestrator/agents`, `src/orchestrator/MetaGPT`, `src/orchestrator/awesome-llm-apps`, `src/skills/mattpocock-skills`
* **Capabilities**: Complex refactoring, architectural design, debugging, cross-language integration (Python/TS), advanced agent reasoning (Hermes/AutoGPT), and workflow optimization (PRDs, TDD, Issue Triage).
