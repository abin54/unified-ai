...
Usage (process-global switch)::
    ...
    from src.memory.rag_anything.prompt_manager import set_prompt_language, get_prompt_language
...
def _lazy_load_language(lang: str) -> Dict[str, Any]:
    ...
    if lang == "zh":
        from src.memory.rag_anything.prompts_zh import PROMPTS_ZH
...
def register_prompt_language(language_code: str, prompts: Dict[str, Any]) -> None:
    ...
    Example::
        ...
        from src.memory.rag_anything.prompt_manager import register_prompt_language
