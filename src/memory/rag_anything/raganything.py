...
from src.memory.lightrag import LightRAG
from src.memory.lightrag.utils import logger

# Import configuration and modules
from src.memory.rag_anything.config import RAGAnythingConfig
from src.memory.rag_anything.query import QueryMixin
from src.memory.rag_anything.processor import ProcessorMixin
from src.memory.rag_anything.batch import BatchMixin
from src.memory.rag_anything.utils import get_processor_supports
from src.memory.rag_anything.parser import MineruParser, SUPPORTED_PARSERS, get_parser
from src.memory.rag_anything.callbacks import CallbackManager

# Import specialized processors
from src.memory.rag_anything.modalprocessors import (
    ImageModalProcessor,
    TableModalProcessor,
...
class RAGAnything(QueryMixin, ProcessorMixin, BatchMixin):
    ...
    async def _ensure_lightrag_initialized(self):
        ...
        try:
            ...
            if self.lightrag is not None:
                ...
                try:
                    ...
                    if (
                        ...
                        from src.memory.lightrag.kg.shared_storage import (
            ...
            from src.memory.lightrag.kg.shared_storage import initialize_pipeline_status
