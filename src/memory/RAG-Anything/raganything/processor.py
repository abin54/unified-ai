...
from src.memory.rag_anything.base import DocStatus
from src.memory.rag_anything.parser import MineruParser, MineruExecutionError, get_parser
from src.memory.rag_anything.utils import (
    separate_content,
    insert_text_content,
...
import asyncio
from src.memory.lightrag.utils import compute_mdhash_id
...
class ProcessorMixin:
    ...
    async def _process_multimodal_content_individual(
        ...
        if all_chunk_results:
            from src.memory.lightrag.operate import merge_nodes_and_edges
    ...
    def _apply_chunk_template(
        ...
        """
        from src.memory.rag_anything.prompt import PROMPTS
    ...
    async def _batch_extract_entities_lightrag_style_type_aware(
        ...
        from src.memory.lightrag.operate import extract_entities
