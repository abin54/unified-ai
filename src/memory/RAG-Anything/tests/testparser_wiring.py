...
from src.memory.rag_anything.batch_parser import BatchParser
...
def test_raganything_initializes_selected_parser(monkeypatch, tmp_path):
    ...
    import src.memory.rag_anything.raganything as rag_module
...
async def test_processor_parse_document_uses_selected_parser(monkeypatch, tmp_path):
    import src.memory.rag_anything.processor as processor_module
