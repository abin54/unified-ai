...
from src.memory.lightrag.llm.openai import openai_complete_if_cache, openai_embed
from src.memory.lightrag.utils import EmbeddingFunc, logger, set_verbose_debug
from src.memory.rag_anything import RAGAnything, RAGAnythingConfig
...
async def process_with_rag(
    ...
    try:
        ...
        from src.memory.lightrag.rerank import cohere_rerank
