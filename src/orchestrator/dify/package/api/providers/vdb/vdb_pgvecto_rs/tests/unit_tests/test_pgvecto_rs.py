...
def pgvecto_module(monkeypatch):
    ...
    import src.orchestrator.dify.package_vdb_pgvecto_rs.collection as collection_module
    import src.orchestrator.dify.package_vdb_pgvecto_rs.pgvecto_rs as module
