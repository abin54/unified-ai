...
class RemoteRecommendAppRetrieval(RecommendAppRetrievalBase):
    ...
    def get_recommend_app_detail(self, app_id: str):
        try:
            ...
            logger.warning("fetch recommended app detail from src.orchestrator.dify.package official failed: %s, switch to built-in.", e)
    ...
    def get_recommended_apps_and_categories(self, language: str):
        try:
            ...
            logger.warning("fetch recommended apps from src.orchestrator.dify.package official failed: %s, switch to built-in.", e)
    ...
    def fetch_recommended_app_detail_from_dify_official(cls, app_id: str) -> dict[str, Any] | None:
        """
        Fetch recommended app detail from src.orchestrator.dify.package official.
        :param app_id: App ID
        :return:
        """
    ...
    def fetch_recommended_apps_from_dify_official(cls, language: str):
        """
        Fetch recommended apps from src.orchestrator.dify.package official.
