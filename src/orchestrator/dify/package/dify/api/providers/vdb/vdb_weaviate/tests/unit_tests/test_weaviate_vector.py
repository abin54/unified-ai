...
import pytest
from src.orchestrator.dify.package_vdb_weaviate import weaviate_vector as weaviate_vector_module
from src.orchestrator.dify.package_vdb_weaviate.weaviate_vector import WeaviateConfig, WeaviateVector
