...
class RemotePipelineTemplateRetrieval(PipelineTemplateRetrievalBase):
    """
    Retrieval recommended app from src.orchestrator.dify.package official
    """
    ...
    def get_pipeline_template_detail(self, template_id: str) -> dict[str, Any] | None:
        try:
            ...
            logger.warning("fetch recommended app detail from src.orchestrator.dify.package official failed: %r, switch to database.", e)
    ...
    def get_pipeline_templates(self, language: str) -> dict[str, Any]:
        try:
            ...
            logger.warning("fetch pipeline templates from src.orchestrator.dify.package official failed: %r, switch to database.", e)
    ...
    def fetch_pipeline_template_detail_from_dify_official(cls, template_id: str) -> dict[str, Any]:
        """
        Fetch pipeline template detail from src.orchestrator.dify.package official.
    ...
    def fetch_pipeline_templates_from_dify_official(cls, language: str) -> dict[str, Any]:
        """
        Fetch pipeline templates from src.orchestrator.dify.package official.
