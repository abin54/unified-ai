...
from src.orchestrator.config import MCPServerConfig
from src.skills.ml.dataset_tools import (
    HF_INSPECT_DATASET_TOOL_SPEC,
    hf_inspect_dataset_handler,
)
from src.skills.ml.docs_tools import (
    EXPLORE_HF_DOCS_TOOL_SPEC,
    HF_DOCS_FETCH_TOOL_SPEC,
    explore_hf_docs_handler,
    hf_docs_fetch_handler,
)
from src.skills.ml.github_find_examples import (
    GITHUB_FIND_EXAMPLES_TOOL_SPEC,
    github_find_examples_handler,
)
from src.skills.ml.github_list_repos import (
    GITHUB_LIST_REPOS_TOOL_SPEC,
    github_list_repos_handler,
)
from src.skills.ml.github_read_file import (
    GITHUB_READ_FILE_TOOL_SPEC,
    github_read_file_handler,
)
from src.skills.ml.hf_repo_files_tool import (
    HF_REPO_FILES_TOOL_SPEC,
    hf_repo_files_handler,
)
from src.skills.ml.hf_repo_git_tool import (
    HF_REPO_GIT_TOOL_SPEC,
    hf_repo_git_handler,
)
from src.skills.ml.jobs_tool import HF_JOBS_TOOL_SPEC, hf_jobs_handler
from src.skills.ml.papers_tool import HF_PAPERS_TOOL_SPEC, hf_papers_handler
from src.skills.ml.plan_tool import PLAN_TOOL_SPEC, plan_tool_handler
from src.skills.ml.research_tool import RESEARCH_TOOL_SPEC, research_handler
from src.skills.ml.sandbox_tool import get_sandbox_tools

# NOTE: Private HF repo tool disabled - replaced by hf_repo_files and hf_repo_git
# from src.skills.ml.private_hf_repo_tools import (
...
def create_builtin_tools(local_mode: bool = False) -> list[ToolSpec]:
    ...
    if local_mode:
        from src.skills.ml.local_tools import get_local_tools
