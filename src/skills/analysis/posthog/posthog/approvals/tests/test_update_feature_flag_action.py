...
from src.skills.analysis.posthog.approvals.actions.feature_flags import UpdateFeatureFlagAction
from src.skills.analysis.posthog.approvals.models import ApprovalPolicy, ChangeRequest
from src.skills.analysis.posthog.approvals.policies import PolicyEngine
...
class TestCheckStaleness(APIBaseTest):
    ...
    def test_staleness_by_version(self, _name, stored_version, current_version, expected_stale):
        ...
        from src.skills.analysis.posthog.approvals.actions.feature_flags import EnableFeatureFlagAction
    ...
    def test_base_action_check_staleness_always_returns_false(self):
        from src.skills.analysis.posthog.approvals.actions.base import BaseAction
...
class TestActionRegistrationAndIntegration(APIBaseTest):
    def test_update_feature_flag_action_registered_in_registry(self):
        from src.skills.analysis.posthog.approvals.actions.registry import ACTION_REGISTRY, register_actions
