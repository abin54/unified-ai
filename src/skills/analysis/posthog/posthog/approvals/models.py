...
from src.skills.analysis.posthog.models.utils import CreatedMetaFields, UpdatedMetaFields, UUIDModel

if TYPE_CHECKING:
    from src.skills.analysis.posthog.approvals.actions.base import BaseAction
    from src.skills.analysis.posthog.approvals.models import ApprovalPolicy as ApprovalPolicyType
