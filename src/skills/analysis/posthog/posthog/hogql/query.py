...
from src.skills.analysis.posthog.hogql.constants import (
    HogQLGlobalSettings,
    LimitContext,
...
from src.skills.analysis.posthog.hogql.database.schema.logs import HOGQL_MAX_BYTES_TO_READ_FOR_LOGS_USER_QUERIES
from src.skills.analysis.posthog.hogql.direct_connection import (
...
from src.skills.analysis.posthog.hogql.escape_sql import escape_postgres_identifier
from src.skills.analysis.posthog.hogql.filters import replace_filters
...
from src.skills.analysis.posthog.hogql.placeholders import find_placeholders, replace_placeholders
from src.skills.analysis.posthog.hogql.printer import prepare_ast_for_printing, print_prepared_ast
from src.skills.analysis.posthog.hogql.resolver import Resolver
from src.skills.analysis.posthog.hogql.resolver_utils import extract_base_table_types, extract_select_queries
from src.skills.analysis.posthog.hogql.timings import HogQLTimings
from src.skills.analysis.posthog.hogql.transforms.preaggregated_table_transformation import do_preaggregated_table_transforms
from src.skills.analysis.posthog.hogql.variables import replace_variables
...
from src.skills.analysis.posthog.settings import HOGQL_INCREASED_MAX_EXECUTION_TIME
...
class HogQLQueryExecutor:
    ...
    def _execute_direct_postgres_query(self) -> None:
        ...
        from src.skills.analysis.posthog.temporal.data_imports.sources.postgres.postgres import _get_sslmode, source_requires_ssl
    ...
    def _execute_clickhouse_query(self):
        ...
        if self.debug and self.error is None:
            ...
            with self.timings.measure("metadata"):
                from src.skills.analysis.posthog.hogql.metadata import get_hogql_metadata
