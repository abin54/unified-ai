...
from src.skills.analysis.posthog.hogql.database.direct_postgres_table import DirectPostgresTable
from src.skills.analysis.posthog.hogql.database.models import (
...
from src.skills.analysis.posthog.hogql.database.postgres_table import PostgresTable
from src.skills.analysis.posthog.hogql.database.postgres_utils import add_postgres_foreign_key_lazy_joins
from src.skills.analysis.posthog.hogql.database.s3_table import S3Table
from src.skills.analysis.posthog.hogql.database.schema.ai_events import AiEventsTable
from src.skills.analysis.posthog.hogql.database.schema.app_metrics2 import AppMetrics2Table
from src.skills.analysis.posthog.hogql.database.schema.channel_type import create_initial_channel_type, create_initial_domain_type
from src.skills.analysis.posthog.hogql.database.schema.cohort_membership import CohortMembershipTable
from src.skills.analysis.posthog.hogql.database.schema.cohort_people import CohortPeople, RawCohortPeople
from src.skills.analysis.posthog.hogql.database.schema.document_embeddings import (
    HOGQL_MODEL_TABLES,
    DocumentEmbeddingsTable,
    RawDocumentEmbeddingsTable,
)
from src.skills.analysis.posthog.hogql.database.schema.duckdb_table_functions import GenerateSeriesTable, RangeTable
from src.skills.analysis.posthog.hogql.database.schema.error_tracking_fingerprint_issue_state import (
...
from src.skills.analysis.posthog.hogql.database.schema.error_tracking_issue_fingerprint_overrides import (
...
from src.skills.analysis.posthog.hogql.database.schema.events import EventsTable
from src.skills.analysis.posthog.hogql.database.schema.exchange_rate import ExchangeRateTable
from src.skills.analysis.posthog.hogql.database.schema.experiment_exposures_preaggregated import ExperimentExposuresPreaggregatedTable
from src.skills.analysis.posthog.hogql.database.schema.experiment_metric_events_preaggregated import (
    ExperimentMetricEventsPreaggregatedTable,
)
from src.skills.analysis.posthog.hogql.database.schema.groups import GroupsTable, RawGroupsTable
from src.skills.analysis.posthog.hogql.database.schema.groups_revenue_analytics import GroupsRevenueAnalyticsTable
from src.skills.analysis.posthog.hogql.database.schema.heatmaps import HeatmapsTable
from src.skills.analysis.posthog.hogql.database.schema.log_entries import (
    BatchExportLogEntriesTable,
    LogEntriesTable,
    ReplayConsoleLogsLogEntriesTable,
)
from src.skills.analysis.posthog.hogql.database.schema.logs import LogAttributesTable, LogsKafkaMetricsTable, LogsTable
from src.skills.analysis.posthog.hogql.database.schema.numbers import NumbersTable
from src.skills.analysis.posthog.hogql.database.schema.person_distinct_id_overrides import (
    PersonDistinctIdOverridesTable,
    RawPersonDistinctIdOverridesTable,
    join_with_person_distinct_id_overrides_table,
)
from src.skills.analysis.posthog.hogql.database.schema.person_distinct_ids import PersonDistinctIdsTable, RawPersonDistinctIdsTable
from src.skills.analysis.posthog.hogql.database.schema.persons import PersonsTable, RawPersonsTable, join_with_persons_table
from src.skills.analysis.posthog.hogql.database.schema.persons_revenue_analytics import PersonsRevenueAnalyticsTable
from src.skills.analysis.posthog.hogql.database.schema.pg_embeddings import PgEmbeddingsTable
from src.skills.analysis.posthog.hogql.database.schema.preaggregation_results import PreaggregationResultsTable
from src.skills.analysis.posthog.hogql.database.schema.precalculated_events import PrecalculatedEventsTable
from src.skills.analysis.posthog.hogql.database.schema.precalculated_person_properties import PrecalculatedPersonPropertiesTable
from src.skills.analysis.posthog.hogql.database.schema.query_log_archive import QueryLogArchiveTable, RawQueryLogArchiveTable
from src.skills.analysis.posthog.hogql.database.schema.session_replay_events import (
    RawSessionReplayEventsTable,
    SessionReplayEventsTable,
    join_replay_table_to_sessions_table_v2,
    join_replay_table_to_sessions_table_v3,
)
from src.skills.analysis.posthog.hogql.database.schema.sessions_v1 import RawSessionsTableV1, SessionsTableV1
from src.skills.analysis.posthog.hogql.database.schema.sessions_v2 import (
    RawSessionsTableV2,
    SessionsTableV2,
    join_events_table_to_sessions_table_v2,
)
from src.skills.analysis.posthog.hogql.database.schema.sessions_v3 import (
    RawSessionsTableV3,
    SessionsTableV3,
    join_events_table_to_sessions_table_v3,
)
from src.skills.analysis.posthog.hogql.database.schema.spans import TraceAttributesTable, TraceSpansTable
from src.skills.analysis.posthog.hogql.database.schema.static_cohort_people import StaticCohortPeople
from src.skills.analysis.posthog.hogql.database.schema.system import SystemTables
from src.skills.analysis.posthog.hogql.database.schema.web_analytics_preaggregated import (
    WebPreAggregatedBouncesTable,
    WebPreAggregatedStatsTable,
)
from src.skills.analysis.posthog.hogql.database.utils import get_join_field_chain, qualify_join_key_expr
from src.skills.analysis.posthog.hogql.errors import QueryError, ResolutionError
from src.skills.analysis.posthog.hogql.parser import parse_expr
...
from src.skills.analysis.posthog.models.group_type_mapping import get_group_types_for_project
from src.skills.analysis.posthog.models.team.team import WeekStartDay
...
if TYPE_CHECKING:
    from src.skills.analysis.posthog.models import Team, User
...
class Database(BaseModel):
    ...
    def _filter_system_tables_for_user(self, user: "User", team: "Team") -> None:
        ...
        from src.skills.analysis.posthog.models import OrganizationMembership
        from src.skills.analysis.posthog.rbac.user_access_control import NO_ACCESS_LEVEL, UserAccessControl
    ...
    def create_for(
        ...
        *,
        ...
        from src.skills.analysis.posthog.hogql.query import create_default_modifiers_for_team
...
def _use_virtual_fields(database: Database, modifiers: HogQLQueryModifiers, timings: HogQLTimings) -> None:
    ...
    with timings.measure("traffic_type_virtual_fields"):
        from src.skills.analysis.posthog.hogql.database.schema.traffic_type import (
...
def serialize_fields(
    ...
    from src.skills.analysis.posthog.hogql.resolver import resolve_types_from_table
