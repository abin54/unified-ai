...
import pytest
from src.skills.analysis.posthog.test.base import BaseTest, FuzzyInt, QueryMatchingTest, snapshot_postgres_queries
...
from src.skills.analysis.posthog.hogql.database.database import (
...
from src.skills.analysis.posthog.hogql.test.utils import pretty_print_in_tests

from src.skills.analysis.posthog.models.group_type_mapping import invalidate_group_types_cache
...
class TestDatabase(BaseTest, QueryMatchingTest):
    ...
    def test_posthog_qualified_table_names_resolve_in_select(self):
        ...
        prepare_and_print_ast(parse_select("select * from src.skills.analysis.posthog.events"), context, dialect="clickhouse")
