...
from src.skills.analysis.posthog.hogql.errors import NotImplementedError, ResolutionError

# Import Workload at module level for Pydantic (needed at runtime)
from src.skills.analysis.posthog.clickhouse.workload import Workload

if TYPE_CHECKING:
    from src.skills.analysis.posthog.hogql.ast import LazyJoinType, SelectQuery
    from src.skills.analysis.posthog.hogql.base import ConstantType
...
class DatabaseField(FieldOrTable):
    ...
    def get_constant_type(self) -> "ConstantType":
        from src.skills.analysis.posthog.hogql.ast import UnknownType
...
class IntegerDatabaseField(DatabaseField):
    def get_constant_type(self) -> "ConstantType":
        from src.skills.analysis.posthog.hogql.ast import IntegerType
...
class FloatDatabaseField(DatabaseField):
    def get_constant_type(self) -> "ConstantType":
        from src.skills.analysis.posthog.hogql.ast import FloatType
...
class DecimalDatabaseField(DatabaseField):
    def get_constant_type(self) -> "ConstantType":
        from src.skills.analysis.posthog.hogql.ast import DecimalType
...
class StringJSONDatabaseField(DatabaseField):
    def get_constant_type(self) -> "ConstantType":
        from src.skills.analysis.posthog.hogql.ast import StringJSONType
...
class StructDatabaseField(DatabaseField):
    ...
    def get_constant_type(self) -> "ConstantType":
        from src.skills.analysis.posthog.hogql.ast import TupleType
...
class StringArrayDatabaseField(DatabaseField):
    def get_constant_type(self) -> "ConstantType":
        from src.skills.analysis.posthog.hogql.ast import StringArrayType
...
class DateDatabaseField(DatabaseField):
    def get_constant_type(self) -> "ConstantType":
        from src.skills.analysis.posthog.hogql.ast import DateType
...
class DateTimeDatabaseField(DatabaseField):
    def get_constant_type(self) -> "ConstantType":
        from src.skills.analysis.posthog.hogql.ast import DateTimeType
...
class BooleanDatabaseField(DatabaseField):
    def get_constant_type(self) -> "ConstantType":
        from src.skills.analysis.posthog.hogql.ast import BooleanType
...
class UUIDDatabaseField(DatabaseField):
    def get_constant_type(self) -> "ConstantType":
        from src.skills.analysis.posthog.hogql.ast import UUIDType
