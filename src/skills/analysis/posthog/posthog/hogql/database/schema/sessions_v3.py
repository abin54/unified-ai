...
from src.skills.analysis.posthog.schema import CustomChannelRule
...
from src.skills.analysis.posthog.hogql.database.schema.sessions_v1 import DEFAULT_BOUNCE_RATE_DURATION_SECONDS
from src.skills.analysis.posthog.hogql.database.schema.util.where_clause_extractor import SessionMinTimestampWhereClauseExtractorV3
