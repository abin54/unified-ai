...
from src.skills.analysis.posthog.hogql.database.schema.groups import GroupsTable, join_with_group_n_table
...
from src.skills.analysis.posthog.hogql.database.schema.sessions_v1 import SessionsTableV1, join_events_table_to_sessions_table
