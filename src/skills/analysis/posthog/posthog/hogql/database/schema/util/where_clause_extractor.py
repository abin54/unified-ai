...
from src.skills.analysis.posthog.hogql.ast import CompareOperationOp
from src.skills.analysis.posthog.hogql.context import HogQLContext
from src.skills.analysis.posthog.hogql.database.models import DatabaseField, LazyJoin, LazyJoinToAdd, LazyTableToAdd
from src.skills.analysis.posthog.hogql.database.schema.util.uuid import (
...
from src.skills.analysis.posthog.hogql.functions.mapping import HOGQL_COMPARISON_MAPPING
from src.skills.analysis.posthog.hogql.helpers.timestamp_visitor import is_simple_timestamp_field_expression, is_time_or_interval_constant
...
class RewriteTimestampFieldVisitor(CloningVisitor):
    ...
    def visit_field(self, node: ast.Field) -> ast.Expr:
        from src.skills.analysis.posthog.hogql.database.schema.events import EventsTable
        from src.skills.analysis.posthog.hogql.database.schema.session_replay_events import RawSessionReplayEventsTable
        from src.skills.analysis.posthog.hogql.database.schema.sessions_v1 import SessionsTableV1
        from src.skills.analysis.posthog.hogql.database.schema.sessions_v2 import SessionsTableV2
        from src.skills.analysis.posthog.hogql.database.schema.sessions_v3 import SessionsTableV3
