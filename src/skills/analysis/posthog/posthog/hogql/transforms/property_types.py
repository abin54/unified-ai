...
from src.skills.analysis.posthog.hogql.database.models import BooleanDatabaseField, DateTimeDatabaseField
from src.skills.analysis.posthog.hogql.database.s3_table import S3Table
from src.skills.analysis.posthog.hogql.database.schema.events import (
    EVENTS_TABLE_TYPES,
    EventsGroupSubTable,
...
from src.skills.analysis.posthog.hogql.database.schema.persons import PersonsTable, RawPersonsTable
from src.skills.analysis.posthog.hogql.escape_sql import escape_hogql_identifier
from src.skills.analysis.posthog.hogql.visitor import CloningVisitor, TraversingVisitor
...
def build_property_swapper(node: ast.AST, context: HogQLContext) -> None:
    ...
    from src.skills.analysis.posthog.models.materialized_column_slots import MaterializedColumnSlot, MaterializedColumnSlotState
