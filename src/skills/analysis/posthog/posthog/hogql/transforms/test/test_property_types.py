...
class TestPropertyTypes(BaseTest):
    ...
    def test_resolve_property_types_from_qualified_posthog_events(self):
        ...
        qualified = self._print_select("select properties.$screen_width, properties.bool from src.skills.analysis.posthog.events")
...
class TestTimezoneIndexPruning(ClickhouseTestMixin, BaseTest):
    ...
    def test_alias_preserved_when_recursing_into_assumeNotNull(self):
        ...
        from src.skills.analysis.posthog.hogql import ast as ast_module
        from src.skills.analysis.posthog.hogql.transforms.property_types import PropertySwapper
