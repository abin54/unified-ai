...
import unittest
from src.skills.analysis.posthog.test.base import APIBaseTest, BaseTest, ClickhouseTestMixin, QueryMatchingTest, snapshot_clickhouse_queries

from parameterized import parameterized

from src.skills.analysis.posthog.schema import BaseMathType, DateRange, EventsNode, HogQLQueryModifiers, TrendsQuery
...
from src.skills.analysis.posthog.hogql.database.schema.web_analytics_preaggregated import WebPreAggregatedStatsTable
...
from src.skills.analysis.posthog.hogql.transforms.preaggregated_table_transformation import (
...
from src.skills.analysis.posthog.hogql_queries.web_analytics.pre_aggregated.properties import (
...
class TestPreaggregatedTableTransformation(BaseTest, QueryMatchingTest):
    ...
    def test_qualified_posthog_events_transforms(self):
        original_query = "select count() from src.skills.analysis.posthog.events where event = '$pageview'"
        query = self._parse_and_transform(original_query)
