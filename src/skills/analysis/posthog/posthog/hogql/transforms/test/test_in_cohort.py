import pytest
from src.skills.analysis.posthog.test.base import BaseTest, QueryMatchingTest, _create_event, _create_person

from django.test import override_settings

from src.skills.analysis.posthog.schema import HogQLQueryModifiers, InCohortVia, InlineCohortCalculation
