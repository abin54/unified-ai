...
from src.skills.analysis.posthog.hogql.database.models import LazyJoinToAdd, LazyTableToAdd
...
from src.skills.analysis.posthog.hogql.resolver_utils import get_long_table_name
