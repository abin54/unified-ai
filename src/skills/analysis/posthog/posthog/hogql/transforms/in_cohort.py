...
from src.skills.analysis.posthog.hogql.escape_sql import escape_clickhouse_string
...
class MultipleInCohortResolver(TraversingVisitor):
    ...
    def _add_join(
        ...
        if must_add_join:
            from src.skills.analysis.posthog.hogql.functions.cohort import inline_cohort_query
