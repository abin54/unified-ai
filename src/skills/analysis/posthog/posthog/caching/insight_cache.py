...
from src.skills.analysis.posthog.models import Insight, InsightCachingState
from src.skills.analysis.posthog.schema_migrations.upgrade_manager import upgrade_query
from src.skills.analysis.posthog.tasks.tasks import update_cache_task
...
def update_cached_state(
    ...
    if result is not None:  # This is particularly the case for HogQL-based queries, which cache.set() on their own
        from src.skills.analysis.posthog.caching.query_cache_routing import get_query_cache
