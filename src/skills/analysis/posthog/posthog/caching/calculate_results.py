...
from src.skills.analysis.posthog.schema import CacheMissResponse, DashboardFilter
...
from src.skills.analysis.posthog.clickhouse.query_tagging import get_team_query_tags, tag_queries
from src.skills.analysis.posthog.event_usage import AnalyticsProps
from src.skills.analysis.posthog.hogql_queries.query_runner import get_query_runner_or_none
from src.skills.analysis.posthog.models import Insight, Team, User
from src.skills.analysis.posthog.models.insight import generate_insight_filters_hash
...
def calculate_for_query_based_insight(
    ...
    *,
    ...
    from src.skills.analysis.posthog.caching.fetch_from_cache import InsightResult, NothingInCacheResult
    from src.skills.analysis.posthog.caching.insight_cache import update_cached_state
