...
from src.skills.analysis.posthog.cloud_utils import is_dev_mode
from src.skills.analysis.posthog.email import is_email_available, is_http_email_service_available
from src.skills.analysis.posthog.helpers.email_utils import ESPSuppressionReason, check_esp_suppression
...
from src.skills.analysis.posthog.settings.web import AUTHENTICATION_BACKENDS
...
class EmailMFAVerifier:
    ...
    def create_token_and_send_email_mfa_verification(self, request: HttpRequest, user: User) -> bool:
        from src.skills.analysis.posthog.tasks import email
