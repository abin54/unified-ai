...
from src.skills.analysis.posthog.management.migration_analysis.models import RiskLevel
...
class TestUnmanagedModels:
    def test_is_unmanaged_model_with_managed_false_option(self):
        ...
        from src.skills.analysis.posthog.management.migration_analysis.operations import is_unmanaged_model
