...
from src.skills.analysis.posthog.temporal.data_modeling import WORKFLOWS as DATA_MODELING_WORKFLOWS
...
from src.skills.analysis.posthog.temporal.llm_analytics import WORKFLOWS as LLM_ANALYTICS_WORKFLOWS
