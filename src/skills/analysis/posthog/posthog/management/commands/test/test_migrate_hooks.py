...
from src.skills.analysis.posthog.cdp.templates.zapier.template_zapier import template as template_zapier
from src.skills.analysis.posthog.management.commands.migrate_hooks import migrate_hooks
