...
import src.skills.analysis.posthog.management.commands.sync_persons_to_clickhouse
from src.skills.analysis.posthog.clickhouse.client import sync_execute
from src.skills.analysis.posthog.management.commands.sync_persons_to_clickhouse import (
    run,
...
from src.skills.analysis.posthog.models.person.person import Person, PersonDistinctId
