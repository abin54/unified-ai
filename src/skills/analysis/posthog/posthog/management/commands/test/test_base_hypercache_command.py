...
from src.skills.analysis.posthog.management.commands._base_hypercache_command import BaseHyperCacheCommand
...
class TestExpiryTrackingVerification(BaseTest):
    ...
    def test_batch_check_expiry_returns_all_true_when_no_expiry_key_configured(self):
        ...
        from src.skills.analysis.posthog.storage.hypercache_manager import batch_check_expiry_tracking
...
class TestGetTeamsQueryset(BaseTest):
    ...
    def test_config_queryset_fn_scopes_all_teams_path(self):
        ...
        from src.skills.analysis.posthog.models import Team as TeamModel
...
class TestFlagVerifyCommandScoping(BaseTest):
    ...
    def test_includes_teams_with_only_soft_deleted_flags(self):
        ...
        from src.skills.analysis.posthog.management.commands.verify_flags_cache import Command as VerifyFlagsCommand
    ...
    def test_flag_definitions_command_scopes_same_way(self):
        ...
        from src.skills.analysis.posthog.management.commands.verify_flag_definitions_cache import Command as VerifyFlagDefinitionsCommand
        from src.skills.analysis.posthog.models import Team as TeamModel
        from src.skills.analysis.posthog.models.feature_flag.feature_flag import FeatureFlag
