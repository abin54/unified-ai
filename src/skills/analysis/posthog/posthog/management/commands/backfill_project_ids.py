...
class Command(BaseCommand):
    help = "Backfill project_id in action tables from src.skills.analysis.posthog_team.project_id in batches"
    ...
    def update_with_sql(self, options):
        """
        Update project_id from src.skills.analysis.posthog_team.project_id in batches using PostgreSQL-optimized SQL.
        """
        total_updated = 0
        batch_count = 0
