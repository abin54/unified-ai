...
from src.skills.analysis.posthog.schema import DomainConnectProviderName
...
def resolve_email_context(integration_id: int, team_id: int) -> tuple[str, str, dict[str, str]]:
    ...
    """
    from src.skills.analysis.posthog.models.integration import EmailIntegration, Integration
