...
from src.skills.analysis.posthog.async_migrations.definition import AsyncMigrationDefinition, AsyncMigrationOperation
...
class TestAsyncMigrationDefinition(BaseTest):
    def test_get_async_migration_definition(self):
        from src.skills.analysis.posthog.async_migrations.examples.example import example_fn, example_rollback_fn
