...
from src.skills.analysis.posthog.settings import ASYNC_MIGRATIONS_DEFAULT_TIMEOUT_SECONDS
...
class AsyncMigrationOperationSQL(AsyncMigrationOperation):
    ...
    def _execute_op(self, query_id: str, sql: str, settings: Optional[dict]):
        from src.skills.analysis.posthog.async_migrations.utils import execute_op_clickhouse, execute_op_postgres
