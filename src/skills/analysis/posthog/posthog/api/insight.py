...
from src.skills.analysis.posthog.schema import ProductKey, QueryStatus

from src.skills.analysis.posthog.hogql.constants import BREAKDOWN_VALUES_LIMIT
from src.skills.analysis.posthog.hogql.errors import ExposedHogQLError
from src.skills.analysis.posthog.hogql.timings import HogQLTimings

from src.skills.analysis.posthog import schema
from src.skills.analysis.posthog.api.documentation import extend_schema, extend_schema_field, extend_schema_serializer
from src.skills.analysis.posthog.api.forbid_destroy_model import ForbidDestroyModel
from src.skills.analysis.posthog.api.insight_metadata import generate_insight_metadata
from src.skills.analysis.posthog.api.insight_suggestions import get_insight_analysis, get_insight_suggestions
from src.skills.analysis.posthog.api.insight_variable import map_stale_to_latest
from src.skills.analysis.posthog.api.monitoring import Feature, monitor
from src.skills.analysis.posthog.api.query_coalescer import QueryCoalescingMixin
...
from src.skills.analysis.posthog.api.services.query import process_query_dict, process_query_model
...
from src.skills.analysis.posthog.api.utils import action, format_paginated_url
from src.skills.analysis.posthog.auth import SharingAccessTokenAuthentication, SharingPasswordProtectedAuthentication
from src.skills.analysis.posthog.caching.fetch_from_cache import InsightResult, fetch_cached_response_by_key
from src.skills.analysis.posthog.clickhouse.cancel import cancel_query_on_cluster
from src.skills.analysis.posthog.clickhouse.client.limit import ConcurrencyLimitExceeded
from src.skills.analysis.posthog.constants import INSIGHT
from src.skills.analysis.posthog.errors import ExposedCHQueryError
from src.skills.analysis.posthog.event_usage import get_request_analytics_properties, report_user_action
from src.skills.analysis.posthog.helpers.multi_property_breakdown import protect_old_clients_from_multi_property_default
from src.skills.analysis.posthog.hogql_queries.apply_dashboard_filters import (
    WRAPPER_NODE_KINDS,
    apply_dashboard_filters_to_dict,
    apply_dashboard_variables_to_dict,
)
from src.skills.analysis.posthog.hogql_queries.legacy_compatibility.feature_flag import get_query_method, hogql_insights_replace_filters
from src.skills.analysis.posthog.hogql_queries.legacy_compatibility.filter_to_query import filter_to_query
from src.skills.analysis.posthog.hogql_queries.query_runner import (
    BLOCKING_EXECUTION_MODES,
    ExecutionMode,
    execution_mode_from_refresh,
    shared_insights_execution_mode,
)
from src.skills.analysis.posthog.kafka_client.topics import KAFKA_METRICS_TIME_TO_SEE_DATA
from src.skills.analysis.posthog.models import Cohort, Filter, Insight, User
from src.skills.analysis.posthog.models.activity_logging.activity_log import (
    Change,
    Detail,
    changes_between,
    describe_change,
...
from src.skills.analysis.posthog.models.activity_logging.activity_page import activity_page_response
from src.skills.analysis.posthog.models.alert import AlertConfiguration
from src.skills.analysis.posthog.models.filters.utils import get_filter
from src.skills.analysis.posthog.models.insight import InsightViewed
from src.skills.analysis.posthog.models.insight_variable import InsightVariable
from src.skills.analysis.posthog.models.organization import Organization
from src.skills.analysis.posthog.models.team.team import Team
from src.skills.analysis.posthog.models.utils import UUIDT
from src.skills.analysis.posthog.rate_limit import (
...
from src.skills.analysis.posthog.rbac.user_access_control import UserAccessControlError, UserAccessControlSerializerMixin
from src.skills.analysis.posthog.schema_migrations.upgrade import upgrade
from src.skills.analysis.posthog.schema_migrations.upgrade_manager import upgrade_query
from src.skills.analysis.posthog.settings import CAPTURE_TIME_TO_SEE_DATA, SITE_URL
from src.skills.analysis.posthog.user_permissions import UserPermissionsSerializerMixin
from src.skills.analysis.posthog.utils import (
...
class InsightSerializer(InsightBasicSerializer):
    ...
    def get_alerts(self, insight: Insight):
        ...
        from src.skills.analysis.posthog.api.alert import AlertSerializer
    ...
    def insight_result(self, insight: Insight) -> InsightResult:
        from src.skills.analysis.posthog.caching.calculate_results import calculate_for_query_based_insight
        ...
        for key in filters:
            if key == "saved":
                ...
                if str_to_bool(request.GET["hide_feature_flag_insights"]):
                    ...
                    from src.skills.analysis.posthog.helpers.dashboard_templates import (
...
When set, the specified dashboard's filters and date range override will be applied.""",
    ...
    def timing(self, request: request.Request, **kwargs):
        from src.skills.analysis.posthog.kafka_client.routing import get_producer
        from src.skills.analysis.posthog.models.event.util import format_clickhouse_timestamp
        from src.skills.analysis.posthog.utils import cast_timestamp_or_now
