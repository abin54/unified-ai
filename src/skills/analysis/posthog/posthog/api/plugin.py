...
from src.skills.analysis.posthoganalytics import capture_exception
...
from src.skills.analysis.posthog.api.hog_function import HogFunctionSerializer
...
from src.skills.analysis.posthog.cdp.templates import HOG_FUNCTION_MIGRATORS
from src.skills.analysis.posthog.event_usage import report_user_action
from src.skills.analysis.posthog.models import Plugin, PluginAttachment, PluginConfig, User
...
from src.skills.analysis.posthog.models.activity_logging.serializers import ActivityLogSerializer
from src.skills.analysis.posthog.models.organization import Organization
from src.skills.analysis.posthog.models.plugin import PluginSourceFile, transpile, update_validated_data_from_url
from src.skills.analysis.posthog.models.utils import generate_random_token
from src.skills.analysis.posthog.permissions import APIScopePermission
from src.skills.analysis.posthog.plugins import can_configure_plugins, can_install_plugins, parse_url
from src.skills.analysis.posthog.plugins.access import can_globally_manage_plugins, has_plugin_access_level
from src.skills.analysis.posthog.plugins.plugin_server_api import populate_plugin_capabilities_on_workers
from src.skills.analysis.posthog.queries.app_metrics.app_metrics import TeamPluginsDeliveryRateQuery
...
class PluginConfigSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data: dict, *args: Any, **kwargs: Any) -> PluginConfig:
        ...
        from src.skills.analysis.posthog.cdp.legacy_plugins import hog_function_from_plugin_config
        from src.skills.analysis.posthog.event_usage import report_team_action
