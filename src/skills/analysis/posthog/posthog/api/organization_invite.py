...
from src.skills.analysis.posthog.event_usage import report_bulk_invited, report_team_member_invited
...
from src.skills.analysis.posthog.rbac.user_access_control import UserAccessControl, ordered_access_levels
from src.skills.analysis.posthog.tasks.email import send_invite
...
class OrganizationInviteViewSet(
    ...
    def dangerously_get_permissions(self):
        ...
        if self.action == "destroy":
            ...
            from src.skills.analysis.posthog.permissions import OrganizationAdminWritePermissions
