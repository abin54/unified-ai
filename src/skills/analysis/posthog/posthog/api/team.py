...
from src.skills.analysis.posthog.schema import AttributionMode, HogQLQueryModifiers

from src.skills.analysis.posthog.api.routing import TeamAndOrgViewSetMixin
from src.skills.analysis.posthog.api.shared import TeamBasicSerializer
from src.skills.analysis.posthog.api.utils import action
from src.skills.analysis.posthog.auth import OAuthAccessTokenAuthentication, PersonalAPIKeyAuthentication, SessionAuthentication
from src.skills.analysis.posthog.constants import AvailableFeature
from src.skills.analysis.posthog.decorators import disallow_if_impersonated
from src.skills.analysis.posthog.event_usage import report_user_action
from src.skills.analysis.posthog.geoip import get_geoip_properties
from src.skills.analysis.posthog.jwt import PosthogJwtAudience, encode_jwt
from src.skills.analysis.posthog.models import ProductIntent, Team, TeamMarketingAnalyticsConfig, TeamRevenueAnalyticsConfig, User
...
from src.skills.analysis.posthog.models.data_color_theme import DataColorTheme
from src.skills.analysis.posthog.models.evaluation_context import EvaluationContext, TeamDefaultEvaluationContext, normalize_context_name
from src.skills.analysis.posthog.models.event_ingestion_restriction_config import EventIngestionRestrictionConfig
...
from src.skills.analysis.posthog.models.product_intent.product_intent import ProductIntentSerializer, calculate_product_activation
from src.skills.analysis.posthog.models.project import Project
from src.skills.analysis.posthog.models.team.extensions import get_or_create_team_extension
from src.skills.analysis.posthog.models.team.setup_tasks import SetupTaskId
from src.skills.analysis.posthog.models.team.team import CURRENCY_CODE_CHOICES, DEFAULT_CURRENCY
from src.skills.analysis.posthog.models.team.util import actions_that_require_current_team
from src.skills.analysis.posthog.models.utils import UUIDT
from src.skills.analysis.posthog.permissions import (
    CREATE_ACTIONS,
...
from src.skills.analysis.posthog.scopes import APIScopeObjectOrNotSupported
from src.skills.analysis.posthog.session_recordings.data_retention import (
    VALID_RETENTION_PERIODS,
    parse_feature_to_entitlement,
    retention_violates_entitlement,
    validate_retention_period,
)
from src.skills.analysis.posthog.user_permissions import UserPermissions, UserPermissionsSerializerMixin
from src.skills.analysis.posthog.utils import get_instance_realm, get_instance_region, get_ip_address, get_week_start_for_country_code
...
class TeamViewSet(TeamAndOrgViewSetMixin, AccessControlViewSetMixin, viewsets.ModelViewSet):
    ...
    def perform_destroy(self, team: Team):
        from src.skills.analysis.posthog.tasks.tasks import delete_project_data_and_notify_task
