...
from src.skills.analysis.posthog.api.oauth import OAuthAuthorizationSerializer
...
class TestOAuthAPI(APIBaseTest):
    ...
    def test_application_isolation_different_users(self):
        from src.skills.analysis.posthog.models import Organization, OrganizationMembership, User
