...
from src.skills.analysis.posthog.test.base import APIBaseTest, QueryMatchingTest
from unittest import mock

from parameterized import parameterized
from rest_framework import status

from src.skills.analysis.posthog.schema import AlertConditionType, AlertState, InsightThresholdType
...
class TestTriggerAlertHogFunctions(APIBaseTest):
    ...
    def test_insight_alert_firing_detector_props(
        ...
        from src.skills.analysis.posthog.tasks.alerts.utils import trigger_alert_hog_functions
