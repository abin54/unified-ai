...
from src.skills.analysis.posthog.api.webauthn import WEBAUTHN_REGISTRATION_CHALLENGE_KEY, WebAuthnLoginViewSet
...
class TestWebAuthnLogin(APIBaseTest):
    ...
    def test_login_complete_success(self, mock_verify):
        ...
        from src.skills.analysis.posthog.api.webauthn import user_uuid_to_handle
