...
from src.skills.analysis.posthog.api.github import (
...
from src.skills.analysis.posthog.models.oauth import OAuthAccessToken, OAuthApplication, OAuthGrant, OAuthRefreshToken
from src.skills.analysis.posthog.models.personal_api_key import LEGACY_PERSONAL_API_KEY_SALT
...
class TestOAuthTokenSecretAlert(APIBaseTest):
    def _create_oauth_app(self):
        ...
        from src.skills.analysis.posthog.models.test.test_oauth import generate_rsa_key
