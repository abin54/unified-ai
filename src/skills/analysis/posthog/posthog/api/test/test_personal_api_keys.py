...
from src.skills.analysis.posthog.api.personal_api_key import PersonalAPIKeySerializer
...
from src.skills.analysis.posthog.models.personal_api_key import LEGACY_PERSONAL_API_KEY_SALT, PersonalAPIKey
from src.skills.analysis.posthog.models.team.team import Team
from src.skills.analysis.posthog.models.utils import SHA256_HASH_PREFIX, generate_random_token_personal, hash_key_value
...
class TestPersonalAPIKeysWithApprovalsScope(PersonalAPIKeysBaseTest):
    ...
    def _create_change_request(self):
        from src.skills.analysis.posthog.approvals.models import ChangeRequest, ChangeRequestState
