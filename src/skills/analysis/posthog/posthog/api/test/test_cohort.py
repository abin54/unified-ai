...
from src.skills.analysis.posthog.schema import PersonsOnEventsMode, PropertyOperator

from src.skills.analysis.posthog.api.test.test_exports import TestExportMixin
from src.skills.analysis.posthog.clickhouse.client.execute import sync_execute
from src.skills.analysis.posthog.models import Action, FeatureFlag, Person, User
from src.skills.analysis.posthog.models.activity_logging.activity_log import ActivityLog
from src.skills.analysis.posthog.models.async_deletion.async_deletion import AsyncDeletion
...
from src.skills.analysis.posthog.models.property import BehavioralPropertyType
...
"""
    ...
    def test_remove_person_from_static_cohort_person_in_ch_but_not_pg(self):
        ...
        """
        from src.skills.analysis.posthog.models.cohort.util import insert_static_cohort
        from src.skills.analysis.posthog.models.person.sql import PERSON_STATIC_COHORT_TABLE
    ...
    def test_cohort_last_error_message_from_calculation_history(self):
        ...
        from src.skills.analysis.posthog.models.cohort.util import CohortErrorCode
