...
from src.skills.analysis.posthog.api.signup import _save_session_with_recovery, process_social_invite_signup
...
from src.skills.analysis.posthog.models.instance_setting import override_instance_config
...
class TestSignupChallengeAPI(APIBaseTest):
    ...
    def test_signup_challenge_returns_428_with_nonce_and_site_key(
        ...
        from src.skills.analysis.posthog.workos_radar import RadarVerdict
