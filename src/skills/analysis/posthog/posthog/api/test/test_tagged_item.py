...
from src.skills.analysis.posthog.models import Insight, Organization, Tag, Team
...
class TestBulkUpdateTags(APIBaseTest):
    ...
    def test_too_many_ids_returns_400(self):
        from src.skills.analysis.posthog.api.tagged_item import BULK_UPDATE_TAGS_MAX_IDS
