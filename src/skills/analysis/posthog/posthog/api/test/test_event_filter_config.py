...
from src.skills.analysis.posthog.models.event_filter_config import EventFilterConfig, EventFilterMode
...
class TestEventFilterConfigAPI(APIBaseTest):
    ...
    def test_metrics_calls_clickhouse_when_config_exists(self, mock_fetch):
        from src.skills.analysis.posthog.api.app_metrics2 import AppMetricsResponse
    ...
    def test_metrics_totals_calls_clickhouse_when_config_exists(self, mock_fetch):
        from src.skills.analysis.posthog.api.app_metrics2 import AppMetricsTotalsResponse
