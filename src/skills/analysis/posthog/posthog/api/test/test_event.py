...
from src.skills.analysis.posthog.models import Action, Element, Organization, Person, PropertyDefinition, User
from src.skills.analysis.posthog.models.cohort import Cohort
from src.skills.analysis.posthog.models.event.query_event_list import insight_query_with_columns
...
class TestEventListTimeWindowOptimization(ClickhouseTestMixin, APIBaseTest):
    def test_cache_key_generation(self):
        from src.skills.analysis.posthog.api.event import _get_event_list_cache_key, _get_limit_size_category
