...
from src.skills.analysis.posthog.test.base import APIBaseTest, ClickhouseTestMixin, QueryMatchingTest
...
from src.skills.analysis.posthog.api.hog_function import MAX_HOG_CODE_SIZE_BYTES, MAX_TRANSFORMATIONS_PER_TEAM
...
from src.skills.analysis.posthog.cdp.templates.slack.template_slack import template as template_slack
...
from src.skills.analysis.posthog.models.hog_functions.hog_function import DEFAULT_STATE, HogFunction, HogFunctionState
...
def get_db_field_value(field, model_id):
    ...
    cursor.execute(f"select {field} from src.skills.analysis.posthog_hogfunction where id='{model_id}';")
