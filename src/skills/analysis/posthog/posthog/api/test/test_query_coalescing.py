...
from src.skills.analysis.posthog import redis as posthog_redis
from src.skills.analysis.posthog.api.query_coalescer import (
    DONE_KEY_PREFIX,
    ERROR_KEY_PREFIX,
    LOCK_KEY_PREFIX,
    CoalesceSignal,
...
class TestQueryCoalescer(TestCase):
    ...
    def test_leader_increments_counter(self):
        from src.skills.analysis.posthog.api.query_coalescer import query_coalesce_counter
