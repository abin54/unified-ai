...
from src.skills.analysis.posthog.api.llm_prompt import LLMPromptViewSet
from src.skills.analysis.posthog.api.llm_prompt_serializers import MAX_PROMPT_PAYLOAD_BYTES
from src.skills.analysis.posthog.api.services.llm_prompt import MAX_PROMPT_VERSION
from src.skills.analysis.posthog.models.llm_prompt import LLMPrompt
...
class TestLLMPromptAPI(APIBaseTest):
    ...
    def test_fetch_prompt_by_name_uses_latest_cache_after_first_load(self, mock_feature_enabled):
        ...
        from src.skills.analysis.posthog.storage.llm_prompt_cache import llm_prompts_hypercache
