...
from src.skills.analysis.posthog.test.base import (
    APIBaseTest,
    ClickhouseTestMixin,
    FuzzyInt,
    _create_person,
...
from src.skills.analysis.posthog import redis
from src.skills.analysis.posthog.api.cohort import get_cohort_actors_for_feature_flag
from src.skills.analysis.posthog.api.feature_flag import FeatureFlagSerializer, extract_etag_from_header
from src.skills.analysis.posthog.constants import AvailableFeature
from src.skills.analysis.posthog.models import FeatureFlag, GroupTypeMapping, TaggedItem, User
...
from src.skills.analysis.posthog.models.feature_flag import FeatureFlagDashboards, get_feature_flags_for_team_in_cache
from src.skills.analysis.posthog.models.feature_flag.feature_flag import FeatureFlagHashKeyOverride
from src.skills.analysis.posthog.models.feature_flag.flag_status import FeatureFlagStatus
from src.skills.analysis.posthog.models.group.group import Group
from src.skills.analysis.posthog.models.group.util import create_group
from src.skills.analysis.posthog.models.organization import Organization, OrganizationMembership
...
from src.skills.analysis.posthog.test.db_context_capturing import capture_db_queries
from src.skills.analysis.posthog.test.test_utils import create_group_type_mapping_without_created_at
...
class TestFeatureFlag(APIBaseTest, ClickhouseTestMixin):
    ...
    def test_create_feature_flag_in_specific_folder(self):
        ...
        from src.skills.analysis.posthog.models.file_system.file_system import FileSystem
    ...
    def test_local_evaluation_caching_basic(self):
        ...
        from src.skills.analysis.posthog.models.feature_flag.local_evaluation import clear_flag_definition_caches
    ...
    def test_local_evaluation_secret_key_in_body_counter_not_incremented_for_header_auth(self):
        from src.skills.analysis.posthog.api.feature_flag import LOCAL_EVALUATION_SECRET_KEY_IN_BODY_COUNTER
    ...
    def test_local_evaluation_personal_api_key_source_counter(self, name, source):
        from src.skills.analysis.posthog.api.feature_flag import LOCAL_EVALUATION_PERSONAL_API_KEY_SOURCE_COUNTER
...
class TestFeatureFlagEvaluationContexts(APIBaseTest):
    ...
    def test_evaluation_contexts_in_minimal_serializer(self):
        from src.skills.analysis.posthog.api.feature_flag import MinimalFeatureFlagSerializer
    ...
    def test_evaluation_contexts_in_cache(self):
        from src.skills.analysis.posthog.models.evaluation_context import EvaluationContext, FeatureFlagEvaluationContext
        from src.skills.analysis.posthog.models.feature_flag import set_feature_flags_for_team_in_cache
    ...
    def test_evaluation_contexts_cache_invalidation(self):
        from src.skills.analysis.posthog.models.feature_flag import get_feature_flags_for_team_in_cache, set_feature_flags_for_team_in_cache
