...
from src.skills.analysis.posthog.models import EventDefinition, EventSchema, SchemaPropertyGroup, SchemaPropertyGroupProperty
...
class TestPythonGeneratorAPI(APIBaseTest):
    ...
    def test_python_endpoint_success(self, mock_report):
        ...
        code = data["content"]
        self.assertIn("from src.skills.analysis.posthog import Posthog", code)
        self.assertIn("class PosthogTyped(Posthog):", code)
    ...
    def test_python_endpoint_handles_no_events(self, mock_report):
        ...
        self.assertIn("from src.skills.analysis.posthog import Posthog", data["content"])
...
from src.skills.analysis.posthog_typed import PosthogTyped
{code}"""
