...
from src.skills.analysis.posthog.test.base import APIBaseTest, QueryMatchingTest, snapshot_postgres_queries_context
...
from src.skills.analysis.posthog.api.oauth.test_dcr import generate_rsa_key
from src.skills.analysis.posthog.api.test.batch_exports.conftest import start_test_worker
from src.skills.analysis.posthog.constants import AvailableFeature
from src.skills.analysis.posthog.models import ActivityLog
from src.skills.analysis.posthog.models.group_type_mapping import GROUP_TYPES_CACHE_KEY_PREFIX, GROUP_TYPES_STALE_CACHE_KEY_PREFIX
from src.skills.analysis.posthog.models.instance_setting import get_instance_setting
from src.skills.analysis.posthog.models.oauth import OAuthAccessToken, OAuthApplication
...
from src.skills.analysis.posthog.models.product_intent import ProductIntent
...
from src.skills.analysis.posthog.temporal.common.schedule import describe_schedule
from src.skills.analysis.posthog.test.test_utils import create_group_type_mapping_without_created_at
from src.skills.analysis.posthog.utils import get_instance_realm
...
def team_api_test_factory():
    class TestTeamAPI(APIBaseTest, QueryMatchingTest):
        ...
        def test_delete_bulky_postgres_data(self):
            ...
            from src.skills.analysis.posthog.models.cohort import Cohort, CohortPeople
            from src.skills.analysis.posthog.models.feature_flag.feature_flag import FeatureFlag, FeatureFlagHashKeyOverride

            # from src.skills.analysis.posthog.models.insight_caching_state import InsightCachingState
        ...
        def test_generate_secret_token(self):
            from src.skills.analysis.posthog.models.utils import mask_key_value
