...
from src.skills.analysis.posthog.schema import SharingConfigurationSettings

from src.skills.analysis.posthog.api.data_color_theme import DataColorTheme, DataColorThemeSerializer
from src.skills.analysis.posthog.api.exports import ExportedAssetSerializer
from src.skills.analysis.posthog.api.insight import InsightSerializer
from src.skills.analysis.posthog.api.insight_variable import InsightVariable
...
from src.skills.analysis.posthog.models import InsightViewed, SessionRecording, SharePassword, SharingConfiguration, Team
from src.skills.analysis.posthog.models.activity_logging.activity_log import Change, Detail, log_activity
from src.skills.analysis.posthog.models.exported_asset import ExportedAsset, asset_for_token, get_content_response
from src.skills.analysis.posthog.models.insight import Insight
from src.skills.analysis.posthog.models.user import User
from src.skills.analysis.posthog.rbac.user_access_control import UserAccessControl, access_level_satisfied_for_resource
from src.skills.analysis.posthog.security.url_validation import is_url_allowed
from src.skills.analysis.posthog.session_recordings.session_recording_api import SessionRecordingSerializer
from src.skills.analysis.posthog.user_permissions import UserPermissions
from src.skills.analysis.posthog.utils import get_ip_address, render_template
...
def build_shared_app_context(team: Team, request: Request) -> dict[str, Any]:
    ...
    from src.skills.analysis.posthog.utils import get_git_commit_short
