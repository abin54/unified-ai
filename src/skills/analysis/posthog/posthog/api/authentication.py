...
from src.skills.analysis.posthog.api.email_verification import EmailVerifier, is_email_verification_disabled
from src.skills.analysis.posthog.caching.login_device_cache import check_and_cache_login_device
from src.skills.analysis.posthog.email import is_email_available
from src.skills.analysis.posthog.event_usage import report_user_logged_in, report_user_password_reset
...
from src.skills.analysis.posthog.helpers.two_factor_session import (
    _obfuscate_token,
...
from src.skills.analysis.posthog.helpers.user_devices import has_valid_known_device_cookie
from src.skills.analysis.posthog.models import OrganizationDomain, User
from src.skills.analysis.posthog.models.activity_logging import signal_handlers  # noqa: F401
from src.skills.analysis.posthog.models.webauthn_credential import WebauthnCredential
from src.skills.analysis.posthog.passkey import generate_passkey_authentication_options, verify_passkey_authentication_response
from src.skills.analysis.posthog.rate_limit import EmailMFAResendThrottle, EmailMFAThrottle, TwoFactorThrottle, UserPasswordResetThrottle
...
from src.skills.analysis.posthog.utils import get_instance_available_sso_providers, get_ip_address, get_short_user_agent
from src.skills.analysis.posthog.workos_radar import RadarAction, RadarAuthMethod, evaluate_auth_attempt
...
class TwoFactorViewSet(NonCreatingViewSetMixin, viewsets.GenericViewSet):
    ...
    def _handle_passkey_2fa(self, request: Request, user: User, credential_id: str, response_data: dict) -> Response:
        ...
        """
        from src.skills.analysis.posthog.api.webauthn import WEBAUTHN_2FA_CHALLENGE_KEY
