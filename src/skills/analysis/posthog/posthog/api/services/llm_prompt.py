...
from src.skills.analysis.posthog.models.llm_prompt import LLMPrompt, annotate_llm_prompt_version_history_metadata
from src.skills.analysis.posthog.storage.llm_prompt_cache import invalidate_prompt_latest_cache, invalidate_prompt_version_caches
...
def archive_prompt(team: Team, prompt_name: str) -> list[int]:
    with transaction.atomic():
        ...
        def invalidate_caches_on_commit() -> None:
            ...
            try:
                from src.skills.analysis.posthog.tasks.llm_prompt_cache import invalidate_archived_prompt_versions_cache_task
