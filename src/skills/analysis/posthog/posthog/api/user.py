...
from src.skills.analysis.posthog.api.email_verification import EmailVerifier
from src.skills.analysis.posthog.api.oauth.toolbar_service import (
    ToolbarOAuthError,
    ToolbarOAuthState,
...
from src.skills.analysis.posthog.api.organization import OrganizationSerializer
from src.skills.analysis.posthog.api.services.flags_service import get_flags_from_service
from src.skills.analysis.posthog.api.shared import OrganizationBasicSerializer, TeamBasicSerializer
from src.skills.analysis.posthog.api.utils import ClassicBehaviorBooleanFieldSerializer, action, unparsed_hostname_in_allowed_url_list
...
from src.skills.analysis.posthog.constants import PERMITTED_FORUM_DOMAINS
from src.skills.analysis.posthog.email import is_email_available
from src.skills.analysis.posthog.event_usage import (
    report_user_deleted_account,
    report_user_logged_in,
    report_user_updated,
    report_user_verified_email,
)
from src.skills.analysis.posthog.helpers.session_cache import SessionCache
from src.skills.analysis.posthog.helpers.two_factor_session import set_two_factor_verified_in_session
from src.skills.analysis.posthog.middleware import get_impersonated_session_expires_at, is_read_only_impersonation
from src.skills.analysis.posthog.models import Team, User, UserScenePersonalisation
from src.skills.analysis.posthog.models.organization import Organization
from src.skills.analysis.posthog.models.user import NOTIFICATION_DEFAULTS, ROLE_CHOICES, Notifications, ShortcutPosition
from src.skills.analysis.posthog.permissions import APIScopePermission, TimeSensitiveActionPermission, UserNoOrgMembershipDeletePermission
from src.skills.analysis.posthog.rate_limit import ToolbarOAuthRefreshThrottle, UserAuthenticationThrottle, UserEmailVerificationThrottle
from src.skills.analysis.posthog.tasks import user_identify
from src.skills.analysis.posthog.tasks.email import (
    send_email_change_emails,
    send_password_changed_email,
    send_two_factor_auth_disabled_email,
    send_two_factor_auth_enabled_email,
)
from src.skills.analysis.posthog.user_permissions import UserPermissions
from src.skills.analysis.posthog.utils import render_template
...
class UserSerializer(serializers.ModelSerializer):
    ...
    def get_has_sso_enforcement(self, instance: User) -> bool:
        from src.skills.analysis.posthog.models.organization_domain import OrganizationDomain
    ...
    def get_pending_invites(self, instance: User) -> list[dict]:
        ...
        from src.skills.analysis.posthog.constants import INVITE_DAYS_VALIDITY
        from src.skills.analysis.posthog.helpers.email_utils import EmailNormalizer
        from src.skills.analysis.posthog.models import OrganizationInvite, OrganizationMembership
    ...
    def validate_passkeys_enabled_for_2fa(self, value: bool) -> bool:
        ...
        from src.skills.analysis.posthog.helpers.two_factor_session import has_passkeys
