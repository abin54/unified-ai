...
from src.skills.analysis.posthog.api.alert_schedule_restriction import AlertScheduleRestriction
from src.skills.analysis.posthog.api.documentation import extend_schema_field
from src.skills.analysis.posthog.api.insight import InsightBasicSerializer
...
from src.skills.analysis.posthog.models import Insight, User
...
from src.skills.analysis.posthog.models.alert import AlertCheck, AlertConfiguration, AlertSubscription, Threshold
...
from src.skills.analysis.posthog.tasks.alerts.detector import MAX_DETECTOR_BREAKDOWN_VALUES
from src.skills.analysis.posthog.tasks.alerts.schedule_restriction import validate_and_normalize_schedule_restriction
from src.skills.analysis.posthog.tasks.alerts.utils import next_check_at_after_schedule_restriction_change, validate_alert_config
from src.skills.analysis.posthog.utils import relative_date_parse
...
class AlertViewSet(TeamAndOrgViewSetMixin, viewsets.ModelViewSet):
    ...
    def simulate(self, request, *args, **kwargs):
        from src.skills.analysis.posthog.tasks.alerts.detector import simulate_detector_on_insight
...
def handle_alert_subscription_delete(sender, instance, **kwargs):
    from src.skills.analysis.posthog.models.activity_logging.model_activity import get_current_user, get_was_impersonated
