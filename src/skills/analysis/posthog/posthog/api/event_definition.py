...
from src.skills.analysis.posthog.api.event_definition_generators.base import EventDefinitionGenerator
from src.skills.analysis.posthog.api.event_definition_generators.golang import GolangGenerator
from src.skills.analysis.posthog.api.event_definition_generators.python import PythonGenerator
from src.skills.analysis.posthog.api.event_definition_generators.typescript import TypeScriptGenerator
...
from src.skills.analysis.posthog.constants import EventDefinitionType
from src.skills.analysis.posthog.event_usage import report_user_action
from src.skills.analysis.posthog.filters import TermSearchFilterBackend, term_search_filter_sql
from src.skills.analysis.posthog.models import EventDefinition, ObjectMediaPreview, Team
...
from src.skills.analysis.posthog.taxonomy.taxonomy import CORE_EVENTS
from src.skills.analysis.posthog.utils import get_safe_cache, relative_date_parse
...
class EventDefinitionViewSet(
    ...
    def perform_update(self, serializer):
        ...
        # Log activity for audit trail
        from src.skills.analysis.posthog.models.activity_logging.activity_log import dict_changes_between
