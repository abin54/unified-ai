...
from src.skills.analysis.posthog.schema import ActorsQuery, HogQLQuery, ProductKey

from src.skills.analysis.posthog.hogql.compiler.bytecode import create_bytecode
from src.skills.analysis.posthog.hogql.constants import CSV_EXPORT_LIMIT
from src.skills.analysis.posthog.hogql.property import property_to_expr
...
from src.skills.analysis.posthog.cdp.filters import build_behavioral_event_expr
from src.skills.analysis.posthog.clickhouse.client import sync_execute
from src.skills.analysis.posthog.clickhouse.query_tagging import Feature, tag_queries
from src.skills.analysis.posthog.constants import LIMIT, OFFSET, PropertyOperatorType
...
from src.skills.analysis.posthog.models import Cohort, FeatureFlag, Person, User
...
from src.skills.analysis.posthog.models.cohort import DEFAULT_COHORT_INSERT_BATCH_SIZE, CohortOrEmpty
from src.skills.analysis.posthog.models.cohort.calculation_history import CohortCalculationHistory
from src.skills.analysis.posthog.models.cohort.cohort import REALTIME_COHORT_MAX_PERSON_COUNT, CohortType
from src.skills.analysis.posthog.models.cohort.util import (
    cohort_filters_have_values,
    get_all_cohort_dependencies,
    get_friendly_error_message,
)
from src.skills.analysis.posthog.models.cohort.validation import CohortTypeValidationSerializer
from src.skills.analysis.posthog.models.feature_flag.flag_matching import (
    FeatureFlagMatcher,
    FlagsMatcherCache,
    get_feature_flag_hash_key_overrides,
)
from src.skills.analysis.posthog.models.filters.filter import Filter
from src.skills.analysis.posthog.models.insight import Insight
from src.skills.analysis.posthog.models.person.person import READ_DB_FOR_PERSONS, PersonDistinctId
from src.skills.analysis.posthog.models.person.util import validate_person_uuids_exist
from src.skills.analysis.posthog.models.property.property import Property, PropertyGroup
from src.skills.analysis.posthog.models.team.team import Team
from src.skills.analysis.posthog.models.utils import UUIDT
from src.skills.analysis.posthog.queries.actor_base_query import get_serialized_people
from src.skills.analysis.posthog.queries.base import determine_parsed_date_for_property_matching, property_group_to_Q
from src.skills.analysis.posthog.queries.person_query import PersonQuery
from src.skills.analysis.posthog.queries.util import get_earliest_timestamp
from src.skills.analysis.posthog.renderers import SafeJSONRenderer
from src.skills.analysis.posthog.utils import format_query_params_absolute_url
...
class CohortSerializer(serializers.ModelSerializer):
    ...
    def _handle_static(
        ...
        from src.skills.analysis.posthog.tasks.calculate_cohort import (
    ...
    def _validate_and_process_ids(self, ids: list[str], id_type: str, cohort: Cohort) -> None:
        ...
        from src.skills.analysis.posthog.tasks.calculate_cohort import calculate_cohort_from_list
    ...
    def update(self, cohort: Cohort, validated_data: dict, *args: Any, **kwargs: Any) -> Cohort:  # type: ignore
        ...
        if not deleted_state:
            from src.skills.analysis.posthog.tasks.calculate_cohort import insert_cohort_from_query
    ...
    def safely_get_queryset(self, queryset) -> QuerySet:
        if self.action == "list":
            ...
            if self.request.query_params.get("hide_behavioral_cohorts", "false").lower() == "true":
                ...
                from src.skills.analysis.posthog.api.feature_flag import _is_realtime_cohort_flag_targeting_enabled
