...
from src.skills.analysis.posthog.async_migrations.status import async_migrations_ok
from src.skills.analysis.posthog.cloud_utils import is_cloud
from src.skills.analysis.posthog.git import get_git_commit_short
from src.skills.analysis.posthog.permissions import SingleTenancyOrAdmin
...
class InstanceStatusViewSet(viewsets.ViewSet):
    ...
    def list(self, request: Request) -> Response:
        try:
            ...
            from src.skills.analysis.posthog.clickhouse.system_status import system_status
    ...
    def navigation(self, request: Request) -> Response:
        ...
        from src.skills.analysis.posthog.clickhouse.system_status import dead_letter_queue_ratio_ok_cached
    ...
    def queries(self, request: Request) -> Response:
        ...
        from src.skills.analysis.posthog.clickhouse.system_status import get_clickhouse_running_queries, get_clickhouse_slow_log
