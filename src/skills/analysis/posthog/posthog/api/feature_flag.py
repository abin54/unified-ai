...
from src.skills.analysis.posthog.schema import ProductKey, PropertyOperator

from src.skills.analysis.posthog.hogql.property import parse_semver

from src.skills.analysis.posthog.api.cohort import CohortSerializer
from src.skills.analysis.posthog.api.documentation import FeatureFlagFiltersSchemaSerializer, extend_schema
from src.skills.analysis.posthog.api.forbid_destroy_model import ForbidDestroyModel
from src.skills.analysis.posthog.api.mixins import validated_request
from src.skills.analysis.posthog.api.routing import TeamAndOrgViewSetMixin
from src.skills.analysis.posthog.api.scoped_related_fields import TeamScopedPrimaryKeyRelatedField
from src.skills.analysis.posthog.api.services.flags_service import get_flags_from_service
from src.skills.analysis.posthog.api.shared import UserBasicSerializer
from src.skills.analysis.posthog.api.tagged_item import TaggedItemSerializerMixin, TaggedItemViewSetMixin
from src.skills.analysis.posthog.api.utils import ClassicBehaviorBooleanFieldSerializer, action
from src.skills.analysis.posthog.approvals.decorators import approval_gate
from src.skills.analysis.posthog.approvals.mixins import ApprovalHandlingMixin
from src.skills.analysis.posthog.auth import (
    JwtAuthentication,
...
from src.skills.analysis.posthog.constants import PRODUCT_TOUR_TARGETING_FLAG_PREFIX, SURVEY_TARGETING_FLAG_PREFIX, FlagRequestType
from src.skills.analysis.posthog.date_util import thirty_days_ago
from src.skills.analysis.posthog.event_usage import report_user_action
from src.skills.analysis.posthog.exceptions import Conflict
from src.skills.analysis.posthog.exceptions_capture import capture_exception
from src.skills.analysis.posthog.helpers.dashboard_templates import add_enriched_insights_to_feature_flag_dashboard
from src.skills.analysis.posthog.helpers.encrypted_flag_payloads import (
    REDACTED_PAYLOAD_VALUE,
    encrypt_flag_payloads,
    get_decrypted_flag_payloads_protected,
)
from src.skills.analysis.posthog.models import FeatureFlag, Team
from src.skills.analysis.posthog.models.activity_logging.activity_log import Detail, changes_between, load_activity, log_activity
from src.skills.analysis.posthog.models.activity_logging.activity_page import ActivityLogPaginatedResponseSerializer, activity_page_response
from src.skills.analysis.posthog.models.activity_logging.model_activity import ImpersonatedContext, is_impersonated_session
from src.skills.analysis.posthog.models.cohort import Cohort
from src.skills.analysis.posthog.models.cohort.cohort import CohortType
from src.skills.analysis.posthog.models.cohort.util import get_all_cohort_dependencies
from src.skills.analysis.posthog.models.evaluation_context import normalize_context_name
from src.skills.analysis.posthog.models.feature_flag import (
    FeatureFlagDashboards,
    get_user_blast_radius,
    set_feature_flags_for_team_in_cache,
)
from src.skills.analysis.posthog.models.feature_flag.flag_analytics import increment_request_count
from src.skills.analysis.posthog.models.feature_flag.flag_status import FeatureFlagStatusChecker
from src.skills.analysis.posthog.models.feature_flag.flag_validation import check_flag_evaluation_query_is_ok
from src.skills.analysis.posthog.models.feature_flag.local_evaluation import (
    DATABASE_FOR_LOCAL_EVALUATION,
    _get_flag_properties_from_filters,
    get_flags_response_if_none_match,
)
from src.skills.analysis.posthog.models.feature_flag.types import PropertyFilterType
from src.skills.analysis.posthog.models.feature_flag.version_history import (
    VersionHistoryIncomplete,
    VersionNotFound,
    reconstruct_flag_at_version,
)
from src.skills.analysis.posthog.models.group.group import Group
from src.skills.analysis.posthog.models.property import Property
from src.skills.analysis.posthog.models.signals import model_activity_signal, mutable_receiver
from src.skills.analysis.posthog.permissions import ProjectSecretAPITokenPermission
from src.skills.analysis.posthog.queries.base import determine_parsed_date_for_property_matching
from src.skills.analysis.posthog.rate_limit import BurstRateThrottle
from src.skills.analysis.posthog.rbac.access_control_api_mixin import AccessControlViewSetMixin
from src.skills.analysis.posthog.rbac.user_access_control import UserAccessControlSerializerMixin
from src.skills.analysis.posthog.settings.feature_flags import LOCAL_EVAL_RATE_LIMITS, REMOTE_CONFIG_RATE_LIMITS
from src.skills.analysis.posthog.views import format_bytes
...
class EvaluationContextSerializerMixin(serializers.Serializer):
    ...
    def _attempt_set_evaluation_contexts(self, evaluation_contexts, obj):
        ...
        from src.skills.analysis.posthog.models.evaluation_context import EvaluationContext, FeatureFlagEvaluationContext
    ...
    def _log_evaluation_context_change(self, obj: FeatureFlag, before: list[str], after: list[str]) -> None:
        ...
        from src.skills.analysis.posthog.models.activity_logging.activity_log import Change, Detail, log_activity
...
class FeatureFlagSerializer(
    ...
    def get_can_edit(self, feature_flag: FeatureFlag) -> bool:
        ...
        from src.skills.analysis.posthog.rbac.user_access_control import AccessControlLevel, access_level_satisfied_for_resource
    ...
    def _validate_flag_reference(self, flag_reference):
        ...
        from src.skills.analysis.posthog.utils import safe_int
...
def _create_usage_dashboard(feature_flag: FeatureFlag, user):
    from src.skills.analysis.posthog.helpers.dashboard_templates import create_feature_flag_dashboard
...
def _update_feature_flag_dashboard(feature_flag: FeatureFlag, old_key: str) -> None:
    from src.skills.analysis.posthog.helpers.dashboard_templates import update_feature_flag_dashboard
...
class MinimalFeatureFlagSerializer(serializers.ModelSerializer):
    ...
    def get_evaluation_contexts(self, feature_flag: FeatureFlag) -> list[str]:
        try:
            ...
            from src.skills.analysis.posthog.models.evaluation_context import FeatureFlagEvaluationContext
...
class FeatureFlagViewSet(
    ...
    def matching_ids(self, request: request.Request, **kwargs):
        ...
        """
        from src.skills.analysis.posthog.rbac.user_access_control import access_level_satisfied_for_resource
    ...
    def bulk_delete(self, request: request.Request, **kwargs):
        ...
        from src.skills.analysis.posthog.models.activity_logging.activity_log import LogActivityEntry, bulk_log_activity
        from src.skills.analysis.posthog.models.feature_flag.feature_flag import set_feature_flags_for_team_in_cache
        from src.skills.analysis.posthog.rbac.user_access_control import access_level_satisfied_for_resource
        from src.skills.analysis.posthog.tasks.feature_flags import update_team_flags_cache, update_team_service_flags_cache
        from src.skills.analysis.posthog.tasks.remote_config import update_team_remote_config
...
def handle_feature_flag_change(
    ...
    **kwargs,
    ...
    if is_scheduled_change:
        from src.skills.analysis.posthog.models.activity_logging.activity_log import Trigger
...
class CanEditFeatureFlag(BasePermission):
    ...
    def has_object_permission(self, request, view, obj):
        from src.skills.analysis.posthog.rbac.user_access_control import UserAccessControl
