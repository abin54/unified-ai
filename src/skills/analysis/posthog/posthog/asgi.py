...
def _ensure_post_fork_init():
    ...
    from src.skills.analysis.posthog.continuous_profiling import start_continuous_profiling
    from src.skills.analysis.posthog.otel_instrumentation import initialize_otel
