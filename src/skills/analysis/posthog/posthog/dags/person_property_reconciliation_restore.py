...
from src.skills.analysis.posthog.clickhouse.custom_metrics import MetricsClient
...
def compute_restore_diff(
    ...
    Args:
        current_person: Current state from src.skills.analysis.posthog_person table
