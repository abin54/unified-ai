...
from src.skills.analysis.posthog.dags.persondistinctids_without_person_cleanup import (
...
class TestGetIdRangeForPdwp:
    ...
    def test_get_id_range_uses_min_id_override(self):
        ...
        assert len(max_queries) == 1, "Should query for max_id from src.skills.analysis.posthog_person when override is not provided"
