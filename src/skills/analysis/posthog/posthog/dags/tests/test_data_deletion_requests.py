...
from src.skills.analysis.posthog.dags.data_deletion_requests import (
...
from src.skills.analysis.posthog.models.data_deletion_request import DataDeletionRequest, ExecutionMode, RequestStatus, RequestType
...
def test_verify_queued_promotes_when_events_gone():
    from src.skills.analysis.posthog.dags.data_deletion_requests import _count_remaining_matching_events
