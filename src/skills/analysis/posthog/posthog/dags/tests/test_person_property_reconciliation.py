...
from src.skills.analysis.posthog.clickhouse.cluster import ClickhouseCluster
from src.skills.analysis.posthog.dags.person_property_reconciliation import (
...
class TestBatchCommits:
    ...
    def test_batch_commits_correct_number_of_times(self, num_persons: int, batch_size: int, expected_commits: int):
        ...
        Total: 3 commits
        """
        from src.skills.analysis.posthog.dags.person_property_reconciliation import process_persons_in_batches
...
class TestKafkaClickHouseRoundTrip:
    ...
    def test_publish_person_to_kafka_updates_clickhouse(self, team):
        ...
        from src.skills.analysis.posthog.dags.person_property_reconciliation import publish_person_to_kafka
        from src.skills.analysis.posthog.kafka_client.client import _KafkaProducer
        from src.skills.analysis.posthog.models import Person
    ...
    def test_full_dagster_job_with_real_kafka(self, team, cluster: ClickhouseCluster):
        ...
        from src.skills.analysis.posthog.dags.person_property_reconciliation import person_property_reconciliation_job
        from src.skills.analysis.posthog.kafka_client.client import _KafkaProducer
        from src.skills.analysis.posthog.models import Person
    ...
    def test_full_job_timestamp_window_filtering_all_permutations(self, cluster: ClickhouseCluster):
        ...
        from src.skills.analysis.posthog.dags.person_property_reconciliation import person_property_reconciliation_job
        from src.skills.analysis.posthog.kafka_client.client import _KafkaProducer
        from src.skills.analysis.posthog.models import Organization, Person, Team
...
class TestReconcileSingleTeamErrorHandling:
    ...
    def test_team_failure_does_not_crash_chunk(self):
        ...
        with patch(
            ...
            from src.skills.analysis.posthog.dags.person_property_reconciliation import reconcile_team_chunk
...
class TestReconciliationSchedulerSensor:
    ...
    def test_sensor_no_cursor_returns_skip_reason(self):
        ...
        from src.skills.analysis.posthog.dags.person_property_reconciliation import person_property_reconciliation_scheduler
