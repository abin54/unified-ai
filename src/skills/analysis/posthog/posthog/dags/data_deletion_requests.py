...
from src.skills.analysis.posthog.clickhouse.adhoc_events_deletion import ADHOC_EVENTS_DELETION_TABLE
from src.skills.analysis.posthog.clickhouse.cluster import (
...
from src.skills.analysis.posthog.dags.deletes import deletes_job
from src.skills.analysis.posthog.models.data_deletion_request import (
    DataDeletionRequest,
    ExecutionMode,
    RequestStatus,
    RequestType,
...
def mark_deletion_failed(context: dagster.HookContext) -> None:
    ...
    if ops_config.get("load_property_removal_request"):
        try:
            from src.skills.analysis.posthog.clickhouse.cluster import Query, get_cluster
