...
from src.skills.analysis.posthog.caching.flags_redis_cache import write_flags_to_cache
from src.skills.analysis.posthog.constants import ENRICHED_DASHBOARD_INSIGHT_IDENTIFIER, PropertyOperatorType
...
from src.skills.analysis.posthog.models.cohort import Cohort, CohortOrEmpty
...
from src.skills.analysis.posthog.models.property import GroupTypeIndex
...
from src.skills.analysis.posthog.models.utils import RootTeamManager, RootTeamMixin
...
class FeatureFlag(FileSystemSyncMixin, ModelActivityMixin, RootTeamMixin, models.Model):
    ...
    def transform_cohort_filters_for_easy_evaluation(
        ...
        from src.skills.analysis.posthog.models.property.util import clear_excess_levels
    ...
    def get_cohort_ids(
        ...
        from src.skills.analysis.posthog.models.cohort.util import get_all_cohort_dependencies, sort_cohorts_topologically
    ...
    def scheduled_changes_dispatcher(
        ...
        from src.skills.analysis.posthog.api.feature_flag import FeatureFlagSerializer
