...
from src.skills.analysis.posthog.models.cohort.cohort import Cohort, CohortOrEmpty, is_cohort_recalculation_only_save
from src.skills.analysis.posthog.models.cohort.util import get_nested_cohort_ids
...
from src.skills.analysis.posthog.models.feature_flag.flags_cache import _compare_flag_fields, get_teams_with_flags_queryset
from src.skills.analysis.posthog.models.feature_flag.types import FlagFilters, FlagProperty, PropertyFilterType
...
from src.skills.analysis.posthog.person_db_router import PERSONS_DB_FOR_READ
from src.skills.analysis.posthog.storage.hypercache import HyperCache, emit_cache_sync_metrics
from src.skills.analysis.posthog.storage.hypercache_manager import HyperCacheManagementConfig
...
def feature_flag_changed(sender, instance: "FeatureFlag", **kwargs):
    from src.skills.analysis.posthog.tasks.feature_flags import update_team_flags_cache
