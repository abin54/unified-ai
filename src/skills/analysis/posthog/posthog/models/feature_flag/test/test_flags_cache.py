...
from src.skills.analysis.posthog.models.feature_flag.flags_cache import (
...
class TestServiceFlagsCeleryTasks(BaseTest):
    ...
    def test_update_team_service_flags_cache_task(self):
        ...
        from src.skills.analysis.posthog.tasks.feature_flags import update_team_service_flags_cache
...
class TestCacheStats(BaseTest):
    ...
    def test_get_cache_stats_basic(self, mock_get_client):
        ...
        from src.skills.analysis.posthog.models.feature_flag.flags_cache import get_cache_stats
...
class TestGetTeamsWithExpiringCaches(BaseTest):
    ...
    def test_skips_teams_with_fresh_ttl(self, mock_time, mock_get_client):
        ...
        from src.skills.analysis.posthog.models.feature_flag.flags_cache import get_teams_with_expiring_flags_caches
...
class TestBatchOperations(BaseTest):
    ...
    def test_cleanup_stale_expiry_tracking(self, mock_get_client):
        ...
        from src.skills.analysis.posthog.models.feature_flag.flags_cache import FLAGS_CACHE_EXPIRY_SORTED_SET, cleanup_stale_expiry_tracking
    ...
    def test_warm_without_stagger_tracks_expiry_with_default_ttl(self, mock_time, mock_get_client):
        ...
        from src.skills.analysis.posthog.storage.hypercache_manager import warm_caches
...
class TestManagementCommands(BaseTest):
    ...
    def test_verify_cache_miss_detection_and_fix(self):
        ...
        from src.skills.analysis.posthog.models.feature_flag.flags_cache import clear_flags_cache
    ...
    def test_verify_cache_mismatch_detection_and_fix(self):
        ...
        from src.skills.analysis.posthog.models.feature_flag.flags_cache import update_flags_cache
    ...
    def test_verify_cache_detects_evaluation_context_rename(self):
        ...
        from src.skills.analysis.posthog.models.evaluation_context import EvaluationContext, FeatureFlagEvaluationContext
        from src.skills.analysis.posthog.models.feature_flag.flags_cache import update_flags_cache, verify_team_flags
    ...
    def test_verify_miss_includes_db_data(self):
        ...
        from src.skills.analysis.posthog.models.feature_flag.flags_cache import clear_flags_cache, verify_team_flags
    ...
    def test_verify_batch_load_fallback(self):
        ...
        from src.skills.analysis.posthog.models.feature_flag.flags_cache import FLAGS_HYPERCACHE_MANAGEMENT_CONFIG
...
class TestVerifyFlagsCacheVerboseOutput(BaseTest):
    ...
    def test_verbose_unknown_diff_type_fallback(self):
        ...
        from src.skills.analysis.posthog.management.commands.verify_flags_cache import Command
