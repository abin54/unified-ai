...
from src.skills.analysis.posthog.models.resource_transfer.types import ResourceKind, ResourceTransferVertex
...
class TestBuildResourceDuplicationGraph(BaseTest):
    ...
    def test_raises_for_unvisitable_model(self) -> None:
        from src.skills.analysis.posthog.models import Annotation
