...
from src.skills.analysis.posthog.models.resource_transfer.types import ResourcePayload, ResourceTransferEdge
from src.skills.analysis.posthog.models.resource_transfer.visitors.base import ResourceTransferVisitor
from src.skills.analysis.posthog.models.resource_transfer.visitors.common import (
    build_edges_for_ids,
