...
from src.skills.analysis.posthog.models.resource_transfer.types import ResourceKind, ResourcePayload, ResourceTransferEdge
from src.skills.analysis.posthog.models.utils import UUIDTClassicModel

if TYPE_CHECKING:
    from src.skills.analysis.posthog.models import Team
    from src.skills.analysis.posthog.models.resource_transfer.types import ResourceTransferVertex
