...
from src.skills.analysis.posthog.models.ai_events.person_shims import PERSON_AI_EVENTS_SHIM_SQL, PERSON_DISTINCT_ID2_AI_EVENTS_SHIM_SQL
from src.skills.analysis.posthog.models.person.sql import PERSON_DISTINCT_ID2_TABLE_BASE_SQL, PERSONS_TABLE_BASE_SQL
