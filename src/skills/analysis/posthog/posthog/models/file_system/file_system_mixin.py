...
class FileSystemSyncMixin(Model):
    ...
    def __init_subclass__(cls, **kwargs):
        ...
        def _file_system_post_save(sender, instance: "FileSystemSyncMixin", created, **kwargs):
            from src.skills.analysis.posthog.models.file_system.file_system import create_or_update_file, delete_file
        ...
        def _file_system_post_delete(sender, instance: "FileSystemSyncMixin", **kwargs):
            from src.skills.analysis.posthog.models.file_system.file_system import delete_file
            from src.skills.analysis.posthog.models.team import Team
