...
from src.skills.analysis.posthog.schema import ProductIntentContext, ProductItemCategory, ProductKey

from src.skills.analysis.posthog.models.utils import UpdatedMetaFields, UUIDModel, uuid7
...
if TYPE_CHECKING:
    from src.skills.analysis.posthog.models.product_intent.product_intent import ProductIntent
