...
from src.skills.analysis.posthog.schema import PropertyOperator
...
from src.skills.analysis.posthog.hogql.visitor import TraversingVisitor

from src.skills.analysis.posthog.clickhouse.kafka_engine import trim_quotes_expr
from src.skills.analysis.posthog.clickhouse.materialized_columns import TableWithProperties, get_materialized_column_for_property
...
from src.skills.analysis.posthog.models.action.util import get_action_tables_and_properties
...
from src.skills.analysis.posthog.models.event import Selector
from src.skills.analysis.posthog.models.group.sql import GET_GROUP_IDS_BY_PROPERTY_SQL
from src.skills.analysis.posthog.models.person.sql import GET_DISTINCT_IDS_BY_PERSON_ID_FILTER, GET_DISTINCT_IDS_BY_PROPERTY_SQL
from src.skills.analysis.posthog.models.property import (
    NEGATED_OPERATORS,
    OperatorType,
    Property,
    PropertyGroup,
...
from src.skills.analysis.posthog.models.property.property import ValueT
...
from src.skills.analysis.posthog.session_recordings.queries.session_query import SessionQuery
from src.skills.analysis.posthog.types import ErrorTrackingIssueFilter
from src.skills.analysis.posthog.utils import is_json, is_valid_regex
    ...
    *,
    ...
    for idx, prop in enumerate(filters):
        if prop.type == "cohort":
            ...
            from src.skills.analysis.posthog.hogql.hogql import translate_hogql
