...
from src.skills.analysis.posthog.models import Cohort, Person, Team
from src.skills.analysis.posthog.models.cohort.cohort import CohortPeople
from src.skills.analysis.posthog.personhog_client.fake_client import fake_personhog_client
from src.skills.analysis.posthog.personhog_client.test_helpers import PersonhogTestMixin
...
class TestCheckCohortMembership(PersonhogTestMixin, BaseTest):
    def test_returns_true_for_member(self):
        from src.skills.analysis.posthog.models.person.util import check_cohort_membership, is_person_in_cohort
    ...
    def test_returns_false_for_non_member(self):
        from src.skills.analysis.posthog.models.person.util import is_person_in_cohort
    ...
    def test_returns_empty_dict_for_empty_cohort_ids(self):
        from src.skills.analysis.posthog.models.person.util import check_cohort_membership
...
class TestPropertyToQStaticCohortShortCircuit(PersonhogTestMixin, BaseTest):
    ...
    def test_returns_match_all_q_when_person_is_member(self):
        from src.skills.analysis.posthog.queries.base import property_to_Q
...
class TestListCohortMemberIds(PersonhogTestMixin, BaseTest):
    def test_returns_member_ids(self):
        from src.skills.analysis.posthog.models.person.util import list_cohort_member_ids
