...
from src.skills.analysis.posthog.constants import PropertyOperatorType
from src.skills.analysis.posthog.exceptions_capture import capture_exception
from src.skills.analysis.posthog.helpers.batch_iterators import ArrayBatchIterator, BatchIterator, FunctionBatchIterator
from src.skills.analysis.posthog.models.file_system.file_system_mixin import FileSystemSyncMixin
from src.skills.analysis.posthog.models.file_system.file_system_representation import FileSystemRepresentation
from src.skills.analysis.posthog.models.filters.filter import Filter
from src.skills.analysis.posthog.models.person import Person, PersonDistinctId
from src.skills.analysis.posthog.models.person.person import READ_DB_FOR_PERSONS
from src.skills.analysis.posthog.models.person.util import get_person_by_uuid, get_persons_by_distinct_ids, is_person_in_cohort
from src.skills.analysis.posthog.models.property import Property, PropertyGroup
from src.skills.analysis.posthog.models.utils import RootTeamManager, RootTeamMixin, sane_repr
from src.skills.analysis.posthog.person_db_router import PERSONS_DB_FOR_WRITE
from src.skills.analysis.posthog.settings.base_variables import TEST
...
class Cohort(FileSystemSyncMixin, RootTeamMixin, models.Model):
    ...
    def calculate_people_ch(self, pending_version: int, *, initiating_user_id: Optional[int] = None):
        from src.skills.analysis.posthog.models.cohort.util import recalculate_cohortpeople
    ...
    def _get_uuids_for_distinct_ids_batch(self, distinct_ids: list[str], team_id: int) -> list[str]:
        ...
        from src.skills.analysis.posthog.personhog_client.gate import use_personhog
    ...
    def insert_users_by_list(
        ...
        *,
        ...
        if TEST:
            from src.skills.analysis.posthog.test.base import flush_persons_and_events
    ...
    def _insert_users_list_with_batching(
        ...
        *,
        ...
        """
        from src.skills.analysis.posthog.models.cohort.util import get_static_cohort_size, insert_static_cohort
    ...
    def remove_user_by_uuid(self, user_uuid: str, *, team_id: int) -> bool:
        ...
        """
        from src.skills.analysis.posthog.models.cohort.util import get_static_cohort_size, remove_person_from_static_cohort
    ...
    def to_dict(self) -> dict:
        from src.skills.analysis.posthog.models.activity_logging.activity_log import common_field_exclusions, field_exclusions
    ...
    def enqueue_calculation(self, *, initiating_user=None) -> None:
        ...
        def trigger_calculation():
            from src.skills.analysis.posthog.tasks.calculate_cohort import increment_version_and_enqueue_calculate_cohort
...
def get_or_create_internal_test_users_cohort(
    ...
    """
    from src.skills.analysis.posthog.utils import GenericEmails
...
def cohort_people_changed(sender, instance: "CohortPeople", **kwargs):
    from src.skills.analysis.posthog.models.cohort.util import get_static_cohort_size
