...
from src.skills.analysis.posthog.models.utils import RootTeamMixin
...
from src.skills.analysis.posthog.utils import get_safe_cache, safe_cache_delete, safe_cache_set
...
def _fetch_group_types_via_personhog(project_id: int) -> list[dict[str, Any]]:
    ...
    from src.skills.analysis.posthog.personhog_client.converters import proto_group_type_mapping_to_dict
    from src.skills.analysis.posthog.personhog_client.proto import GetGroupTypeMappingsByProjectIdRequest
