...
from src.skills.analysis.posthog.models.activity_logging.utils import ACTIVITY_LOG_CLIENT_MAX_LENGTH, activity_storage
from src.skills.analysis.posthog.models.utils import ActivityDetailEncoder, UUIDTModel
...
def apply_activity_visibility_restrictions(queryset: QuerySet, user: Union["User", AnonymousUser, None]) -> QuerySet:
    ...
    """
    from src.skills.analysis.posthog.models.activity_logging.utils import activity_visibility_manager
...
def activity_log_created(sender, instance: "ActivityLog", created, **kwargs):
    from src.skills.analysis.posthog.api.advanced_activity_logs import ActivityLogSerializer
    ...
    try:
        ...
        if instance.team_id is not None:
            ...
            from src.skills.analysis.posthog.tasks.activity_log import broadcast_activity_log_to_organization
