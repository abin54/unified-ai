...
from src.skills.analysis.posthog.plugins.access import can_install_plugins
from src.skills.analysis.posthog.plugins.plugin_server_api import populate_plugin_capabilities_on_workers, reload_plugins_on_workers
from src.skills.analysis.posthog.plugins.site import get_decide_site_apps, get_decide_site_functions
from src.skills.analysis.posthog.plugins.utils import (
...
def transpile(input_string: str, type: Literal["site", "frontend"] = "site") -> Optional[str]:
    from src.skills.analysis.posthog.settings.base_variables import BASE_DIR
