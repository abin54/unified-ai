...
from src.skills.analysis.posthog.models.property import Property, PropertyIdentifier
from src.skills.analysis.posthog.models.property.property import OperatorType
...
def format_action_filter(
    ...
    for index, step in enumerate(steps):
        ...
        if step.event == AUTOCAPTURE_EVENT:
            from src.skills.analysis.posthog.models.property.util import filter_element  # prevent circular import
...
def get_action_tables_and_properties(action: Action) -> TCounter[PropertyIdentifier]:
    from src.skills.analysis.posthog.models.property.util import extract_tables_and_properties
