...
from src.skills.analysis.posthog.cache_utils import cache_for
from src.skills.analysis.posthog.exceptions_capture import capture_exception
from src.skills.analysis.posthog.models.async_migration import is_async_migration_complete
...
def delete_bulky_postgres_data(team_ids: list[int]):
    ...
    from src.skills.analysis.posthog.models.group_type_mapping import GroupTypeMapping
    from src.skills.analysis.posthog.models.insight_caching_state import InsightCachingState
    from src.skills.analysis.posthog.models.person import PersonlessDistinctId
...
def _delete_persons_for_teams(team_ids: list[int]) -> None:
    ...
    from src.skills.analysis.posthog.models.person.util import _personhog_routed
...
def _delete_persons_for_team_via_personhog(team_id: int) -> None:
    from src.skills.analysis.posthog.personhog_client.client import get_personhog_client
    from src.skills.analysis.posthog.personhog_client.proto import DeletePersonsBatchForTeamRequest
...
def delete_batch_exports(team_ids: list[int]):
    ...
    """
    from src.skills.analysis.posthog.batch_exports.models import BatchExport
...
def delete_data_modeling_schedules(team_ids: list[int]) -> None:
    ...
    from src.skills.analysis.posthog.temporal.common.schedule import delete_schedule
