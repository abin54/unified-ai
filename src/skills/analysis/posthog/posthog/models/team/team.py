...
from src.skills.analysis.posthog.clickhouse.query_tagging import Feature, Product, tag_queries, tags_context
from src.skills.analysis.posthog.cloud_utils import is_cloud
from src.skills.analysis.posthog.helpers.dashboard_templates import create_dashboard_from_template
from src.skills.analysis.posthog.helpers.session_recording_playlist_templates import DEFAULT_PLAYLISTS
...
from src.skills.analysis.posthog.models.filters.utils import GroupTypeIndex
...
from src.skills.analysis.posthog.models.signals import mutable_receiver
from src.skills.analysis.posthog.models.utils import (
    UUIDTClassicModel,
...
from src.skills.analysis.posthog.rbac.decorators import field_access_control
from src.skills.analysis.posthog.session_recordings.models.session_recording_playlist import SessionRecordingPlaylist
from src.skills.analysis.posthog.settings.utils import get_list
...
class TeamManager(models.Manager):
    ...
    def create_with_data(self, *, initiating_user: Optional["User"], **kwargs) -> "Team":
        ...
        from src.skills.analysis.posthog.models.cohort.cohort import get_or_create_internal_test_users_cohort
        ...
        from src.skills.analysis.posthog.tasks.tasks import sync_user_product_lists_for_new_team
...
class Team(UUIDTClassicModel):
    ...
    def _notify_vercel_of_token_rotation(self) -> None:
        ...
        from src.skills.analysis.posthog.tasks.integrations import push_vercel_secrets
    ...
    def kick_off_demo_data_generation(self, initiating_user: "User") -> None:
        from src.skills.analysis.posthog.tasks.demo_create_data import create_data_for_demo_team
