...
from src.skills.analysis.posthog.kafka_client.client import ClickhouseProducer
from src.skills.analysis.posthog.kafka_client.topics import KAFKA_PERSON, KAFKA_PERSON_DISTINCT_ID
...
from src.skills.analysis.posthog.personhog_client.proto import (
...
def check_cohort_membership(team_id: int, person_id: int, cohort_ids: list[int]) -> dict[int, bool]:
    ...
    from src.skills.analysis.posthog.models.cohort.cohort import Cohort, CohortPeople
