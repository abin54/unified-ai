...
from src.skills.analysis.posthog.models.filters.mixins.base import BaseParamMixin, FunnelWindowIntervalType
from src.skills.analysis.posthog.models.filters.mixins.utils import cached_property, include_dict
