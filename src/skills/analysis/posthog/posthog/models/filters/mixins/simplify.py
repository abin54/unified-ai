...
from src.skills.analysis.posthog.models.property import GroupTypeIndex, PropertyGroup

if TYPE_CHECKING:  # Avoid circular import
    from src.skills.analysis.posthog.models import Property, Team
...
class SimplifyFilterMixin:
    ...
    def _simplify_entity(
        ...
        **kwargs,
        ...
        from src.skills.analysis.posthog.models.entity import Entity, ExclusionEntity
    ...
    def _simplify_property(self, team: "Team", property: "Property", **kwargs) -> "PropertyGroup":
        if property.type == "cohort":
            ...
            from src.skills.analysis.posthog.models.cohort.util import simplified_cohort_filter_properties
