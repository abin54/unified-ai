...
from src.skills.analysis.posthog.helpers.encrypted_fields import EncryptedJSONStringField
from src.skills.analysis.posthog.models.action.action import Action
from src.skills.analysis.posthog.models.cohort.cohort import is_cohort_recalculation_only_save
...
from src.skills.analysis.posthog.models.plugin import sync_team_inject_web_apps
...
from src.skills.analysis.posthog.models.utils import UUIDTModel
from src.skills.analysis.posthog.plugins.plugin_server_api import (
    get_hog_function_status,
    patch_hog_function_status,
    reload_hog_functions_on_workers,
)
from src.skills.analysis.posthog.utils import absolute_uri
...
class HogFunction(FileSystemSyncMixin, UUIDTModel):
    ...
    def save(self, *args, **kwargs):
        from src.skills.analysis.posthog.cdp.filters import compile_filters_bytecode
...
def action_saved(sender, instance: Action, created, **kwargs):
    ...
    from src.skills.analysis.posthog.tasks.hog_functions import refresh_affected_hog_functions
...
def enabled_default_hog_functions_for_new_team(sender, instance: Team, created: bool, **kwargs):
    ...
    from src.skills.analysis.posthog.cdp.templates.hog_function_template import sync_template_to_db
    from src.skills.analysis.posthog.models.hog_function_template import HogFunctionTemplate
    from src.skills.analysis.posthog.plugins.plugin_server_api import get_hog_function_templates
