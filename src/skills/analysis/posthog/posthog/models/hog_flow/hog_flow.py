...
from src.skills.analysis.posthog.plugins.plugin_server_api import reload_hog_flows_on_workers
...
def action_saved_for_hog_flows(sender, instance: Action, created, **kwargs):
    ...
    from src.skills.analysis.posthog.tasks.hog_flows import refresh_affected_hog_flows
