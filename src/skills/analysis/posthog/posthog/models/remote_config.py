...
from src.skills.analysis.posthog.database_healthcheck import DATABASE_FOR_FLAG_MATCHING
...
from src.skills.analysis.posthog.models.js_snippet_versioning import (
...
from src.skills.analysis.posthog.models.team.js_snippet_config import TeamJsSnippetConfig
from src.skills.analysis.posthog.models.team.team import Team
from src.skills.analysis.posthog.models.utils import UUIDTModel, execute_with_timeout
from src.skills.analysis.posthog.storage.hypercache import HyperCache, HyperCacheStoreMissing
...
def sanitize_config_for_public_cdn(config: dict, request: Optional[HttpRequest] = None) -> dict:
    from src.skills.analysis.posthog.api.utils import on_permitted_recording_domain
...
class RemoteConfig(UUIDTModel):
    ...
    def build_config(self):
        ...
        from src.skills.analysis.posthog.plugins.site import get_decide_site_apps
    ...
    def _build_site_apps_js(self):
        ...
        from src.skills.analysis.posthog.models import HogFunction
        from src.skills.analysis.posthog.plugins.site import get_site_apps_for_team, get_site_config_from_schema
