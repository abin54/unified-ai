...
from src.skills.analysis.posthog.constants import MAX_SLUG_LENGTH
from src.skills.analysis.posthog.person_db_router import PERSONS_DB_MODELS
...
class BytecodeModelMixin(models.Model):
    ...
    def _refresh_bytecode(self):
        ...
        from src.skills.analysis.posthog.hogql.errors import BaseHogQLError
...
class ActivityDetailEncoder(json.JSONEncoder):
    def default(self, obj):
        from src.skills.analysis.posthog.models.activity_logging.activity_log import ActivityContextBase, Change, Detail, Trigger
