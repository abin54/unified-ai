...
from src.skills.analysis.posthog.helpers.email_utils import EmailNormalizer, EmailValidationHelper
...
from src.skills.analysis.posthog.models.utils import UUIDTModel, sane_repr
...
def validate_private_project_access(value):
    from src.skills.analysis.posthog.rbac.user_access_control import ACCESS_CONTROL_LEVELS_MEMBER
...
class OrganizationInvite(ModelActivityMixin, UUIDTModel):
    ...
    def use(self, user: "User", *, prevalidated: bool = False) -> None:
        ...
        if is_email_available(with_absolute_urls=True):
            from src.skills.analysis.posthog.tasks.email import send_member_join
    ...
    def delete(self, *args, **kwargs):
        ...
        from src.skills.analysis.posthog.models.signals import model_activity_signal
