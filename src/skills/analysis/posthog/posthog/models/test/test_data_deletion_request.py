...
from src.skills.analysis.posthog.models.data_deletion_request import DataDeletionRequest, RequestType
...
def test_compile_hogql_predicate_returns_sql_and_values(team):
    from src.skills.analysis.posthog.models.data_deletion_request import compile_hogql_predicate
...
def test_rendered_count_query_substitutes_parameters():
    from src.skills.analysis.posthog.admin.admins.data_deletion_request_admin import build_deletion_count_query
    from src.skills.analysis.posthog.clickhouse.client.escape import substitute_params_for_display
