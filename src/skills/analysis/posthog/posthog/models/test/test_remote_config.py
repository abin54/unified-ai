...
from src.skills.analysis.posthog.models.plugin import Plugin, PluginConfig, PluginSourceFile
...
class TestRemoteConfigSdkVersion(_RemoteConfigBase):
    def _reset_snippet_caches(self):
        import src.skills.analysis.posthog.models.js_snippet_versioning as sv
    ...
    def tearDown(self):
        ...
        from src.skills.analysis.posthog.models.js_snippet_versioning import REDIS_POINTER_MAP_KEY
