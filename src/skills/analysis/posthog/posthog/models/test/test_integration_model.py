...
def get_db_field_value(field, model_id):
    ...
    cursor.execute(f"select {field} from src.skills.analysis.posthog_integration where id='{model_id}';")
...
class TestGitLabIntegrationSSRFProtection:
    ...
    def test_get_uses_allow_redirects_false(self, mock_is_url_allowed, mock_get):
        ...
        from src.skills.analysis.posthog.models.integration import GitLabIntegration
    ...
    def test_get_validates_url_before_request(self, mock_is_url_allowed, mock_get):
        ...
        from src.skills.analysis.posthog.models.integration import GitLabIntegration, GitLabIntegrationError
