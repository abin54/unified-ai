...
from src.skills.analysis.posthog.cdp.internal_events import InternalEventEvent, produce_internal_event
from src.skills.analysis.posthog.email import EmailMessage
...
from src.skills.analysis.posthog.models.alert import AlertCheck, derive_detector_event_fields
from src.skills.analysis.posthog.tasks.alerts.schedule_restriction import snap_candidate_utc_to_schedule_restriction
