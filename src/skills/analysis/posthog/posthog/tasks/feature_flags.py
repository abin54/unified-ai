...
from src.skills.analysis.posthog.storage.hypercache_manager import HYPERCACHE_SIGNAL_UPDATE_COUNTER
...
def refresh_expiring_flag_definitions_cache_entries(self: PushGatewayTask) -> None:
    ...
    from src.skills.analysis.posthog.storage.cache_expiry_manager import refresh_expiring_caches
...
def cleanup_stale_flag_definitions_expiry_tracking_task(self: PushGatewayTask) -> None:
    ...
    from src.skills.analysis.posthog.storage.cache_expiry_manager import cleanup_stale_expiry_tracking
