...
from src.skills.analysis.posthoganalytics.client import Client as PostHogClient
from psycopg import sql
from retry import retry

from src.skills.analysis.posthog.schema import AIEventType

from src.skills.analysis.posthog import version_requirement
from src.skills.analysis.posthog.batch_exports.models import BatchExportDestination, BatchExportRun
...
from src.skills.analysis.posthog.clickhouse.query_tagging import Feature, Product, tags_context
from src.skills.analysis.posthog.cloud_utils import get_cached_instance_license
from src.skills.analysis.posthog.constants import FlagRequestType
from src.skills.analysis.posthog.exceptions_capture import capture_exception
from src.skills.analysis.posthog.logging.timing import timed_log
from src.skills.analysis.posthog.models import BatchExport, GroupTypeMapping, OrganizationMembership, User
...
from src.skills.analysis.posthog.models.property.util import get_property_string_expr
from src.skills.analysis.posthog.models.team.team import Team
from src.skills.analysis.posthog.models.utils import namedtuplefetchall
from src.skills.analysis.posthog.settings import CLICKHOUSE_CLUSTER, INSTANCE_TAG
from src.skills.analysis.posthog.tasks.report_utils import capture_event
from src.skills.analysis.posthog.tasks.utils import CeleryQueue
from src.skills.analysis.posthog.utils import get_helm_info_env, get_instance_realm, get_instance_region, get_previous_day
...
def get_teams_with_ai_credits_used_in_period(
    ...
    if region is None:
        ...
        from src.skills.analysis.posthog.settings import TEST
