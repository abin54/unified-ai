...
from src.skills.analysis.posthog.schema import EventsQuery

from src.skills.analysis.posthog.hogql.query import execute_hogql_query

from src.skills.analysis.posthog.batch_exports.models import BatchExport, BatchExportDestination, BatchExportRun
...
from src.skills.analysis.posthog.hogql_queries.events_query_runner import EventsQueryRunner
from src.skills.analysis.posthog.models import Organization, Plugin, Team
from src.skills.analysis.posthog.models.app_metrics2.sql import TRUNCATE_APP_METRICS2_TABLE_SQL
from src.skills.analysis.posthog.models.event.util import create_event
from src.skills.analysis.posthog.models.feature_flag import FeatureFlag
from src.skills.analysis.posthog.models.group.util import create_group
from src.skills.analysis.posthog.models.plugin import PluginConfig
from src.skills.analysis.posthog.models.sharing_configuration import SharingConfiguration
from src.skills.analysis.posthog.session_recordings.queries.test.session_replay_sql import produce_replay_summary
from src.skills.analysis.posthog.tasks.usage_report import (
    OrgReport,
...
from src.skills.analysis.posthog.test.fixtures import create_app_metric2
from src.skills.analysis.posthog.test.test_utils import create_group_type_mapping_without_created_at
from src.skills.analysis.posthog.utils import get_previous_day
...
class TestFeatureFlagsUsageReport(ClickhouseDestroyTablesMixin, TestCase, ClickhouseTestMixin):
    ...
    def test_active_hog_destinations_and_transformations_per_team(
        ...
        from src.skills.analysis.posthog.models.hog_functions.hog_function import HogFunction, HogFunctionType
...
class TestCaptureReportGroupProperties(ClickhouseDestroyTablesMixin, TestCase, ClickhouseTestMixin):
    ...
    def test_capture_report_sets_org_group_properties(self, mock_client: MagicMock) -> None:
        from src.skills.analysis.posthog.tasks.usage_report import capture_report
...
class TestAIEventsUsageReport(ClickhouseDestroyTablesMixin, TestCase, ClickhouseTestMixin):
    ...
    def test_ai_credits_with_billable_tools(self, mock_region: MagicMock) -> None:
        ...
        from src.skills.analysis.posthog.tasks.usage_report import get_teams_with_ai_credits_used_in_period
...
class TestQuerySplitting(ClickhouseDestroyTablesMixin, ClickhouseTestMixin, TestCase):
    ...
    def test_execute_split_query_splits_correctly(self, mock_sync_execute: MagicMock) -> None:
        ...
        from src.skills.analysis.posthog.tasks.usage_report import _execute_split_query
    ...
    def test_get_teams_with_billable_event_count_in_period(self) -> None:
        ...
        from src.skills.analysis.posthog.tasks.usage_report import get_teams_with_billable_event_count_in_period
    ...
    def test_get_teams_with_billable_enhanced_persons_event_count_in_period(
        ...
        from src.skills.analysis.posthog.tasks.usage_report import get_teams_with_billable_enhanced_persons_event_count_in_period
