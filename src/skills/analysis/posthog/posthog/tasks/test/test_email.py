...
from src.skills.analysis.posthog.test.base import APIBaseTest, ClickhouseTestMixin, run_clickhouse_statement_in_parallel
...
from src.skills.analysis.posthog.api.authentication import password_reset_token_generator
from src.skills.analysis.posthog.api.email_verification import email_verification_token_generator
...
from src.skills.analysis.posthog.models.instance_setting import set_instance_setting
...
from src.skills.analysis.posthog.models.plugin import Plugin, PluginConfig
...
from src.skills.analysis.posthog.tasks.test.utils_email_tests import mock_email_messages
...
class TestEmail(APIBaseTest, ClickhouseTestMixin):
    ...
    def test_send_hog_functions_daily_digest(self, MockEmailMessage: MagicMock) -> None:
        ...
        from src.skills.analysis.posthog.models.activity_logging.activity_log import ActivityLog, Detail
    ...
    def test_send_discussions_mentioned_with_slug_generates_correct_href(self, MockEmailMessage: MagicMock) -> None:
        from src.skills.analysis.posthog.models import Comment
