...
from src.skills.analysis.posthog.models import FeatureFlag, Organization, ScheduledChange
...
class TestProcessScheduledChanges(APIBaseTest, QueryMatchingTest):
    ...
    def test_max_retries_exceeded(self) -> None:
        ...
        from src.skills.analysis.posthog.tasks.process_scheduled_changes import MAX_RETRY_ATTEMPTS
