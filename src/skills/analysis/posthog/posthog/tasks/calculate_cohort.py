...
from src.skills.analysis.posthog.api.monitoring import Feature
from src.skills.analysis.posthog.clickhouse import query_tagging
from src.skills.analysis.posthog.clickhouse.query_tagging import QueryTags, update_tags
from src.skills.analysis.posthog.errors import CHQueryErrorCannotScheduleTask, CHQueryErrorS3Error, CHQueryErrorTooManySimultaneousQueries
from src.skills.analysis.posthog.exceptions import ClickHouseAtCapacity
from src.skills.analysis.posthog.exceptions_capture import capture_exception
from src.skills.analysis.posthog.models import Cohort
from src.skills.analysis.posthog.models.cohort import CohortOrEmpty
...
def static_cohort_has_supported_population_source(cohort: Cohort) -> bool:
    from src.skills.analysis.posthog.models.cohort.util import cohort_filters_have_values
...
def insert_cohort_from_query(cohort_id: int, team_id: Optional[int] = None) -> None:
    ...
    All new tasks should pass team_id explicitly.
    """
    from src.skills.analysis.posthog.models.cohort.util import insert_cohort_people_into_pg, insert_cohort_query_actors_into_ch
...
def insert_cohort_from_filters(cohort_id: int, team_id: Optional[int] = None) -> None:
    ...
    """
    from src.skills.analysis.posthog.models.cohort.util import insert_cohort_filter_actors_into_ch, insert_cohort_people_into_pg
