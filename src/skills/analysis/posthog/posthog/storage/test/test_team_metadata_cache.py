...
import src.skills.analysis.posthog.storage.team_access_cache_signal_handlers  # noqa: F401 — registers PSAK delete handler
from src.skills.analysis.posthog.models.team.team import Team
from src.skills.analysis.posthog.storage.team_metadata_cache import (
...
from src.skills.analysis.posthog.tasks.team_metadata import update_team_metadata_cache_task
...
class TestCacheStats(BaseTest):
    ...
    def test_get_cache_stats_basic(self, mock_get_client):
        ...
        from src.skills.analysis.posthog.storage.team_metadata_cache import get_cache_stats
...
class TestVerifyTeamMetadata(BaseTest):
    ...
    def test_verify_ignores_extra_cached_fields(self, mock_get_metadata):
        ...
        """
        from src.skills.analysis.posthog.storage.team_metadata_cache import _serialize_team_to_metadata
...
class TestWarmCachesExpiryTracking(BaseTest):
    ...
    def test_warm_caches_uses_api_token_for_token_based_cache(self, mock_time, mock_get_client):
        ...
        from src.skills.analysis.posthog.storage.team_metadata_cache import TEAM_CACHE_EXPIRY_SORTED_SET, TEAM_HYPERCACHE_MANAGEMENT_CONFIG
...
class TestTeamMetadataGracePeriod(BaseTest):
    ...
    def test_recently_updated_team_is_in_skip_set(self):
        ...
        from src.skills.analysis.posthog.storage.team_metadata_cache import _get_team_ids_with_recently_updated_teams
    ...
    def test_config_has_skip_fix_function(self):
        ...
        from src.skills.analysis.posthog.storage.team_metadata_cache import TEAM_HYPERCACHE_MANAGEMENT_CONFIG
