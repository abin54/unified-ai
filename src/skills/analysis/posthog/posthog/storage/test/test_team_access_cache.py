...
from src.skills.analysis.posthog.storage.team_access_cache import TOKEN_CACHE_PREFIX, TokenAuthCache
...
class TestTokenAuthCache(TestCase):
    ...
    def test_invalidate_team_tokens_deletes_secret_tokens(self):
        ...
        from src.skills.analysis.posthog.models.utils import generate_random_token_secret, hash_key_value
