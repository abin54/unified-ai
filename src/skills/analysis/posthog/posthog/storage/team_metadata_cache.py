...
Manual invalidation:
    from src.skills.analysis.posthog.storage.team_metadata_cache import clear_team_metadata_cache
...
from src.skills.analysis.posthog.storage.hypercache import HyperCache, HyperCacheStoreMissing, KeyType
