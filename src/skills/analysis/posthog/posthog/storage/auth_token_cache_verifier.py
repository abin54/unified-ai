...
def _unpickle_json(raw_bytes: bytes) -> dict | None:
    ...
    try:
        # nosemgrep: python.lang.security.deserialization.pickle.avoid-pickle (internal Redis cache, data is self-generated by our Rust service)
        unpickled = pickle.loads(raw_bytes)  # noqa: S301
