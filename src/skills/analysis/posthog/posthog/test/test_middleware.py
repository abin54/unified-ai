...
from src.skills.analysis.posthog.test.base import APIBaseTest, FuzzyInt, override_settings
...
from src.skills.analysis.posthog.api.test.test_organization import create_organization
from src.skills.analysis.posthog.api.test.test_team import create_team
from src.skills.analysis.posthog.models import Action, Cohort, FeatureFlag, Insight
...
from src.skills.analysis.posthog.settings import SITE_URL
...
class TestActivityLoggingMiddleware(APIBaseTest):
    def setUp(self):
        ...
        from src.skills.analysis.posthog.middleware import ActivityLoggingMiddleware
        from src.skills.analysis.posthog.models.activity_logging.utils import activity_storage
    ...
    def test_long_header_value_is_truncated(self):
        from src.skills.analysis.posthog.models.activity_logging.utils import ACTIVITY_LOG_CLIENT_MAX_LENGTH
...
class TestSocialAuthExceptionMiddleware(APIBaseTest):
    ...
    def setUp(self):
        ...
        from src.skills.analysis.posthog.middleware import SocialAuthExceptionMiddleware
...
def test_oauth_coop_middleware(path, query_string, expected_coop):
    ...
    from src.skills.analysis.posthog.middleware import OAuthCoopMiddleware
