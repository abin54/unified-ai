from src.skills.analysis.posthog.models.batch_imports import BatchImport
from src.skills.analysis.posthog.test.activity_log_utils import ActivityLogTestHelper
...
class TestBatchImportActivityLogging(ActivityLogTestHelper):
    ...
    def test_batch_import_field_exclusions_configured(self):
        ...
        from src.skills.analysis.posthog.models.activity_logging.activity_log import field_exclusions
    ...
    def test_batch_import_scope_in_activity_log_types(self):
        ...
        from src.skills.analysis.posthog.models.activity_logging.activity_log import ActivityScope
    ...
    def test_batch_import_masked_fields_configured(self):
        ...
        from src.skills.analysis.posthog.models.activity_logging.activity_log import field_with_masked_contents
