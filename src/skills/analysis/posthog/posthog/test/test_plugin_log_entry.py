...
from src.skills.analysis.posthog.models import Plugin, PluginConfig
from src.skills.analysis.posthog.models.plugin import PluginLogEntrySource, PluginLogEntryType, fetch_plugin_log_entries
...
def create_plugin_log_entry(
    *,
    ...
    from src.skills.analysis.posthog.clickhouse.plugin_log_entries import INSERT_PLUGIN_LOG_ENTRY_SQL
