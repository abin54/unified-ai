...
from src.skills.analysis.posthog.management.commands.generate_demo_data import Command as GenerateDemoDataCommand
from src.skills.analysis.posthog.models import Insight, PersonalAPIKey, Team, User
from src.skills.analysis.posthog.models.insight_variable import InsightVariable
from src.skills.analysis.posthog.models.utils import hash_key_value, mask_key_value
...
def _create_events_and_persons(data: PlaywrightWorkspaceSetupData, team: Team) -> None:
    ...
    from src.skills.analysis.posthog.models import Person, PersonDistinctId
