...
from src.skills.analysis.posthog.permissions import AccessControlPermission, PostHogFeatureFlagPermission
...
class TestAccessControlPermission(BaseTest):
    ...
    def test_has_permission_with_project_secret_api_token_authentication(self):
        ...
        from src.skills.analysis.posthog.auth import ProjectSecretAPIKeyAuthentication
...
class TestTeamMemberAccessPermission(BaseTest):
    ...
    def setUp(self):
        super().setUp()
        from src.skills.analysis.posthog.permissions import TeamMemberAccessPermission
