...
from src.skills.analysis.posthog.helpers.two_factor_session import enforce_two_factor
from src.skills.analysis.posthog.jwt import PosthogJwtAudience, decode_jwt
from src.skills.analysis.posthog.models.oauth import OAuthAccessToken, OAuthApplication, OAuthApplicationAuthBrand
from src.skills.analysis.posthog.models.personal_api_key import (
...
from src.skills.analysis.posthog.models.utils import hash_key_value
from src.skills.analysis.posthog.models.webauthn_credential import WebauthnCredential
from src.skills.analysis.posthog.passkey import verify_passkey_authentication_response
from src.skills.analysis.posthog.settings import LOCAL_DEV_INTERNAL_API_SECRET
...
if TYPE_CHECKING:
    from src.skills.analysis.posthog.models.share_password import SharePassword
...
class PersonalAPIKeyAuthentication(authentication.BaseAuthentication):
    ...
    def validate_key(cls, personal_api_key_with_source):
        from src.skills.analysis.posthog.models import PersonalAPIKey
