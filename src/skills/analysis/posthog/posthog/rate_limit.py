...
from src.skills.analysis.posthog.metrics import LABEL_PATH, LABEL_ROUTE, LABEL_TEAM_ID
...
from src.skills.analysis.posthog.utils import patchable
...
class IPThrottle(SimpleRateThrottle):
    ...
    def get_cache_key(self, request, view):
        from src.skills.analysis.posthog.utils import get_ip_address
...
class EmailMFAResendThrottle(UserOrEmailRateThrottle):
    ...
    def get_cache_key(self, request, view):
        from src.skills.analysis.posthog.helpers.two_factor_session import email_mfa_verifier
