...
from src.skills.analysis.posthog.temporal.health_checks.models import BatchDetectFn

if TYPE_CHECKING:
    from src.skills.analysis.posthog.clickhouse.query_tagging import Product
    from src.skills.analysis.posthog.temporal.health_checks.framework import HealthCheckRegistration
