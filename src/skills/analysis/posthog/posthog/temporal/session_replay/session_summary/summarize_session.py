...
from src.skills.analysis.posthog.schema import ReplayInactivityPeriod
...
from src.skills.analysis.posthog.temporal.session_replay.session_summary.activities import (
    CaptureTimingInputs,
...
from src.skills.analysis.posthog.temporal.session_replay.session_summary.types.single import (
    SingleSessionProgress,
    SingleSessionSummaryInputs,
)
from src.skills.analysis.posthog.temporal.session_replay.session_summary.types.video import (
    VideoSegmentOutput,
    VideoSegmentSpec,
