...
from src.skills.analysis.posthog.temporal.messaging.realtime_cohort_calculation_workflow import flush_kafka_batch
...
class TestBatchFlushingBehavior:
    ...
    def test_flush_batch_size_env_var_configuration(self):
        ...
        import src.skills.analysis.posthog.temporal.messaging.realtime_cohort_calculation_workflow as module
