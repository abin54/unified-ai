...
from src.skills.analysis.posthog.temporal.ai.research_agent import ResearchAgentWorkflowInputs, process_research_agent_activity
...
class TestProcessResearchAgentActivity:
    ...
    async def test_activity_forwards_billing_context(
        ...
        from src.skills.analysis.posthog.schema import MaxBillingContext, MaxBillingContextSettings, MaxBillingContextSubscriptionLevel
