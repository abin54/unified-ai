...
import pytest
from src.skills.analysis.posthog.test.base import QueryMatchingTest, snapshot_postgres_queries_context
...
from src.skills.analysis.posthog.schema import NodeKind

import src.skills.analysis.posthog.schema_migrations as schema_migrations_module
from src.skills.analysis.posthog.models.insight import Insight
from src.skills.analysis.posthog.schema_migrations import LATEST_VERSIONS, MIGRATIONS, SchemaMigration, _discover_migrations
from src.skills.analysis.posthog.temporal.product_analytics.upgrade_queries_activities import (
    GetInsightsToMigrateActivityInputs,
    MigrateInsightsBatchActivityInputs,
    get_insights_to_migrate,
    migrate_insights_batch,
)
from src.skills.analysis.posthog.temporal.product_analytics.upgrade_queries_workflow import (
