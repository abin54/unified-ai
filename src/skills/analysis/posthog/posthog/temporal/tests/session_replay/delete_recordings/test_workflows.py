...
from src.skills.analysis.posthog.temporal.session_replay.delete_recordings.workflows import (
...
def test_queue_delete_team_recordings(team_ids, expected_calls):
    from src.skills.analysis.posthog.tasks.tasks import _queue_delete_team_recordings
