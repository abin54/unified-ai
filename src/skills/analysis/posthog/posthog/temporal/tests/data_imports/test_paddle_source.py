...
from src.skills.analysis.posthog.temporal.data_imports.sources.paddle.settings import ENDPOINTS
from src.skills.analysis.posthog.temporal.data_imports.sources.paddle.source import PaddleSource
...
def test_paddle_request_fails_fast(mock_request):
    ...
    from src.skills.analysis.posthog.temporal.data_imports.sources.paddle.paddle import _get_paddle_session, paddle_request
