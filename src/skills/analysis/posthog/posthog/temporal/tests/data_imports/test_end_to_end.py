...
from src.skills.analysis.posthog.hogql_queries.insights.funnels.funnel import FunnelUDF
from src.skills.analysis.posthog.hogql_queries.insights.funnels.funnel_query_context import FunnelQueryContext
from src.skills.analysis.posthog.models import DataWarehouseTable
from src.skills.analysis.posthog.models.hog_functions.hog_function import HogFunction
from src.skills.analysis.posthog.models.team.team import Team
from src.skills.analysis.posthog.temporal.common.shutdown import ShutdownMonitor, WorkerShuttingDownError
from src.skills.analysis.posthog.temporal.data_imports.cdp_producer_job import CDPProducerJobWorkflow
from src.skills.analysis.posthog.temporal.data_imports.external_data_job import ExternalDataJobWorkflow
from src.skills.analysis.posthog.temporal.data_imports.pipelines.pipeline.consts import PARTITION_KEY
from src.skills.analysis.posthog.temporal.data_imports.pipelines.pipeline.delta_table_helper import DeltaTableHelper
from src.skills.analysis.posthog.temporal.data_imports.pipelines.pipeline.pipeline import PipelineNonDLT
from src.skills.analysis.posthog.temporal.data_imports.pipelines.pipeline_v3.load.processor import process_message
from src.skills.analysis.posthog.temporal.data_imports.pipelines.pipeline_v3.pipeline import PipelineV3
from src.skills.analysis.posthog.temporal.data_imports.row_tracking import get_rows
from src.skills.analysis.posthog.temporal.data_imports.settings import ACTIVITIES
from src.skills.analysis.posthog.temporal.data_imports.sources.common.registry import SourceRegistry
from src.skills.analysis.posthog.temporal.data_imports.sources.common.rest_source.rest_client import RESTClient as PostHogRESTClient
from src.skills.analysis.posthog.temporal.data_imports.sources.common.webhook_s3 import WebhookSourceManager
from src.skills.analysis.posthog.temporal.data_imports.sources.stripe.constants import (
...
from src.skills.analysis.posthog.temporal.data_imports.sources.stripe.custom import InvoiceListWithAllLines
from src.skills.analysis.posthog.temporal.data_imports.workflow_activities.calculate_table_size import (
    CalculateTableSizeActivityInputs,
    calculate_table_size_activity,
)
from src.skills.analysis.posthog.temporal.data_imports.workflow_activities.sync_new_schemas import ExternalDataSourceType
from src.skills.analysis.posthog.temporal.ducklake import ACTIVITIES as DUCKLAKE_ACTIVITIES
from src.skills.analysis.posthog.temporal.ducklake.ducklake_copy_data_imports_workflow import DuckLakeCopyDataImportsWorkflow
from src.skills.analysis.posthog.temporal.utils import ExternalDataWorkflowInputs
...
async def test_v3_delta_commit_metadata_and_idempotency_fallback(team, stripe_customer, mock_stripe_client):
    ...
    from src.skills.analysis.posthog.temporal.data_imports.pipelines.pipeline_v3.load.idempotency import is_batch_already_processed
