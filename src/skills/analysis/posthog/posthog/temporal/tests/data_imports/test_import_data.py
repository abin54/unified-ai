...
from src.skills.analysis.posthog.tasks.test.test_usage_report import freeze_time
...
def test_report_heartbeat_timeout_first_attempt(team):
    ...
    with mock.patch(
        ...
        from src.skills.analysis.posthog.temporal.data_imports.pipelines.common.extract import report_heartbeat_timeout
