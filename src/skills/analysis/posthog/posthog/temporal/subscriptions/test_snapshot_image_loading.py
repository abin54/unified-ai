...
from src.skills.analysis.posthog.temporal.subscriptions.snapshot_activities import (
    MAX_SUMMARY_IMAGES,
...
def _over_image_size_cap_scenario(team, user):
    from src.skills.analysis.posthog.temporal.subscriptions import snapshot_activities
