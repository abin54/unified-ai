...
from src.skills.analysis.posthog.temporal.llm_analytics.eval_reports.activities import _period_for_scheduled_report
...
class TestDogfoodTeamAllowlist(BaseTest):
    ...
    def test_count_triggered_filter_includes_only_allowlisted_teams(self):
        ...
        with patch(
            ...
            from src.skills.analysis.posthog.temporal.llm_analytics.eval_reports.activities import DOGFOOD_TEAM_IDS
