...
def get_generation_details(
    ...
    from src.skills.analysis.posthog.temporal.llm_analytics.evaluation_clustering.data import fetch_generation_contents
...
def get_evaluator_config(
    ...
    """
    from src.skills.analysis.posthog.models.team import Team
    from src.skills.analysis.posthog.temporal.llm_analytics.evaluation_clustering.data import fetch_evaluator_configs
