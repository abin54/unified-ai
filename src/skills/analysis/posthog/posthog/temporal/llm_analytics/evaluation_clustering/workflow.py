...
from src.skills.analysis.posthog.temporal.llm_analytics.evaluation_clustering.models import (
    SamplerActivityInputs,
    SamplerWorkflowInputs,
    SamplerWorkflowResult,
)
from src.skills.analysis.posthog.temporal.llm_analytics.evaluation_clustering.sampling import sample_and_embed_for_job_activity
...
class LLMAEvaluationClusteringWorkflow(PostHogWorkflow):
    ...
    async def run(self, inputs: SamplerWorkflowInputs) -> SamplerWorkflowResult:
        ...
        from src.skills.analysis.posthog.temporal.llm_analytics.evaluation_clustering.activities import (
            METADATA_LOOKBACK,
