...
from src.skills.analysis.posthog.temporal.llm_analytics.evaluation_clustering.models import SamplerActivityInputs, SamplerActivityResult
...
def _sample_and_embed_sync(inputs: SamplerActivityInputs) -> SamplerActivityResult:
    ...
    from src.skills.analysis.posthog.schema import EmbeddingModelName
