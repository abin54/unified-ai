...
from src.skills.analysis.posthog.temporal.llm_analytics.trace_summarization.fetch_and_format import (
    _format_generation_text_repr,
    fetch_and_format_activity,
)
from src.skills.analysis.posthog.temporal.llm_analytics.trace_summarization.models import FetchAndFormatInput
...
class TestFetchAndFormatActivity:
    ...
    async def test_trace_success_stores_in_redis(self, mock_team):
        from src.skills.analysis.posthog.schema import LLMTrace, LLMTracePerson
    ...
    async def test_oversized_trace_returns_skipped(self, mock_team):
        from src.skills.analysis.posthog.schema import LLMTrace, LLMTraceEvent, LLMTracePerson
