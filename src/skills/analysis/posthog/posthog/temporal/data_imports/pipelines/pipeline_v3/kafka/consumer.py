...
from src.skills.analysis.posthog.kafka_client.client import _KafkaProducer, _KafkaSecurityProtocol
from src.skills.analysis.posthog.kafka_client.routing import get_producer, get_profile_settings, resolve_profile_name
from src.skills.analysis.posthog.temporal.data_imports.pipelines.pipeline_v3.kafka.metrics import (
...
from src.skills.analysis.posthog.temporal.data_imports.pipelines.pipeline_v3.load.config import ConsumerConfig
from src.skills.analysis.posthog.temporal.data_imports.pipelines.pipeline_v3.load.retry_tracker import (
    TRANSIENT_ERRORS,
    RetryExhaustedError,
    classify_error,
    clear_retry_info,
...
class KafkaConsumerService:
    ...
    def _mark_job_failed_from_message(self, message: Any, error: Exception) -> None:
        ...
        try:
            from src.skills.analysis.posthog.temporal.data_imports.pipelines.pipeline_v3.kafka.common import ExportSignalMessage
            from src.skills.analysis.posthog.temporal.data_imports.pipelines.pipeline_v3.load.processor import _mark_job_failed
