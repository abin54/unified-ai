...
from src.skills.analysis.posthog.temporal.data_imports.pipelines.common.load import (
...
class PipelineNonDLT(Generic[ResumableData]):
    ...
    async def _post_run_operations(self, row_count: int):
        ...
        if self._schema.sync_type == ExternalDataSchema.SyncType.CDC and self._schema.cdc_table_mode in (
            ...
            from src.skills.analysis.posthog.temporal.data_imports.pipelines.common.load import _seed_cdc_companion_from_snapshot
