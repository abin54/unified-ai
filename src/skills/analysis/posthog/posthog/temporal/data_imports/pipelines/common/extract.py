...
from src.skills.analysis.posthog.redis import get_async_client
from src.skills.analysis.posthog.sync import database_sync_to_async_pool
from src.skills.analysis.posthog.temporal.data_imports.pipelines.common.load import get_incremental_field_value
...
from src.skills.analysis.posthog.temporal.data_imports.row_tracking import decrement_rows, increment_rows, will_hit_billing_limit
from src.skills.analysis.posthog.temporal.data_imports.util import NonRetryableException

if TYPE_CHECKING:
    from src.skills.analysis.posthog.temporal.data_imports.pipelines.pipeline_sync import PipelineInputs
    from src.skills.analysis.posthog.temporal.data_imports.workflow_activities.import_data_sync import ImportDataActivityInputs
...
async def update_row_tracking_after_batch(
    ...
    from src.skills.analysis.posthog.temporal.data_imports.pipelines.common.load import update_job_row_count
