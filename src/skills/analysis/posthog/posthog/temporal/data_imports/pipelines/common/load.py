...
from src.skills.analysis.posthog.temporal.data_imports.pipelines.helpers import sync_revenue_analytics_views
from src.skills.analysis.posthog.temporal.data_imports.pipelines.pipeline.utils import normalize_column_name
from src.skills.analysis.posthog.temporal.data_imports.pipelines.pipeline_sync import set_initial_sync_complete
from src.skills.analysis.posthog.temporal.data_imports.util import prepare_s3_files_for_querying
...
if TYPE_CHECKING:
    ...
    from src.skills.analysis.posthog.temporal.data_imports.pipelines.pipeline.typings import SourceResponse
...
async def _seed_cdc_companion_from_snapshot(
    ...
    from src.skills.analysis.posthog.temporal.data_imports.cdc.batcher import (
        CDC_OP_COLUMN,
...
async def run_post_load_operations(
    ...
    """
    from src.skills.analysis.posthog.temporal.data_imports.pipelines.common.extract import finalize_desc_sort_incremental_value
    from src.skills.analysis.posthog.temporal.data_imports.pipelines.helpers import build_table_name
    from src.skills.analysis.posthog.temporal.data_imports.pipelines.pipeline_sync import (
        register_cdc_companion_table,
        update_last_synced_at,
        validate_schema_and_update_table,
    )
    from src.skills.analysis.posthog.temporal.data_imports.pipelines.pipeline_v3.load.metrics import POST_LOAD_DURATION_SECONDS
