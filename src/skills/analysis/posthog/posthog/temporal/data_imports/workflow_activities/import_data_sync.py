...
from src.skills.analysis.posthog.temporal.common.heartbeat import LivenessHeartbeater as Heartbeater
...
from src.skills.analysis.posthog.temporal.data_imports.pipelines.pipeline.pipeline import PipelineNonDLT, PipelineResult
from src.skills.analysis.posthog.temporal.data_imports.pipelines.pipeline.typings import SourceInputs, SourceResponse
from src.skills.analysis.posthog.temporal.data_imports.pipelines.pipeline_sync import PipelineInputs
from src.skills.analysis.posthog.temporal.data_imports.row_tracking import setup_row_tracking
from src.skills.analysis.posthog.temporal.data_imports.sources import SourceRegistry
from src.skills.analysis.posthog.temporal.data_imports.sources.common.base import ResumableSource, SimpleSource
from src.skills.analysis.posthog.temporal.data_imports.sources.common.resumable import ResumableSourceManager
from src.skills.analysis.posthog.temporal.data_imports.sources.postgres.exceptions import CDCHandledExternally
...
async def _run(
    ...
    try:
        ...
        if use_v3:
            from src.skills.analysis.posthog.temporal.data_imports.pipelines.pipeline_v3 import PipelineV3
