...
def _register_all_emitters() -> None:
    from src.skills.analysis.posthog.temporal.data_imports.signals.conversations_tickets import CONVERSATIONS_TICKETS_CONFIG
    from src.skills.analysis.posthog.temporal.data_imports.signals.github_issues import GITHUB_ISSUES_CONFIG
    from src.skills.analysis.posthog.temporal.data_imports.signals.linear_issues import LINEAR_ISSUES_CONFIG
    from src.skills.analysis.posthog.temporal.data_imports.signals.zendesk_tickets import ZENDESK_TICKETS_CONFIG
