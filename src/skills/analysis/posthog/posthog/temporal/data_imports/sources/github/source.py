...
from src.skills.analysis.posthog.models.integration import GitHubIntegration
...
from src.skills.analysis.posthog.temporal.data_imports.sources.generated_configs import GithubSourceConfig
from src.skills.analysis.posthog.temporal.data_imports.sources.github.github import (
    GithubResumeConfig,
    github_source,
    validate_credentials as validate_github_credentials,
)
from src.skills.analysis.posthog.temporal.data_imports.sources.github.settings import ENDPOINTS, INCREMENTAL_FIELDS
