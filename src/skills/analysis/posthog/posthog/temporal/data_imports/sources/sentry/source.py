...
from src.skills.analysis.posthog.temporal.data_imports.sources.generated_configs import SentrySourceConfig
from src.skills.analysis.posthog.temporal.data_imports.sources.sentry.sentry import (
    sentry_source,
