...
from src.skills.analysis.posthog.temporal.data_imports.sources.generated_configs import VitallySourceConfig
from src.skills.analysis.posthog.temporal.data_imports.sources.vitally.settings import (
    ENDPOINTS as VITALLY_ENDPOINTS,
    INCREMENTAL_FIELDS as VITALLY_INCREMENTAL_FIELDS,
)
from src.skills.analysis.posthog.temporal.data_imports.sources.vitally.vitally import (
