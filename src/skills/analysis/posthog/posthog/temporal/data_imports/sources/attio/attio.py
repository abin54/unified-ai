...
from src.skills.analysis.posthog.temporal.data_imports.sources.attio.settings import ATTIO_ENDPOINTS
...
from src.skills.analysis.posthog.temporal.data_imports.sources.common.rest_source.typing import Endpoint, EndpointResource
