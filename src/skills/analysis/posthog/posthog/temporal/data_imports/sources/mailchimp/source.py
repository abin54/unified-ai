...
from src.skills.analysis.posthog.temporal.data_imports.sources.generated_configs import MailchimpSourceConfig
from src.skills.analysis.posthog.temporal.data_imports.sources.mailchimp.mailchimp import (
    MailchimpResumeConfig,
    mailchimp_source,
    validate_credentials as validate_mailchimp_credentials,
)
from src.skills.analysis.posthog.temporal.data_imports.sources.mailchimp.settings import ENDPOINTS, INCREMENTAL_FIELDS
