...
from src.skills.analysis.posthog.temporal.data_imports.sources.common.webhook_s3 import WAREHOUSE_WEBHOOK_FLAG, WebhookSourceManager

if TYPE_CHECKING:
    from src.skills.analysis.posthog.cdp.templates.hog_function_template import HogFunctionTemplateDC
...
from src.skills.analysis.posthog.temporal.data_imports.sources.common.base import (
    ExternalWebhookInfo,
    FieldType,
    ResumableSource,
...
from src.skills.analysis.posthog.temporal.data_imports.sources.common.mixins import OAuthMixin
...
from src.skills.analysis.posthog.temporal.data_imports.sources.generated_configs import StripeSourceConfig
...
from src.skills.analysis.posthog.temporal.data_imports.sources.stripe.settings import (
    APPEND_ONLY_INCREMENTAL_FIELDS as STRIPE_APPEND_ONLY_INCREMENTAL_FIELDS,
    ENDPOINTS as STRIPE_ENDPOINTS,
)
from src.skills.analysis.posthog.temporal.data_imports.sources.stripe.stripe import (
...
class StripeSource(
    ...
    def webhook_template(self) -> Optional["HogFunctionTemplateDC"]:
        from src.skills.analysis.posthog.temporal.data_imports.sources.stripe.webhook_template import template
