...
from src.skills.analysis.posthog.temporal.data_imports.sources.generated_configs import SlackSourceConfig
from src.skills.analysis.posthog.temporal.data_imports.sources.slack.settings import ENDPOINTS, messages_endpoint_config
from src.skills.analysis.posthog.temporal.data_imports.sources.slack.slack import (
    SlackResumeConfig,
    get_channels,
    slack_source,
