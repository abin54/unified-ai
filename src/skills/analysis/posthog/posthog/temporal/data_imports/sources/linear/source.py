...
from src.skills.analysis.posthog.models.integration import OauthIntegration
...
from src.skills.analysis.posthog.temporal.data_imports.sources.generated_configs import LinearSourceConfig
from src.skills.analysis.posthog.temporal.data_imports.sources.linear.linear import (
    LinearResumeConfig,
    linear_source,
    validate_credentials as validate_linear_credentials,
)
from src.skills.analysis.posthog.temporal.data_imports.sources.linear.settings import ENDPOINTS, INCREMENTAL_FIELDS
