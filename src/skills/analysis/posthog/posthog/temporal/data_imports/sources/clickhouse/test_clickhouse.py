...
from src.skills.analysis.posthog.temporal.data_imports.sources.clickhouse.source import ClickHouseSource
...
class TestGetClickhouseRowCount:
    ...
    def _run(self, responses):
        ...
        from src.skills.analysis.posthog.temporal.data_imports.sources.clickhouse import clickhouse as ch_module
...
class TestSourceClassValidateCredentials:
    ...
    def test_returns_error_when_clickhouse_connection_fails(self):
        from src.skills.analysis.posthog.temporal.data_imports.sources.clickhouse import source as source_module
        from src.skills.analysis.posthog.temporal.data_imports.sources.clickhouse.clickhouse import ClickHouseConnectionError
