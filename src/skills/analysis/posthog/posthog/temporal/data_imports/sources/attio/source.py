...
from src.skills.analysis.posthog.temporal.data_imports.sources.attio.attio import (
    attio_source,
...
from src.skills.analysis.posthog.temporal.data_imports.sources.generated_configs import AttioSourceConfig
