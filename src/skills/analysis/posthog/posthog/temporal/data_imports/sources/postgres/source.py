...
from src.skills.analysis.posthog.temporal.data_imports.sources.common.mixins import SSHTunnelMixin, ValidateDatabaseHostMixin
...
from src.skills.analysis.posthog.temporal.data_imports.sources.generated_configs import PostgresSourceConfig
from src.skills.analysis.posthog.temporal.data_imports.sources.postgres.postgres import (
    SSLRequiredError,
...
class PostgresSource(SimpleSource[PostgresSourceConfig], SSHTunnelMixin, ValidateDatabaseHostMixin):
    ...
    def check_cdc_prerequisites(
        ...
        """
        from src.skills.analysis.posthog.temporal.data_imports.sources.postgres.cdc.prerequisite_validator import validate_cdc_prerequisites
        from src.skills.analysis.posthog.temporal.data_imports.sources.postgres.postgres import _connect_to_postgres
