...
from src.skills.analysis.posthog.temporal.data_imports.sources.generated_configs import GoogleAdsSourceConfig
from src.skills.analysis.posthog.temporal.data_imports.sources.google_ads.schemas import FIELD_ALIASES, RESOURCE_SCHEMAS
