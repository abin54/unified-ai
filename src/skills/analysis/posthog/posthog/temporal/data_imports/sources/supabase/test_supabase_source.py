from src.skills.analysis.posthog.schema import SourceFieldInputConfig

from src.skills.analysis.posthog.temporal.data_imports.sources.supabase.source import SupabaseSource
