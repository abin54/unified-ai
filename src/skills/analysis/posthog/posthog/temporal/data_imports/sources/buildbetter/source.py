...
from src.skills.analysis.posthog.temporal.data_imports.sources.buildbetter.buildbetter import (
    BuildBetterResumeConfig,
    buildbetter_source,
    validate_credentials as validate_buildbetter_credentials,
)
from src.skills.analysis.posthog.temporal.data_imports.sources.buildbetter.settings import ENDPOINTS, INCREMENTAL_FIELDS
...
from src.skills.analysis.posthog.temporal.data_imports.sources.generated_configs import BuildBetterSourceConfig
