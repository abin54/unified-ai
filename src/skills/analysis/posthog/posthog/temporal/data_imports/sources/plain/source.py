...
from src.skills.analysis.posthog.temporal.data_imports.sources.generated_configs import PlainSourceConfig
from src.skills.analysis.posthog.temporal.data_imports.sources.plain.plain import (
    plain_source,
    validate_credentials as validate_plain_credentials,
)
from src.skills.analysis.posthog.temporal.data_imports.sources.plain.settings import ENDPOINTS, INCREMENTAL_FIELDS
