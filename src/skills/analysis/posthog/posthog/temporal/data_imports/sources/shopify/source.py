...
from src.skills.analysis.posthog.temporal.data_imports.sources.generated_configs import ShopifySourceConfig
from src.skills.analysis.posthog.temporal.data_imports.sources.shopify.constants import SHOPIFY_GRAPHQL_OBJECTS
from src.skills.analysis.posthog.temporal.data_imports.sources.shopify.settings import ENDPOINT_CONFIGS
from src.skills.analysis.posthog.temporal.data_imports.sources.shopify.shopify import (
