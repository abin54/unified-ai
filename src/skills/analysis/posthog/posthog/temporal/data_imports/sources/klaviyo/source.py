...
from src.skills.analysis.posthog.temporal.data_imports.sources.generated_configs import KlaviyoSourceConfig
from src.skills.analysis.posthog.temporal.data_imports.sources.klaviyo.klaviyo import (
    KlaviyoResumeConfig,
    klaviyo_source,
    validate_credentials as validate_klaviyo_credentials,
)
from src.skills.analysis.posthog.temporal.data_imports.sources.klaviyo.settings import ENDPOINTS, INCREMENTAL_FIELDS
