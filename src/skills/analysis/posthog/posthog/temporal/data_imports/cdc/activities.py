...
from src.skills.analysis.posthog.temporal.data_imports.pipelines.pipeline_v3.kafka.common import SyncTypeLiteral
from src.skills.analysis.posthog.temporal.data_imports.pipelines.pipeline_v3.kafka.producer import KafkaBatchProducer
from src.skills.analysis.posthog.temporal.data_imports.pipelines.pipeline_v3.s3.writer import S3BatchWriter
from src.skills.analysis.posthog.temporal.data_imports.workflow_activities.create_job_model import _build_schema_snapshot
...
class CDCExtractActivity:
    ...
    def _flush_deferred_runs(self, schema: ExternalDataSchema) -> None:
        ...
        for run_meta in deferred_runs:
            ...
            from src.skills.analysis.posthog.temporal.data_imports.pipelines.pipeline_v3.s3 import BatchWriteResult
