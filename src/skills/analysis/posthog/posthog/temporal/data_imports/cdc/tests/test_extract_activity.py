...
from src.skills.analysis.posthog.temporal.data_imports.cdc.activities import CDCExtractActivity, CDCExtractInput, cdc_extract_activity
from src.skills.analysis.posthog.temporal.data_imports.cdc.types import ChangeEvent
...
class TestGetCDCAdapter:
    def test_returns_postgres_adapter(self):
        from src.skills.analysis.posthog.temporal.data_imports.cdc.adapters import get_cdc_adapter
        from src.skills.analysis.posthog.temporal.data_imports.sources.postgres.cdc.adapter import PostgresCDCAdapter
    ...
    def test_create_reader_extracts_params(self):
        from src.skills.analysis.posthog.temporal.data_imports.sources.postgres.cdc.adapter import PostgresCDCAdapter
        from src.skills.analysis.posthog.temporal.data_imports.sources.postgres.cdc.stream_reader import PgCDCStreamReader
...
class TestCDCExtractActivity:
    ...
    def test_micro_batch_flush_sends_kafka_immediately(
        ...
        from src.skills.analysis.posthog.temporal.data_imports.cdc.batcher import ChangeEventBatcher as RealBatcher
