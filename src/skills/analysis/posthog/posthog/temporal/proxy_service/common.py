...
from src.skills.analysis.posthog.temporal.proxy_service.proto import ProxyProvisionerServiceStub
...
def activity_send_proxy_created_email(inputs: SendProxyCreatedEmailInputs):
    ...
    from src.skills.analysis.posthog.email import EmailMessage, is_email_available
