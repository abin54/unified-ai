...
from src.skills.analysis.posthog.temporal.proxy_service.proto.proxy_provisioner_pb2 import (
    READY as CertificateState_READY,
    CreateRequest,
    DeleteRequest,
    StatusRequest,
)
from src.skills.analysis.posthog.temporal.proxy_service.proto.proxy_provisioner_pb2_grpc import ProxyProvisionerServiceStub
