...
from src.skills.analysis.posthog.temporal.proxy_service.cloudflare import (
    CloudflareAPIError,
    CustomHostnameSSLStatus,
    get_custom_hostname_by_domain,
)
from src.skills.analysis.posthog.temporal.proxy_service.common import (
    CaptureEventInputs,
...
from src.skills.analysis.posthog.temporal.proxy_service.proto import CertificateState_READY, StatusRequest
...
async def cleanup_monitor_job(inputs: CleanupMonitorJobInputs):
    from src.skills.analysis.posthog.temporal.common.schedule import a_delete_schedule, a_schedule_exists
