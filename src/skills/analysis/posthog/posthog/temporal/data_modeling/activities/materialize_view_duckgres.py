...
from src.skills.analysis.posthog.ducklake.common import get_duckgres_server_for_team, is_dev_mode
...
def _compile_hogql_to_postgres_sql(hogql_query: str, team_id: int) -> tuple[str, dict[str, object]]:
    from src.skills.analysis.posthog.schema import HogQLQuery

    from src.skills.analysis.posthog.ducklake.client import compile_hogql_to_ducklake_sql
...
async def materialize_view_duckgres_activity(inputs: DuckgresShadowInputs) -> DuckgresShadowResult:
    ...
    try:
        ...
        from src.skills.analysis.posthog.ducklake.client import execute_ducklake_create_table
