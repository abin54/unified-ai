...
if typing.TYPE_CHECKING:
    from src.skills.analysis.posthog.kafka_client.client import _AsyncKafkaProducer
...
class KafkaLogProducerFromQueueAsync:
    ...
    def __init__(
        ...
        from src.skills.analysis.posthog.kafka_client.routing import new_async_producer
