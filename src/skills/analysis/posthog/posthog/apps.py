...
from src.skills.analysis.posthoganalytics.client import Client

from src.skills.analysis.posthog.git import get_git_branch, get_git_commit_short
from src.skills.analysis.posthog.tasks.tasks import sync_all_organization_available_product_features
from src.skills.analysis.posthog.utils import get_instance_region, get_machine_id, initialize_self_capture_api_token, str_to_bool
...
class PostHogConfig(AppConfig):
    ...
    def ready(self):
        import src.skills.analysis.posthog.storage.team_access_cache_signal_handlers  # noqa: F401
        ...
        if not posthoganalytics.disabled:
            from src.skills.analysis.posthog.feature_flags.sdk_cache_provider import HyperCacheFlagProvider
        ...
        from src.skills.analysis.posthog.async_migrations.setup import setup_async_migrations
        ...
        from src.skills.analysis.posthog.api.file_system import registrations as file_system_registrations
        from src.skills.analysis.posthog.tasks.hog_functions import queue_sync_hog_function_templates
    ...
    def _setup_lazy_admin(self):
        ...
        class LazyAdminRegistry(dict):
            ...
            def _ensure_loaded(self):
                if not self._loaded:
                    from src.skills.analysis.posthog.admin import register_all_admin
