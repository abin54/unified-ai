...
from src.skills.analysis.posthog.api.person import MinimalPersonSerializer
from src.skills.analysis.posthog.api.routing import TeamAndOrgViewSetMixin
from src.skills.analysis.posthog.api.utils import ServerTimingsGathered, action, safe_clickhouse_string
...
from src.skills.analysis.posthog.clickhouse.query_tagging import Feature, Product, tag_queries
from src.skills.analysis.posthog.cloud_utils import is_cloud
from src.skills.analysis.posthog.errors import CHQueryErrorCannotScheduleTask, CHQueryErrorTooManySimultaneousQueries
...
from src.skills.analysis.posthog.models import Organization, Team, User
from src.skills.analysis.posthog.models.activity_logging.activity_log import Detail, log_activity
from src.skills.analysis.posthog.models.comment import Comment
from src.skills.analysis.posthog.models.person.util import get_persons_mapped_by_distinct_id
from src.skills.analysis.posthog.rate_limit import ClickHouseBurstRateThrottle, ClickHouseSustainedRateThrottle, PersonalApiKeyRateThrottle
...
from src.skills.analysis.posthog.renderers import ServerSentEventRenderer
from src.skills.analysis.posthog.session_recordings.ai_data.ai_regex_prompts import AI_REGEX_PROMPTS
from src.skills.analysis.posthog.session_recordings.ai_data.ai_regex_schema import AiRegexSchema
from src.skills.analysis.posthog.session_recordings.models.session_recording import SessionRecording
from src.skills.analysis.posthog.session_recordings.models.session_recording_event import SessionRecordingViewed
from src.skills.analysis.posthog.session_recordings.queries.session_recording_list_from_query import SessionRecordingListFromQuery
from src.skills.analysis.posthog.session_recordings.queries.session_replay_events import SessionReplayEvents
from src.skills.analysis.posthog.session_recordings.recordings import recording_s3_client
from src.skills.analysis.posthog.session_recordings.recordings.errors import BlockFetchError, RecordingDeletedError
from src.skills.analysis.posthog.session_recordings.recordings.recording_api_client import RecordingApiClient, recording_api_client
from src.skills.analysis.posthog.session_recordings.session_recording_v2_service import list_blocks, list_blocks_async
from src.skills.analysis.posthog.session_recordings.utils import (
    clean_prompt_whitespace,
    filter_from_params_to_query,
    query_as_params_to_dict,
)
from src.skills.analysis.posthog.settings.session_replay import SESSION_REPLAY_AI_REGEX_MODEL
from src.skills.analysis.posthog.temporal.session_replay.session_summary.summarize_session import execute_summarize_session_video_stream
...
class SessionRecordingSerializer(serializers.ModelSerializer, UserAccessControlSerializerMixin):
    ...
    def get_external_references(self, obj: SessionRecording) -> list[dict]:
        ...
        from src.skills.analysis.posthog.session_recordings.session_recording_external_reference_api import (
