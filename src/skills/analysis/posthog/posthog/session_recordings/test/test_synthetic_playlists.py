...
from src.skills.analysis.posthog.test.base import APIBaseTest, BaseTest, _create_event, flush_persons_and_events
...
from src.skills.analysis.posthog.models import Comment, SessionRecordingPlaylist
...
class TestSyntheticPlaylists(APIBaseTest):
    ...
    def test_synthetic_playlist_pagination(self) -> None:
        from src.skills.analysis.posthog.session_recordings.synthetic_playlists import WatchedPlaylistSource
