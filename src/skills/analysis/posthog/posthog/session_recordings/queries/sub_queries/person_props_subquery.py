from src.skills.analysis.posthog.schema import FilterLogicalOperator, PropertyGroupFilterValue, RecordingsQuery
...
from src.skills.analysis.posthog.session_recordings.queries.utils import is_person_property, poe_is_active
