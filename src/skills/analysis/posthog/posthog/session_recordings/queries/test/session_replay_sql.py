...
from src.skills.analysis.posthog.clickhouse.log_entries import INSERT_LOG_ENTRY_SQL
from src.skills.analysis.posthog.kafka_client.client import ClickhouseProducer
from src.skills.analysis.posthog.kafka_client.topics import KAFKA_CLICKHOUSE_SESSION_REPLAY_EVENTS, KAFKA_LOG_ENTRIES
...
def produce_replay_summary(
    ...
    *,
    ...
    if ensure_analytics_event_in_session:
        # Only importing from src.skills.analysis.posthog.test.base if needed
        from src.skills.analysis.posthog.test.base import _create_event, flush_persons_and_events
