...
from src.skills.analysis.posthog.models.person.person import READ_DB_FOR_PERSONS, Person
...
from src.skills.analysis.posthog.session_recordings.models.metadata import RecordingMatchingEvents, RecordingMetadata
...
def _fetch_person_by_distinct_id_via_personhog(team_id: int, distinct_id: str) -> Person | None:
    ...
    from src.skills.analysis.posthog.personhog_client.proto import GetPersonByDistinctIdRequest
