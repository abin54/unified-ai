...
from src.skills.analysis.posthog.schema import ClickhouseQueryProgress, QueryStatus
...
from src.skills.analysis.posthog import celery, redis
from src.skills.analysis.posthog.clickhouse.client.async_task_chain import add_task_to_on_commit
from src.skills.analysis.posthog.clickhouse.query_tagging import get_query_tags, tag_queries
from src.skills.analysis.posthog.errors import CHQueryErrorTooManySimultaneousQueries, ExposedCHQueryError
...
from src.skills.analysis.posthog.tasks.tasks import process_query_task
...
def execute_process_query(
    ...
    from src.skills.analysis.posthog.api.services.query import ExecutionMode, process_query_dict
