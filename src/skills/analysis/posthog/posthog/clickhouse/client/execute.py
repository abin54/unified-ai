...
from src.skills.analysis.posthog.clickhouse.client.connection import (
    ClickHouseUser,
    Workload,
    get_client_from_pool,
    get_default_clickhouse_workload_type,
)
from src.skills.analysis.posthog.clickhouse.client.escape import substitute_params
from src.skills.analysis.posthog.clickhouse.client.tracing import trace_clickhouse_query_decorator
from src.skills.analysis.posthog.clickhouse.query_tagging import (
    AccessMethod,
    Feature,
    Product,
    QueryTags,
...
from src.skills.analysis.posthog.errors import clickhouse_error_type, wrap_clickhouse_query_error
from src.skills.analysis.posthog.settings import CLICKHOUSE_PER_TEAM_QUERY_SETTINGS, DEBUG, TEST
from src.skills.analysis.posthog.settings.data_stores import is_enable_analyzer_team
from src.skills.analysis.posthog.temporal.common.clickhouse import update_query_tags_with_temporal_info
from src.skills.analysis.posthog.utils import generate_short_id, patchable
...
def clickhouse_at_least_228() -> bool:
    from src.skills.analysis.posthog.version_requirement import ServiceVersionRequirement
    ...
    *,
    ...
    if DEBUG and not TEST and (tags.product is None or tags.feature is None):
        ...
        raise UntaggedQueryError(
            ...
            "`tag_queries(product=..., feature=...)` from src.skills.analysis.posthog.clickhouse.query_tagging."
        )
    elif (
        not TEST
