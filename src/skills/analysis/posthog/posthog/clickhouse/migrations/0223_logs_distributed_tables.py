...
from src.skills.analysis.posthog.clickhouse.logs import (
    LOG_ATTRIBUTES_DISTRIBUTED_TABLE_SQL,
    LOGS_DISTRIBUTED2_TABLE_SQL,
    LOGS_KAFKA_METRICS_DISTRIBUTED_TABLE_SQL,
)
from src.skills.analysis.posthog.clickhouse.logs.logs_kafka_metrics import LOGS_KAFKA_METRICS_TABLE_SQL
