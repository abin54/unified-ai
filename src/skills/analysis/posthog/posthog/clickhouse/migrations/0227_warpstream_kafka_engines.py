...
from src.skills.analysis.posthog.clickhouse.log_entries import KAFKA_LOG_ENTRIES_WS_TABLE_SQL, LOG_ENTRIES_WS_MV_SQL
from src.skills.analysis.posthog.models.app_metrics2.sql import APP_METRICS2_WS_MV_TABLE_SQL, KAFKA_APP_METRICS2_WS_TABLE_SQL
from src.skills.analysis.posthog.models.tophog.sql import KAFKA_TOPHOG_WS_TABLE_SQL, TOPHOG_WS_MV_SQL
