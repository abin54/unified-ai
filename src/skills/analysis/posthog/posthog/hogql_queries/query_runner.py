...
from src.skills.analysis.posthog.hogql.modifiers import create_default_modifiers_for_user
...
from src.skills.analysis.posthog import settings
from src.skills.analysis.posthog.caching.utils import ThresholdMode, cache_target_age, is_stale, last_refresh_from_cached_result
from src.skills.analysis.posthog.clickhouse.client.connection import Workload
from src.skills.analysis.posthog.clickhouse.client.execute_async import QueryNotFoundError, enqueue_process_query_task, get_query_status
from src.skills.analysis.posthog.clickhouse.client.limit import (
...
from src.skills.analysis.posthog.clickhouse.query_tagging import get_query_tag_value, tag_queries
from src.skills.analysis.posthog.errors import classify_query_error, clickhouse_error_type
from src.skills.analysis.posthog.event_usage import AnalyticsProps, groups, report_user_or_team_action
from src.skills.analysis.posthog.exceptions_capture import capture_exception
from src.skills.analysis.posthog.hogql_queries.insights.utils.breakdowns import has_multi_breakdown, has_single_breakdown
from src.skills.analysis.posthog.hogql_queries.insights.utils.entities import has_data_warehouse_node
from src.skills.analysis.posthog.hogql_queries.insights.utils.properties import has_any_property_filters
from src.skills.analysis.posthog.hogql_queries.query_cache import count_query_cache_hit
from src.skills.analysis.posthog.hogql_queries.query_cache_base import QueryCacheManagerBase
from src.skills.analysis.posthog.hogql_queries.query_cache_factory import get_query_cache_manager
from src.skills.analysis.posthog.hogql_queries.query_metadata import extract_query_metadata
from src.skills.analysis.posthog.hogql_queries.utils.event_usage import log_event_usage_from_query_metadata
from src.skills.analysis.posthog.hogql_queries.validation.validation import (
    QueryValidationContext,
    QueryValidationRule,
    run_validation_rules,
)
from src.skills.analysis.posthog.models import Team, User
from src.skills.analysis.posthog.models.team import WeekStartDay
from src.skills.analysis.posthog.rbac.user_access_control import UserAccessControlError
from src.skills.analysis.posthog.schema_helpers import to_dict
from src.skills.analysis.posthog.utils import generate_cache_key, get_from_dict_or_attr, to_json
...
def get_query_runner(
    ...
    if kind == "ExperimentExposureQuery":
        from src.skills.analysis.posthog.hogql_queries.experiments.experiment_exposures_query_runner import ExperimentExposuresQueryRunner
    ...
    if kind == "SuggestedQuestionsQuery":
        from src.skills.analysis.posthog.hogql_queries.ai.suggested_questions_query_runner import SuggestedQuestionsQueryRunner
    ...
    if kind == "RecordingsQuery":
        from src.skills.analysis.posthog.session_recordings.queries.recordings_query_runner import RecordingsQueryRunner
    ...
    if kind == "TraceSpansQuery":
        from src.skills.analysis.posthog.schema import TraceSpansQuery
    ...
    if kind == "PropertyValuesQuery":
        from src.skills.analysis.posthog.hogql_queries.property_values_query_runner import PropertyValuesQueryRunner
