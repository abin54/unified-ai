...
from src.skills.analysis.posthog.session_recordings.constants import (
    DEFAULT_TOTAL_EVENTS_PER_QUERY,
    EXTRA_SUMMARY_EVENT_FIELDS,
    MAX_TOTAL_EVENTS_PER_QUERY,
)
from src.skills.analysis.posthog.session_recordings.queries.session_replay_events import DEFAULT_EVENT_FIELDS
