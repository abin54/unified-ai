from src.skills.analysis.posthog.test.base import APIBaseTest, ClickhouseTestMixin, _create_person, snapshot_clickhouse_queries

from django.test import override_settings

from src.skills.analysis.posthog.schema import ActorsPropertyTaxonomyQuery, ActorsPropertyTaxonomyResponse
