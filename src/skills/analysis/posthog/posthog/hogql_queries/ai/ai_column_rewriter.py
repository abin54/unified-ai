...
from src.skills.analysis.posthog.hogql_queries.ai.ai_property_rewriter import AI_PROPERTY_TO_COLUMN
...
# Derived from src.skills.analysis.posthog/models/ai_events/sql.py DDL. Keep in sync when adding columns.
