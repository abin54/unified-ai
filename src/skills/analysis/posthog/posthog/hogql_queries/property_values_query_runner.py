...
from src.skills.analysis.posthog.caching.utils import (
    ThresholdMode,
...
from src.skills.analysis.posthog.utils import convert_property_value, flatten, relative_date_parse
...
class PropertyValuesQueryRunner(AnalyticsQueryRunner[PropertyValuesQueryResponse]):
    ...
    def _calculate_person(self) -> PropertyValuesQueryResponse:
        ...
        from src.skills.analysis.posthog.queries.property_values import get_person_property_values_for_key
