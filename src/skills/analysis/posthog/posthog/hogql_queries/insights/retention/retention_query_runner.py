...
from src.skills.analysis.posthog.hogql.property import entity_to_expr, property_to_expr
...
from src.skills.analysis.posthog.caching.insights_api import BASE_MINIMUM_INSIGHT_REFRESH_INTERVAL, REDUCED_MINIMUM_INSIGHT_REFRESH_INTERVAL
from src.skills.analysis.posthog.constants import TREND_FILTER_TYPE_EVENTS
from src.skills.analysis.posthog.hogql_queries.insights.retention.retention_base_query_fixed import RetentionFixedIntervalBaseQueryBuilder
from src.skills.analysis.posthog.hogql_queries.insights.retention.retention_base_query_rolling import (
    RetentionRollingIntervalBaseQueryBuilder,
)
from src.skills.analysis.posthog.hogql_queries.insights.retention.utils import has_cohort_property
from src.skills.analysis.posthog.hogql_queries.insights.trends.breakdown import BREAKDOWN_OTHER_STRING_LABEL
from src.skills.analysis.posthog.hogql_queries.insights.utils.breakdowns import has_breakdown_filter, has_single_breakdown
from src.skills.analysis.posthog.hogql_queries.query_runner import AnalyticsQueryRunner
from src.skills.analysis.posthog.hogql_queries.utils.query_date_range import QueryDateRangeWithIntervals
...
from src.skills.analysis.posthog.queries.breakdown_props import ALL_USERS_COHORT_ID
