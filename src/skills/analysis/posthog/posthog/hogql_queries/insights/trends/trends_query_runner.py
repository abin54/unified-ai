...
from src.skills.analysis.posthog.hogql.constants import MAX_SELECT_RETURNED_ROWS, LimitContext
...
from src.skills.analysis.posthog.caching.insights_api import (
    BASE_MINIMUM_INSIGHT_REFRESH_INTERVAL,
    REAL_TIME_INSIGHT_REFRESH_INTERVAL,
    REDUCED_MINIMUM_INSIGHT_REFRESH_INTERVAL,
)
from src.skills.analysis.posthog.clickhouse import query_tagging
from src.skills.analysis.posthog.clickhouse.query_tagging import QueryTags
from src.skills.analysis.posthog.hogql_queries.insights.trends.breakdown import (
...
from src.skills.analysis.posthog.hogql_queries.insights.trends.display import TrendsDisplay
from src.skills.analysis.posthog.hogql_queries.insights.trends.series_with_extras import SeriesWithExtras
from src.skills.analysis.posthog.hogql_queries.insights.trends.trend_validation_rules import ValidateDataWarehouseBreakdown
from src.skills.analysis.posthog.hogql_queries.insights.trends.trends_actors_query_builder import TrendsActorsQueryBuilder
from src.skills.analysis.posthog.hogql_queries.insights.trends.trends_query_builder import TrendsQueryBuilder
from src.skills.analysis.posthog.hogql_queries.insights.utils.breakdowns import has_breakdown_filter
from src.skills.analysis.posthog.hogql_queries.insights.utils.utils import get_response_hogql
from src.skills.analysis.posthog.hogql_queries.query_runner import AnalyticsQueryRunner
from src.skills.analysis.posthog.hogql_queries.utils.formula_ast import FormulaAST
from src.skills.analysis.posthog.hogql_queries.utils.query_compare_to_date_range import QueryCompareToDateRange
from src.skills.analysis.posthog.hogql_queries.utils.query_date_range import QueryDateRange
from src.skills.analysis.posthog.hogql_queries.utils.query_previous_period_date_range import QueryPreviousPeriodDateRange
from src.skills.analysis.posthog.hogql_queries.utils.timestamp_utils import format_label_date, get_earliest_timestamp_from_series
from src.skills.analysis.posthog.hogql_queries.validation.rules import DisallowUnsupportedDataWarehouseSettings, RequireAtLeastOneSeries
from src.skills.analysis.posthog.hogql_queries.validation.validation import QueryValidationRule
from src.skills.analysis.posthog.models import Team
from src.skills.analysis.posthog.models.action.action import Action
from src.skills.analysis.posthog.models.cohort.cohort import Cohort
from src.skills.analysis.posthog.models.filters.mixins.utils import cached_property
from src.skills.analysis.posthog.queries.util import correct_result_for_sampling
from src.skills.analysis.posthog.utils import multisort
...
class TrendsQueryRunner(AnalyticsQueryRunner[TrendsQueryResponse]):
    ...
    def __init__(
        ...
        from src.skills.analysis.posthog.hogql_queries.insights.utils.utils import convert_active_user_math_based_on_interval
