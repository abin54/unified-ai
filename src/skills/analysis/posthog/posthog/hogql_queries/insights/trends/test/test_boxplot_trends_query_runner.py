...
from src.skills.analysis.posthog.schema import BoxPlotDatum, ChartDisplayType, DateRange, EventsNode, TrendsFilter, TrendsQuery

from src.skills.analysis.posthog.hogql_queries.insights.trends.boxplot_trends_query_runner import BoxPlotTrendsQueryRunner
...
class TestBoxPlotTrendsQueryRunner(ClickhouseTestMixin, APIBaseTest):
    ...
    def test_session_duration_produces_boxplot_data(self):
        from src.skills.analysis.posthog.schema import PropertyMathType
