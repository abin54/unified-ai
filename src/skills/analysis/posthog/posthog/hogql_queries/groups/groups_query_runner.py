from src.skills.analysis.posthog.schema import CachedGroupsQueryResponse, GroupsQuery, GroupsQueryResponse
...
from src.skills.analysis.posthog.hogql.property import has_aggregation, property_to_expr
