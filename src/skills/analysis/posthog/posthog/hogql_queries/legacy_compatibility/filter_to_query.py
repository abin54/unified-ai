...
from src.skills.analysis.posthog.hogql_queries.legacy_compatibility.clean_properties import clean_entity_properties, clean_global_properties
from src.skills.analysis.posthog.models.entity.entity import Entity as LegacyEntity
