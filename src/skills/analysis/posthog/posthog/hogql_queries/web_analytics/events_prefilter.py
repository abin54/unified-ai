...
from src.skills.analysis.posthog.hogql.database.models import DatabaseField
...
if TYPE_CHECKING:
    from src.skills.analysis.posthog.schema import HogQLQueryResponse
...
class EventsPrefilterTransformer(TraversingVisitor):
    ...
    def _resolve_materialized_columns(
        ...
        from src.skills.analysis.posthog.hogql.database.models import StringDatabaseField

        from src.skills.analysis.posthog.clickhouse.materialized_columns import get_enabled_materialized_columns
        from src.skills.analysis.posthog.models.property import TableColumn
    ...
    def _get_events_table(table_type: ast.Type) -> Table | None:
        from src.skills.analysis.posthog.hogql.database.models import Table as TableModel
...
class PrefilterHogQLHasMorePaginator(HogQLHasMorePaginator):
    ...
    def create(
        ...
        *,
        ...
        from src.skills.analysis.posthog.hogql.constants import get_default_limit_for_context, get_max_limit_for_context
    ...
    def execute_hogql_query(
        ...
        **kwargs,
        ...
        from src.skills.analysis.posthog.hogql.constants import get_default_hogql_global_settings
