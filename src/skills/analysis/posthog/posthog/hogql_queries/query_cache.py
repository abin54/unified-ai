...
from src.skills.analysis.posthog.cache_utils import OrjsonJsonSerializer
from src.skills.analysis.posthog.caching.cache_size_tracker import TeamCacheSizeTracker
from src.skills.analysis.posthog.caching.query_cache_routing import (
    BACKEND_CLUSTER,
    BACKEND_DEFAULT,
...
from src.skills.analysis.posthog.metrics import LABEL_TEAM_ID, pushed_metrics_registry
...
class DjangoCacheQueryCacheManager(QueryCacheManagerBase):
    ...
    def get_cache_data(self) -> Optional[dict]:
        from src.skills.analysis.posthog.caching.fetch_from_cache import fetch_cached_response_by_key
