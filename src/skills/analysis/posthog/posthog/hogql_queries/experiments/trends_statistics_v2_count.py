...
def calculate_probabilities_v2_count(
    ...
    >>> from src.skills.analysis.posthog.hogql_queries.experiments.trends_statistics_v2_count import calculate_probabilities_v2_count
...
def calculate_credible_intervals_v2_count(variants, lower_bound=0.025, upper_bound=0.975):
    ...
    --------
    >>> from src.skills.analysis.posthog.schema import ExperimentVariantTrendsBaseStats
    >>> from src.skills.analysis.posthog.hogql_queries.experiments.trends_statistics_v2_count import calculate_credible_intervals_v2_count
    >>> variants = [
