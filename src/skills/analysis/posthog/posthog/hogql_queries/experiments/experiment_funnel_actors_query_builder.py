...
from src.skills.analysis.posthog.schema import ActionsNode, ExperimentEventExposureConfig, ExperimentFunnelMetric, MultipleVariantHandling
...
from src.skills.analysis.posthog.hogql_queries.experiments.base_query_utils import funnel_steps_to_filter
from src.skills.analysis.posthog.hogql_queries.experiments.experiment_query_builder import ExperimentQueryBuilder
...
class ExperimentFunnelActorsQueryBuilder(ExperimentQueryBuilder):
    ...
    def _build_entity_metrics_cte(self) -> ast.SelectQuery:
        ...
        if self.metric.conversion_window is not None and self.metric.conversion_window_unit is not None:
            from src.skills.analysis.posthog.hogql_queries.experiments.base_query_utils import conversion_window_to_seconds
        ...
        if self.include_recordings:
            ...
            from src.skills.analysis.posthog.hogql_queries.experiments.base_query_utils import funnel_evaluation_expr
