...
from src.skills.analysis.posthog.schema import ExperimentSignificanceCode, ExperimentVariantTrendsBaseStats

from src.skills.analysis.posthog.exceptions_capture import capture_exception
from src.skills.analysis.posthog.hogql_queries.experiments import (
...
def calculate_probabilities_v2_continuous(
    ...
    Example:
    --------
    >>> from src.skills.analysis.posthog.schema import ExperimentVariantTrendsBaseStats
    >>> from src.skills.analysis.posthog.hogql_queries.experiments.trends_statistics_v2_continuous import calculate_probabilities_v2_continuous
...
def calculate_credible_intervals_v2_continuous(variants, lower_bound=0.025, upper_bound=0.975):
    ...
    --------
    >>> from src.skills.analysis.posthog.schema import ExperimentVariantTrendsBaseStats
    >>> from src.skills.analysis.posthog.hogql_queries.experiments.trends_statistics_v2_continuous import calculate_credible_intervals_v2_continuous
    >>> variants = [
