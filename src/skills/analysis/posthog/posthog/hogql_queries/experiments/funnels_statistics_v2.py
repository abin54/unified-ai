...
from src.skills.analysis.posthog.schema import ExperimentSignificanceCode, ExperimentVariantFunnelsBaseStats
...
def calculate_probabilities_v2(
    ...
    Example:
    --------
    >>> from src.skills.analysis.posthog.schema import ExperimentVariantFunnelsBaseStats
    >>> from src.skills.analysis.posthog.hogql_queries.experiments.funnels_statistics_v2 import calculate_probabilities_v2
...
def calculate_credible_intervals_v2(variants: list[ExperimentVariantFunnelsBaseStats]) -> dict[str, list[float]]:
    ...
    --------
    >>> from src.skills.analysis.posthog.schema import ExperimentVariantFunnelsBaseStats
    >>> from src.skills.analysis.posthog.hogql_queries.experiments.funnels_statistics_v2 import calculate_credible_intervals_v2
    >>> variants = [
