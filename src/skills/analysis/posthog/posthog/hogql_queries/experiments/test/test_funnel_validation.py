...
from src.skills.analysis.posthog.schema import EventsNode, ExperimentDataWarehouseNode
...
class TestFunnelDWValidationIntegration(BaseTest):
    ...
    def test_query_runner_raises_not_implemented_for_dw_funnels(self):
        ...
        from src.skills.analysis.posthog.schema import ExperimentFunnelMetric, ExperimentQuery, StepOrderValue
