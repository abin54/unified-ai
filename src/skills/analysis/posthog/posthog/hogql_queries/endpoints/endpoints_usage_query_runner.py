...
from src.skills.analysis.posthog.schema import EndpointsUsageOverviewQuery, EndpointsUsageTableQuery, EndpointsUsageTrendsQuery
...
class EndpointsUsageQueryRunner(AnalyticsQueryRunner[EAR], ABC):
    ...
    def _get_materialization_filter(self) -> ast.Expr | None:
        ...
        from src.skills.analysis.posthog.schema import MaterializationType
    ...
    def _get_breakdown_expression(
        ...
        """
        from src.skills.analysis.posthog.schema import EndpointsUsageBreakdown
