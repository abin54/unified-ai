...
if TYPE_CHECKING:
    ...
    from src.skills.analysis.posthog.personhog_client.proto.generated.personhog.types.v1 import group_pb2, person_pb2
...
def proto_person_to_model(
    ...
    """
    from src.skills.analysis.posthog.models.person import Person as PersonModel
