...
import structlog
from src.skills.analysis.posthoganalytics.flag_definition_cache import FlagDefinitionCacheData
...
class HyperCacheFlagProvider:
    ...
    def _get_hypercache(self):
        ...
        if self._hypercache is None:
            from src.skills.analysis.posthog.models.feature_flag.local_evaluation import flag_definitions_hypercache
