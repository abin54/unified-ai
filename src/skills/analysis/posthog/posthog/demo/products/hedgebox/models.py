...
from src.skills.analysis.posthog.demo.matrix.models import EVENT_AUTOCAPTURE, Effect, SimPerson, SimSessionIntent
...
if TYPE_CHECKING:
    from src.skills.analysis.posthog.demo.products.hedgebox.matrix import HedgeboxCluster
