...
from src.skills.analysis.posthog.clickhouse.client import query_with_columns, sync_execute
from src.skills.analysis.posthog.demo.matrix.taxonomy_inference import infer_taxonomy_for_team
...
class MatrixManager:
    ...
    def _copy_analytics_data_from_master_team(self, target_team: Team):
        from src.skills.analysis.posthog.models.event.sql import COPY_EVENTS_BETWEEN_TEAMS
        from src.skills.analysis.posthog.models.group.sql import COPY_GROUPS_BETWEEN_TEAMS
        from src.skills.analysis.posthog.models.person.sql import COPY_PERSON_DISTINCT_ID2S_BETWEEN_TEAMS, COPY_PERSONS_BETWEEN_TEAMS
    ...
    def _sync_postgres_with_clickhouse_data(cls, source_team_id: int, target_team_id: int):
        from src.skills.analysis.posthog.models.group.sql import SELECT_GROUPS_OF_TEAM
        from src.skills.analysis.posthog.models.person.sql import SELECT_PERSON_DISTINCT_ID2S_OF_TEAM, SELECT_PERSONS_OF_TEAM
    ...
    def _save_sim_person(self, team: Team, subject: SimPerson):
        ...
        if subject.past_events:
            from src.skills.analysis.posthog.models.person.util import create_person, create_person_distinct_id
    ...
    def _save_sim_group(
        ...
        from src.skills.analysis.posthog.models.group.util import raw_create_group_ch
    ...
    def _sleep_until_person_data_in_clickhouse(self, team_id: int):
        from src.skills.analysis.posthog.models.person.sql import GET_PERSON_COUNT_FOR_TEAM, GET_PERSON_DISTINCT_ID2_COUNT_FOR_TEAM
