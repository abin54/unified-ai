...
if TYPE_CHECKING:
    from src.skills.analysis.posthog.ducklake.models import DuckgresServer, DuckLakeCatalog
...
def is_dev_mode() -> bool:
    ...
    try:
        from src.skills.analysis.posthog.settings import USE_LOCAL_SETUP
...
def get_duckgres_server_for_team(team_id: int) -> DuckgresServer | None:
    ...
    from src.skills.analysis.posthog.ducklake.models import DuckgresServer
