...
from src.skills.analysis.posthog.ducklake.common import get_duckgres_config, sanitize_ducklake_identifier
...
def compile_hogql_to_ducklake_sql(team_id: int, query: HogQLQuery) -> tuple[str, dict[str, object], str]:
    ...
    from src.skills.analysis.posthog.hogql.printer.utils import prepare_and_print_ast
