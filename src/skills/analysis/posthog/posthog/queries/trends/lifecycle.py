...
from src.skills.analysis.posthog.queries.trends.sql import LIFECYCLE_EVENTS_QUERY, LIFECYCLE_SQL
from src.skills.analysis.posthog.queries.trends.util import parse_response
from src.skills.analysis.posthog.queries.util import get_person_properties_mode
...
class Lifecycle:
    ...
    def get_people(self, filter: LifecycleFilter, team: Team):
        from src.skills.analysis.posthog.queries.trends.lifecycle_actors import LifecycleActors
