...
from src.skills.analysis.posthog.queries.trends.lifecycle import LifecycleEventQuery
from src.skills.analysis.posthog.queries.trends.sql import LIFECYCLE_PEOPLE_SQL
