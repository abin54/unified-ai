...
from src.skills.analysis.posthog.schema import ActorsQuery

from src.skills.analysis.posthog.constants import INSIGHT_FUNNELS, INSIGHT_PATHS, INSIGHT_TRENDS
from src.skills.analysis.posthog.hogql_queries.actor_strategies import PersonStrategy
from src.skills.analysis.posthog.hogql_queries.insights.paginators import HogQLHasMorePaginator
from src.skills.analysis.posthog.models import Entity, Filter, PersonDistinctId, Team
...
from src.skills.analysis.posthog.personhog_client.converters import proto_person_to_model
from src.skills.analysis.posthog.personhog_client.metrics import (
    PERSONHOG_ROUTING_ERRORS_TOTAL,
    PERSONHOG_ROUTING_TOTAL,
    PERSONHOG_TEAM_MISMATCH_TOTAL,
    get_client_name,
)
from src.skills.analysis.posthog.personhog_client.proto import GetDistinctIdsForPersonsRequest, GetPersonsByUuidsRequest
...
def get_serialized_people(
    ...
    from src.skills.analysis.posthog.api.person import get_person_name_helper
...
def serialize_people(
    ...
    from src.skills.analysis.posthog.api.person import get_person_name
