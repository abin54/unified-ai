...
from src.skills.analysis.posthog.constants import BREAKDOWN_TYPES, MONTHLY_ACTIVE, WEEKLY_ACTIVE, PropertyOperatorType
from src.skills.analysis.posthog.models.cohort import Cohort
from src.skills.analysis.posthog.models.cohort.util import format_filter_query
from src.skills.analysis.posthog.models.entity import Entity
from src.skills.analysis.posthog.models.entity.util import get_entity_filtering_params
...
from src.skills.analysis.posthog.models.property import PropertyGroup
from src.skills.analysis.posthog.models.property.util import (
...
from src.skills.analysis.posthog.queries.groups_join_query import GroupsJoinQuery
...
from src.skills.analysis.posthog.queries.person_on_events_v2_sql import PERSON_DISTINCT_ID_OVERRIDES_JOIN_SQL
from src.skills.analysis.posthog.queries.person_query import PersonQuery
from src.skills.analysis.posthog.queries.query_date_range import QueryDateRange
from src.skills.analysis.posthog.queries.trends.sql import HISTOGRAM_ELEMENTS_ARRAY_OF_KEY_SQL, TOP_ELEMENTS_ARRAY_OF_KEY_SQL
from src.skills.analysis.posthog.queries.util import PersonPropertiesMode, alias_poe_mode_for_legacy
...
def get_breakdown_prop_values(
    ...
    if use_all_funnel_entities:
        from src.skills.analysis.posthog.queries.funnels.funnel_event_query import FunnelEventQuery
