...
from src.skills.analysis.posthog.hogql.escape_sql import escape_hogql_string

from src.skills.analysis.posthog.cdp.templates.hog_function_template import HogFunctionTemplateDC, HogFunctionTemplateMigrator
from src.skills.analysis.posthog.models.integration import GoogleCloudIntegration
...
class TemplateGooglePubSubMigrator(HogFunctionTemplateMigrator):
    ...
    def migrate(cls, obj):
        ...
        from src.skills.analysis.posthog.models.plugin import PluginAttachment
