...
try:
    ...
    if posthoganalytics.api_key:
        from src.skills.analysis.posthoganalytics.ai.claude_agent_sdk import query  # type: ignore[no-redef]  # noqa: F811
...
def _validate_verdict(result: dict) -> dict:
    """Validate structured verdict from src.orchestrator output.
