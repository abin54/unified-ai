...
from src.skills.analysis.posthog.models import Integration, Organization, Team
...
class TestTaskRun(TestCase):
    ...
    def test_log_file_tagged_with_ttl(self):
        ...
        from src.skills.analysis.posthog.storage.object_storage import ObjectStorage, object_storage_client
