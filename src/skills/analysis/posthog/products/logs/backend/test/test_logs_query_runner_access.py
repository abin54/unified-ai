...
from src.skills.analysis.posthog.schema import DateRange, FilterLogicalOperator, LogsQuery, PropertyGroupFilter
...
class TestLogsQueryRunnerAccess(APIBaseTest):
    ...
    def test_run_without_user_skips_access_check(self):
        ...
        with patch.object(runner, "_calculate") as mock_calculate:
            from src.skills.analysis.posthog.schema import LogsQueryResponse
