...
from src.skills.analysis.posthog.schema import CachedUsageMetricsQueryResponse, UsageMetric, UsageMetricsQuery, UsageMetricsQueryResponse
...
class UsageMetricsQueryRunner(AnalyticsQueryRunner[UsageMetricsQueryResponse]):
    ...
    def to_query(self) -> ast.SelectQuery | ast.SelectSetQuery:
        ...
        if not interval_groups:
            from src.skills.analysis.posthog.hogql.database.models import UnknownDatabaseField
