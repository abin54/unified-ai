...
from src.skills.analysis.posthog.hogql_queries.web_analytics.web_goals import NoActionsError, WebGoalsQueryRunner
...
def auto_select_project_for_user(user: User, team_traffic_data: dict[int, dict]) -> bool:
    ...
    """
    from src.skills.analysis.posthog.tasks.email_utils import auto_select_digest_project
