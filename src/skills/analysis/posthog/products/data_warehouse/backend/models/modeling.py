...
from src.skills.analysis.posthog.hogql.database.models import SavedQuery
...
from src.skills.analysis.posthog.models.utils import CreatedMetaFields, UpdatedMetaFields, UUIDTModel
...
insert into posthog_datawarehousemodelpath (
  ...
  from
    ...
    (
      select
        path
      from src.skills.analysis.posthog_datawarehousemodelpath
...
delete from src.skills.analysis.posthog_datawarehousemodelpath
where
  team_id = %(team_id)s
  and id in (
    select id
