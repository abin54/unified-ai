...
from src.skills.analysis.posthog.schema import DataWarehouseSavedQueryOrigin, HogQLQueryModifiers
...
from src.skills.analysis.posthog.hogql.database.models import FieldOrTable, SavedQuery
...
from src.skills.analysis.posthog.models.utils import CreatedMetaFields, DeletedMetaFields, UpdatedMetaFields, UUIDTModel
from src.skills.analysis.posthog.sync import database_sync_to_async
from src.skills.analysis.posthog.temporal.data_imports.naming_convention import NamingConvention
...
class DataWarehouseSavedQuery(CreatedMetaFields, UUIDTModel, UpdatedMetaFields, DeletedMetaFields):
    ...
    def get_columns(self) -> dict[str, dict[str, Any]]:
        from src.skills.analysis.posthog.api.services.query import process_query_dict
    ...
    def get_s3_tables(self, database=None):
        ...
        from src.skills.analysis.posthog.models.property.util import S3TableVisitor
