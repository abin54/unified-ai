...
from src.skills.analysis.posthog.test.base import APIBaseTest, FuzzyInt
...
from src.skills.analysis.posthog.temporal.data_imports.sources.bigquery.bigquery import BigQuerySourceConfig
from src.skills.analysis.posthog.temporal.data_imports.sources.common.base import FieldType
from src.skills.analysis.posthog.temporal.data_imports.sources.common.schema import SourceSchema
from src.skills.analysis.posthog.temporal.data_imports.sources.postgres.postgres import PostgresDiscoveredSchema
...
from src.skills.analysis.posthog.temporal.data_imports.sources.stripe.settings import ENDPOINTS as STRIPE_ENDPOINTS
...
class TestExternalDataSource(APIBaseTest):
    ...
    def test_database_schema_stripe_permissions_error(self):
        with patch(
            ...
            from src.skills.analysis.posthog.temporal.data_imports.sources.stripe.stripe import StripePermissionError
...
class TestCreateWebhook(APIBaseTest):
    def _webhook_result(self, success=True, error=None, extra_inputs=None):
        from src.skills.analysis.posthog.temporal.data_imports.sources.common.base import WebhookCreationResult
    ...
    def _create_hog_function_template(self):
        from src.skills.analysis.posthog.models.hog_function_template import HogFunctionTemplate
    ...
    def test_create_webhook_success(self, mock_create_webhook, _mock_flag):
        ...
        from src.skills.analysis.posthog.temporal.data_imports.sources.stripe.constants import RESOURCE_TO_STRIPE_OBJECT_TYPE
...
class TestWebhookInfo(APIBaseTest):
    ...
    def test_webhook_info_with_hog_function(self, mock_get_info, _mock_flag):
        from src.skills.analysis.posthog.temporal.data_imports.sources.common.base import ExternalWebhookInfo
...
class TestDeleteWebhook(APIBaseTest):
    ...
    def test_delete_webhook_success(self, mock_delete_webhook, _mock_flag):
        from src.skills.analysis.posthog.temporal.data_imports.sources.common.base import WebhookDeletionResult
