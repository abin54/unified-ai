...
from src.skills.analysis.posthog.models.activity_logging.activity_log import ActivityContextBase, Detail, changes_between, log_activity
from src.skills.analysis.posthog.models.activity_logging.external_data_utils import (
...
from src.skills.analysis.posthog.temporal.data_imports.sources import SourceRegistry
from src.skills.analysis.posthog.temporal.data_imports.sources.common.base import ExternalWebhookInfo, FieldType, WebhookSource
from src.skills.analysis.posthog.temporal.data_imports.sources.common.config import Config
from src.skills.analysis.posthog.temporal.data_imports.sources.common.schema import SourceSchema
from src.skills.analysis.posthog.temporal.data_imports.sources.postgres.cdc.config import PostgresCDCConfig
from src.skills.analysis.posthog.temporal.data_imports.sources.postgres.source import PostgresSource
...
def get_direct_postgres_connection_metadata(
    *,
    ...
    from src.skills.analysis.posthog.temporal.data_imports.sources.postgres.postgres import source_requires_ssl
...
class ExternalDataSourceViewSet(TeamAndOrgViewSetMixin, AccessControlViewSetMixin, viewsets.ModelViewSet):
    ...
    def create(self, request: Request, *args: Any, **kwargs: Any) -> Response:
        ...
        if cdc_enabled and source_type_model == ExternalDataSourceType.POSTGRES:
            ...
            if cdc_table_names_by_schema:
                from src.skills.analysis.posthog.temporal.data_imports.sources.postgres.cdc.slot_manager import cdc_pg_connection
                from src.skills.analysis.posthog.temporal.data_imports.sources.postgres.postgres import get_primary_key_columns
    ...
    def _setup_cdc_slot(
        ...
        if management_mode == "posthog":
            from src.skills.analysis.posthog.temporal.data_imports.sources.postgres.cdc.slot_manager import create_slot_and_publication
            ...
            from src.skills.analysis.posthog.temporal.data_imports.sources.postgres.cdc.slot_manager import create_slot, publication_exists
    ...
    def _add_table_to_cdc_publication(
        ...
        from src.skills.analysis.posthog.temporal.data_imports.sources.postgres.cdc.slot_manager import (
