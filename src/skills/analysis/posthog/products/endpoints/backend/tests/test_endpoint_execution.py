...
from src.skills.analysis.posthog.schema import DataWarehouseSyncInterval, EventsNode, TrendsQuery
...
class TestEndpointExecution(ClickhouseTestMixin, APIBaseTest):
    ...
    def test_non_materialized_insight_endpoint_accepts_breakdown_variable(self):
        from src.skills.analysis.posthog.schema import Breakdown, BreakdownFilter, BreakdownType
    ...
    def test_non_materialized_insight_endpoint_accepts_hogql_breakdown_variable(self, _name, variables):
        from src.skills.analysis.posthog.schema import BreakdownFilter, BreakdownType
    ...
    def test_trends_with_calendar_display_create_and_run(self):
        from src.skills.analysis.posthog.schema import ChartDisplayType, TrendsFilter
