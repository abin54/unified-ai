...
from src.skills.analysis.posthog.schema import HogQLQuery, HogQLQueryModifiers

from src.skills.analysis.posthog.hogql import ast
from src.skills.analysis.posthog.hogql.functions.aggregations import COMBINATORS
from src.skills.analysis.posthog.hogql.functions.mapping import HOGQL_AGGREGATIONS, find_hogql_aggregation
...
def _strip_combinators(func_name: str) -> str | None:
    ...
    Uses the COMBINATORS registry from src.skills.analysis.posthog.hogql.functions.aggregations.
