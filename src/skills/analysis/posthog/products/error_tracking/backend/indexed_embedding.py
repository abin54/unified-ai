...
from src.skills.analysis.posthog.clickhouse.kafka_engine import KAFKA_COLUMNS_WITH_PARTITION
...
def DOCUMENT_EMBEDDINGS_BUFFER_SHARDED_TABLE_SQL():
    from src.skills.analysis.posthog.clickhouse.table_engines import ReplacingMergeTree, ReplicationScheme
...
def DOCUMENT_EMBEDDINGS_BUFFER_WRITABLE_TABLE_SQL():
    from src.skills.analysis.posthog.clickhouse.table_engines import Distributed
