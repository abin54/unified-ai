...
from src.skills.analysis.posthog.models import FeatureFlag, Insight
...
class TestSurveyAnalysisTool(BaseTest):
    ...
    def test_format_responses_for_analysis(self):
        from src.skills.analysis.posthog.schema import SurveyAnalysisQuestionGroup, SurveyAnalysisResponseItem
    ...
    def test_format_responses_for_analysis_empty_responses(self):
        from src.skills.analysis.posthog.schema import SurveyAnalysisQuestionGroup
