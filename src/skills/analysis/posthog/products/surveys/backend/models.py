...
from src.skills.analysis.posthog.models.utils import RootTeamMixin, UUIDModel, UUIDTModel
...
def survey_changed(sender, instance: "Survey", **kwargs):
    ...
    from src.skills.analysis.posthog.tasks.surveys import update_team_surveys_cache
