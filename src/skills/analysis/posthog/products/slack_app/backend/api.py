...
from src.skills.analysis.posthog.llm.gateway_client import get_llm_client
...
from src.skills.analysis.posthog.temporal.ai.posthog_code_slack_interactivity import (
    PostHogCodeSlackInteractivityInputs,
    PostHogCodeSlackTerminateTaskWorkflow,
)
from src.skills.analysis.posthog.temporal.ai.posthog_code_slack_mention import (
...
def select_repository(
    ...
    if user_id and channel:
        from src.skills.analysis.posthog.models.user_repo_preference import UserRepoPreference
...
def _match_repo_rule(
    ...
    from src.skills.analysis.posthog.models.repo_routing_rule import RepoRoutingRule
