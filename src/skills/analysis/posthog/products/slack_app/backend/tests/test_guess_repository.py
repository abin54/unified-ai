...
class TestHandleRulesCommandActivity:
    ...
    def _make_inputs(self, text: str):
        from src.skills.analysis.posthog.temporal.ai.posthog_code_slack_mention import PostHogCodeSlackMentionWorkflowInputs
    ...
    def test_list_empty_rules(self, mock_slack_cls):
        ...
        from src.skills.analysis.posthog.temporal.ai.posthog_code_slack_mention import handle_posthog_code_rules_command_activity
