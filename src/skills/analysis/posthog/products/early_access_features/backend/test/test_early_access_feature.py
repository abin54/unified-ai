...
import unittest
from src.skills.analysis.posthog.test.base import APIBaseTest, BaseTest, QueryMatchingTest, snapshot_postgres_queries
...
from src.skills.analysis.posthog.models import FeatureFlag, Person
from src.skills.analysis.posthog.models.team.team_caching import set_team_in_cache
...
class TestEarlyAccessFeatureSiteAppTemplate(unittest.TestCase):
    def test_site_app_template_escapes_user_controlled_fields(self):
        ...
        from src.skills.analysis.posthog.cdp.templates._siteapps.template_early_access_features import template
