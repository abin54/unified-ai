...
def hogql_functions() -> list[str]:
    ...
    """
    from src.skills.analysis.posthog.hogql.functions.aggregations import HOGQL_AGGREGATIONS
    from src.skills.analysis.posthog.hogql.functions.mapping import HOGQL_CLICKHOUSE_FUNCTIONS
    from src.skills.analysis.posthog.hogql.functions.udfs import UDFS
