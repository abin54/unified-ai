...
def render_hogql_example(query_dict: dict[str, Any]) -> str:
    ...
    from src.skills.analysis.posthog.schema import HogQLFilters
    ...
    from src.skills.analysis.posthog.hogql.printer.utils import to_printed_hogql
    ...
    with freeze_time(FROZEN_TIME):
        ...
        from src.skills.analysis.posthog.hogql_queries.ai.trace_query_runner import TraceQueryRunner
