...
if TYPE_CHECKING:
    from src.skills.analysis.posthog.models.team.team_marketing_analytics_config import TeamMarketingAnalyticsConfig

from src.skills.analysis.posthog.schema import NativeMarketingSource, SourceMap
