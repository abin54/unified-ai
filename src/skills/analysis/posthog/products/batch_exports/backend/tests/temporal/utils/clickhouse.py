...
from src.skills.analysis.posthog.models.app_metrics2.sql import APP_METRICS2_DATA_TABLE_SQL, APP_METRICS2_MV_TABLE_SQL
from src.skills.analysis.posthog.temporal.common.asyncpa import InvalidMessageFormat
from src.skills.analysis.posthog.temporal.common.clickhouse import ClickHouseClient, ClickHouseError
...
async def create_clickhouse_tables_and_views(clickhouse_client):
    from src.skills.analysis.posthog.batch_exports.sql import (
    ...
    from src.skills.analysis.posthog.clickhouse.schema import CREATE_KAFKA_TABLE_QUERIES, build_query
