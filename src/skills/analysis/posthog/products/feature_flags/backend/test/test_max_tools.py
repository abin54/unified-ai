...
from src.skills.analysis.posthog.schema import FeatureFlagGroupType, GroupPropertyFilter, PersonPropertyFilter, PropertyOperator
...
class TestCreateFeatureFlagTool(APIBaseTest):
    ...
    async def _get_tag_names(flag: FeatureFlag) -> list[str]:
        from src.skills.analysis.posthog.models import TaggedItem
