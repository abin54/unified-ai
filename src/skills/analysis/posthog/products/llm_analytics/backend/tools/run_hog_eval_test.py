...
from src.skills.analysis.posthog.schema import AssistantTool
...
class RunHogEvalTestTool(MaxTool):
    ...
    async def _arun_impl(self, source: str, sample_count: int = 3) -> tuple[str, Any]:
        ...
        from src.skills.analysis.posthog.temporal.llm_analytics.run_evaluation import run_hog_eval
