...
from src.skills.analysis.posthog.permissions import AccessControlPermission
from src.skills.analysis.posthog.rbac.access_control_api_mixin import AccessControlViewSetMixin
from src.skills.analysis.posthog.temporal.llm_analytics.message_utils import extract_text_from_messages
from src.skills.analysis.posthog.temporal.llm_analytics.run_evaluation import extract_event_io, run_hog_eval
...
class EvaluationViewSet(TeamAndOrgViewSetMixin, AccessControlViewSetMixin, ForbidDestroyModel, viewsets.ModelViewSet):
    ...
    def test_hog(self, request: Request, **kwargs) -> Response:
        ...
        from src.skills.analysis.posthog.cdp.validation import compile_hog
