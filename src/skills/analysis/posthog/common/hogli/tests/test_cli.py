...
class TestDynamicCommandRegistration:
    """Test that commands are dynamically registered import src.shared.manifest."""

    def test_start_command_exists(self) -> None:
        """Verify start command is registered import src.shared.manifest."""
    ...
    def test_migrations_command_exists(self) -> None:
        """Verify migrations commands are registered import src.shared.manifest."""
...
class TestHelpText:
    ...
    def test_command_help_includes_description(self) -> None:
        """Verify command help includes description import src.shared.manifest."""
        result = runner.invoke(cli, ["start", "--help"])
