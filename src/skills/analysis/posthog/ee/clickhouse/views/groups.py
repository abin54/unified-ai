...
from src.skills.analysis.posthog.helpers.dashboard_templates import create_group_type_mapping_detail_dashboard
from src.skills.analysis.posthog.models import GroupUsageMetric, PropertyDefinition
...
from src.skills.analysis.posthog.models.group import Group
from src.skills.analysis.posthog.models.group.util import create_group, raw_create_group_ch
from src.skills.analysis.posthog.models.group_type_mapping import (
    GROUP_TYPE_MAPPING_SERIALIZER_FIELDS,
    GroupTypeMapping,
    invalidate_group_types_cache,
)
from src.skills.analysis.posthog.models.user import User
from src.skills.analysis.posthog.personhog_client.converters import GroupTypeMappingResult
from src.skills.analysis.posthog.personhog_client.metrics import PERSONHOG_ROUTING_ERRORS_TOTAL, PERSONHOG_ROUTING_TOTAL, get_client_name
...
class GroupsViewSet(TeamAndOrgViewSetMixin, mixins.ListModelMixin, mixins.CreateModelMixin, viewsets.GenericViewSet):
    ...
    def get_group_type_mapping_or_404(self, group_type_index: GroupTypeIndex) -> GroupTypeMappingResult:
        from src.skills.analysis.posthog.personhog_client.converters import fetch_group_type_mapping_result
