...
from src.skills.analysis.posthog.models.property import Property, TableWithProperties
...
from src.skills.analysis.posthog.queries.property_optimizer import PropertyOptimizer
