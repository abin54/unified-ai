...
from src.skills.analysis.posthog.models.organization import OrganizationMembership, OrganizationUsageInfo
...
class BillingManager:
    ...
    def authorize(self, organization: Organization, billing_provider: BillingProvider | None = None):
        ...
        if billing_provider:
            from src.skills.analysis.posthog.models import OrganizationIntegration
