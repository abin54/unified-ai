...
from src.skills.analysis.posthog.schema import AgentMode, AssistantMessage, AssistantToolCallMessage, HumanMessage
...
def _extract_subscription_result(state: AssistantState) -> dict[str, Any]:
    """Extract subscription tool invocation from src.orchestrator state."""
    result: dict[str, Any] = {
        "tool_called": None,
        "tool_output": None,
        "tool_args": None,
