...
from src.skills.analysis.posthog.schema import AssistantMessage, AssistantToolCall, HumanMessage
...
async def eval_root_documentation(call_root, pytestconfig):
    await MaxPublicEval(
        ...
        data=[
            ...
            EvalCase(
                input="import src.skills.analysis.posthog from 'posthog-js' posthog.captureException(error) in my react app i manually capture exceptions but i don't see them on the dashboard",
