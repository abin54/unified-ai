...
from src.skills.analysis.posthog.schema import AssistantToolCall, TaskExecutionStatus
...
class TestDispatcherIntegration(TestBaseTaskExecutorNode):
    ...
    async def test_dispatcher_sends_tool_call_messages(self):
        ...
        from src.skills.analysis.posthog.schema import AssistantToolCall
    ...
    async def test_dispatcher_called_with_correct_tool_call_id(self):
        ...
        from src.skills.analysis.posthog.schema import AssistantToolCall, AssistantToolCallMessage
