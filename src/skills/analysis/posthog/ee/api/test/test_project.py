from src.skills.analysis.posthog.test.base import FuzzyInt

from src.skills.analysis.posthog.api.test.test_team import EnvironmentToProjectRewriteClient
