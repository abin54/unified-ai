...
from src.skills.ml.deeptutor.runtime.registry.tool_registry import ToolRegistry as CoreToolRegistry
from src.skills.ml.deeptutor.runtime.registry.tool_registry import get_tool_registry

if TYPE_CHECKING:
from src.skills.ml.deeptutor.core.tool_protocol import ToolResult
...
from src.skills.ml.deeptutor.core.tool_protocol import ToolResult as _ToolResult
