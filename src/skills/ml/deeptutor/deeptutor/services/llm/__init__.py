...
from src.skills.ml.deeptutor.services.llm import complete, stream
    ...
    # Configuration
from src.skills.ml.deeptutor.services.llm import get_llm_config, LLMConfig
    config = get_llm_config()

    # URL utilities for local LLM servers
from src.skills.ml.deeptutor.services.llm import sanitize_url, is_local_llm_server
"""
