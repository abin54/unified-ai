...
from src.skills.ml.deeptutor.core.capability_protocol import BaseCapability
from src.skills.ml.deeptutor.runtime.bootstrap.builtin_capabilities import BUILTIN_CAPABILITY_CLASSES
