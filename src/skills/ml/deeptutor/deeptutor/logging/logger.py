...
from src.skills.ml.deeptutor.config.constants import PROJECT_ROOT
...
def get_logger(
    ...
    if log_dir is None or effective_level is None:
        try:
from src.skills.ml.deeptutor.services.config import get_path_from_config, load_config_with_main
