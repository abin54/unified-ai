...
from src.skills.ml.deeptutor.tutorbot.providers.base import LLMProvider, LLMResponse, ToolCallRequest

if TYPE_CHECKING:
from src.skills.ml.deeptutor.tutorbot.providers.registry import ProviderSpec
