...
from src.skills.ml.deeptutor.core.tool_protocol import BaseTool, ToolDefinition, ToolParameter, ToolResult
from src.skills.ml.deeptutor.tools.prompting import load_prompt_hints
...
from src.skills.ml.deeptutor.tools.brainstorm import brainstorm
...
class RAGTool(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
from src.skills.ml.deeptutor.tools.rag_tool import rag_search
...
class WebSearchTool(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
from src.skills.ml.deeptutor.tools.web_search import web_search
...
"""
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
from src.skills.ml.deeptutor.tools.code_executor import run_code
...
from src.skills.ml.deeptutor.services.llm import complete, get_token_limit_kwargs
...
class ReasonTool(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
from src.skills.ml.deeptutor.tools.reason import reason
...
class PaperSearchToolWrapper(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
from src.skills.ml.deeptutor.tools.paper_search_tool import ArxivSearchTool
...
class GeoGebraAnalysisTool(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
from src.skills.ml.deeptutor.agents.vision_solver.vision_solver_agent import VisionSolverAgent
from src.skills.ml.deeptutor.services.llm.config import get_llm_config
