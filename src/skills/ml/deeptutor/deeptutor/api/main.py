...
def validate_tool_consistency():
    ...
    """
    try:
from src.skills.ml.deeptutor.runtime.registry.capability_registry import get_capability_registry
...
async def lifespan(app: FastAPI):
    ...
    try:
from src.skills.ml.deeptutor.services.llm import get_llm_client
    ...
    try:
from src.skills.ml.deeptutor.events.event_bus import get_event_bus
    ...
    try:
from src.skills.ml.deeptutor.services.tutorbot import get_tutorbot_manager
...
try:
from src.skills.ml.deeptutor.services.setup import init_user_directories
...
from src.skills.ml.deeptutor.api.routers import (
    agent_config,
    book,
    chat,
    co_writer,
...
from src.skills.ml.deeptutor.api.run_server import main as run_server_main
