...
from src.skills.ml.deeptutor.api.routers._tutorbot_channel_schema import (
    all_channel_schemas,
...
from src.skills.ml.deeptutor.tutorbot.channels.telegram import TelegramChannel, TelegramConfig

        assert resolve_config_model(TelegramChannel) is TelegramConfig

    def test_slack_pairs_with_slack_config(self) -> None:
from src.skills.ml.deeptutor.tutorbot.channels.slack import SlackChannel, SlackConfig

        assert resolve_config_model(SlackChannel) is SlackConfig

    def test_discord_pairs_with_discord_config(self) -> None:
from src.skills.ml.deeptutor.tutorbot.channels.discord import DiscordChannel, DiscordConfig
...
from src.skills.ml.deeptutor.tutorbot.channels.telegram import TelegramChannel
...
from src.skills.ml.deeptutor.tutorbot.channels.slack import SlackChannel
...
from src.skills.ml.deeptutor.api.routers import tutorbot as tutorbot_router
