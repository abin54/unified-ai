...
from src.skills.ml.vision.stable_diffusion.modules import shared, paths, script_callbacks, extensions, script_loading, scripts_postprocessing, errors, timer, util
...
class ScriptRunner:
    ...
    def initialize_scripts(self, is_img2img):
        from src.skills.ml.vision.stable_diffusion.modules import scripts_auto_postprocessing
    ...
    def create_script_ui_inner(self, script):
        import src.skills.ml.vision.stable_diffusion.modules.api.models as api_models
