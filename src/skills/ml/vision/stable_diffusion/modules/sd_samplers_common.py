...
from src.skills.ml.vision.stable_diffusion.modules import devices, images, sd_vae_approx, sd_samplers, sd_vae_taesd, shared, sd_models
...
def samples_to_images_tensor(sample, approximation=None, model=None):
    ...
    if approximation is None or (shared.state.interrupted and opts.live_preview_fast_interrupt):
        ...
        from src.skills.ml.vision.stable_diffusion.modules import lowvram
