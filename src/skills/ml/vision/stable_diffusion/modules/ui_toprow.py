...
from src.skills.ml.vision.stable_diffusion.modules import shared, ui_prompt_styles
...
class Toprow:
    ...
    def create_tools_row(self):
        with gr.Row(elem_id=f"{self.id_part}_tools"):
            from src.skills.ml.vision.stable_diffusion.modules.ui import paste_symbol, clear_prompt_symbol, restore_progress_symbol
