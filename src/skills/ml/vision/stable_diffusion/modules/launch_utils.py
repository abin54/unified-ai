...
from src.skills.ml.vision.stable_diffusion.modules import cmd_args, errors
from src.skills.ml.vision.stable_diffusion.modules.paths_internal import script_path, extensions_dir
from src.skills.ml.vision.stable_diffusion.modules.timer import startup_timer
from src.skills.ml.vision.stable_diffusion.modules import logging_config
...
def check_python_version():
    ...
    if not (major == 3 and minor in supported_minors):
        import src.skills.ml.vision.stable_diffusion.modules.errors
...
def dump_sysinfo():
    from src.skills.ml.vision.stable_diffusion.modules import sysinfo
    import datetime
