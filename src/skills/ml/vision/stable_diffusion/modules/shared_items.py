...
from src.skills.ml.vision.stable_diffusion.modules import script_callbacks, scripts, ui_components
from src.skills.ml.vision.stable_diffusion.modules.options import OptionHTML, OptionInfo
from src.skills.ml.vision.stable_diffusion.modules.shared_cmd_options import cmd_opts


def realesrgan_models_names():
    import src.skills.ml.vision.stable_diffusion.modules.realesrgan_model
    return [x.name for x in modules.realesrgan_model.get_realesrgan_models(None)]


def dat_models_names():
    import src.skills.ml.vision.stable_diffusion.modules.dat_model
    return [x.name for x in modules.dat_model.get_dat_models(None)]


def postprocessing_scripts():
    import src.skills.ml.vision.stable_diffusion.modules.scripts

    return modules.scripts.scripts_postproc.scripts


def sd_vae_items():
    import src.skills.ml.vision.stable_diffusion.modules.sd_vae
...
def sd_unet_items():
    import src.skills.ml.vision.stable_diffusion.modules.sd_unet
...
def list_checkpoint_tiles(use_short=False):
    import src.skills.ml.vision.stable_diffusion.modules.sd_models
...
def list_samplers():
    import src.skills.ml.vision.stable_diffusion.modules.sd_samplers
    return modules.sd_samplers.all_samplers


def reload_hypernetworks():
    from src.skills.ml.vision.stable_diffusion.modules.hypernetworks import hypernetwork
    from src.skills.ml.vision.stable_diffusion.modules import shared

    shared.hypernetworks = hypernetwork.list_hypernetworks(cmd_opts.hypernetwork_dir)


def get_infotext_names():
    from src.skills.ml.vision.stable_diffusion.modules import infotext_utils, shared
    res = {}
...
def ui_reorder_categories():
    from src.skills.ml.vision.stable_diffusion.modules import scripts
