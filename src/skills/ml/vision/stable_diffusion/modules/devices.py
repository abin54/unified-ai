...
import torch
from src.skills.ml.vision.stable_diffusion.modules import errors, shared, npu_specific

if sys.platform == "darwin":
    from src.skills.ml.vision.stable_diffusion.modules import mac_specific

if shared.cmd_opts.use_ipex:
    from src.skills.ml.vision.stable_diffusion.modules import xpu_specific
