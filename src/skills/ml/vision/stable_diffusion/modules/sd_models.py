...
from src.skills.ml.vision.stable_diffusion.modules import paths, shared, modelloader, devices, script_callbacks, sd_vae, sd_disable_initialization, errors, hashes, sd_models_config, sd_unet, sd_models_xl, cache, extra_networks, processing, lowvram, sd_hijack, patches
from src.skills.ml.vision.stable_diffusion.modules.timer import Timer
...
def load_model(checkpoint_info=None, already_loaded_state_dict=None):
    from src.skills.ml.vision.stable_diffusion.modules import sd_hijack
