...
from src.skills.ml.vision.stable_diffusion.modules import shared, devices, sd_hijack, sd_models, images, sd_samplers, sd_hijack_checkpoint, errors, hashes
import src.skills.ml.vision.stable_diffusion.modules.textual_inversion.dataset
from src.skills.ml.vision.stable_diffusion.modules.textual_inversion.learn_schedule import LearnRateScheduler

from src.skills.ml.vision.stable_diffusion.modules.textual_inversion.image_embedding import embedding_to_b64, embedding_from_b64, insert_image_data_embed, extract_image_data_embed, caption_image_overlay
from src.skills.ml.vision.stable_diffusion.modules.textual_inversion.saving_settings import save_settings_to_file
...
def train_embedding(id_task, embedding_name, learn_rate, batch_size, gradient_step, data_root, log_directory, training_width, training_height, varsize, steps, clip_grad_mode, clip_grad_value, shuffle_tags, tag_drop_out, latent_sampling_method, use_weight, create_image_every, save_embedding_every, template_filename, save_image_with_stored_embedding, preview_from_txt2img, preview_prompt, preview_negative_prompt, preview_steps, preview_sampler_name, preview_cfg_scale, preview_seed, preview_width, preview_height):
    from src.skills.ml.vision.stable_diffusion.modules import processing
