...
from src.skills.ml.vision.stable_diffusion.modules import localization, shared, scripts, util
from src.skills.ml.vision.stable_diffusion.modules.paths import script_path, data_path
...
def css_html():
    ...
    from src.skills.ml.vision.stable_diffusion.modules.shared_gradio_themes import resolve_var
