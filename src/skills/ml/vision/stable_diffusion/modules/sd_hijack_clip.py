...
from src.skills.ml.vision.stable_diffusion.modules import prompt_parser, devices, sd_hijack, sd_emphasis
...
class FrozenCLIPEmbedderWithCustomWordsBase(TextConditionalModel):
    ...
    def forward(self, texts):
        if opts.use_old_emphasis_implementation:
            import src.skills.ml.vision.stable_diffusion.modules.sd_hijack_clip_old
