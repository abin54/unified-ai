...
def restore_config_state_file():
    from src.skills.ml.vision.stable_diffusion.modules import shared, config_states
...
def configure_opts_onchange():
    from src.skills.ml.vision.stable_diffusion.modules import shared, sd_models, sd_vae, ui_tempdir, sd_hijack
    from src.skills.ml.vision.stable_diffusion.modules.call_queue import wrap_queued_call
