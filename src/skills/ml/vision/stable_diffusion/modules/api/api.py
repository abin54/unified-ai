...
from src.skills.ml.vision.stable_diffusion.modules import sd_samplers, deepbooru, sd_hijack, images, scripts, ui, postprocessing, errors, restart, shared_items, script_callbacks, infotext_utils, sd_models, sd_schedulers
from src.skills.ml.vision.stable_diffusion.modules.api import models
from src.skills.ml.vision.stable_diffusion.modules.shared import opts
from src.skills.ml.vision.stable_diffusion.modules.processing import StableDiffusionProcessingTxt2Img, StableDiffusionProcessingImg2Img, process_images
from src.skills.ml.vision.stable_diffusion.modules.textual_inversion.textual_inversion import create_embedding, train_embedding
from src.skills.ml.vision.stable_diffusion.modules.hypernetworks.hypernetwork import create_hypernetwork, train_hypernetwork
from PIL import PngImagePlugin
from src.skills.ml.vision.stable_diffusion.modules.sd_models_config import find_checkpoint_config_near_filename
from src.skills.ml.vision.stable_diffusion.modules.realesrgan_model import get_realesrgan_models
from src.skills.ml.vision.stable_diffusion.modules import devices
from typing import Any
import piexif
import piexif.helper
from contextlib import closing
from src.skills.ml.vision.stable_diffusion.modules.progress import create_task_id, add_task_to_queue, start_task, finish_task, current_task
...
class Api:
    ...
    def get_sd_models(self):
        import src.skills.ml.vision.stable_diffusion.modules.sd_models as sd_models
        return [{"title": x.title, "model_name": x.model_name, "hash": x.shorthash, "sha256": x.sha256, "filename": x.filename, "config": find_checkpoint_config_near_filename(x)} for x in sd_models.checkpoints_list.values()]

    def get_sd_vaes(self):
        import src.skills.ml.vision.stable_diffusion.modules.sd_vae as sd_vae
