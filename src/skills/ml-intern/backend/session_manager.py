...
from src.orchestrator.core.agent_loop import process_submission
...
class SessionManager:
    ...
    async def seed_from_summary(self, session_id: str, messages: list[dict]) -> int:
        ...
        from src.orchestrator.context_manager.manager import _RESTORE_PROMPT, summarize_messages
