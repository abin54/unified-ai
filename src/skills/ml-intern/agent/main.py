...
from src.orchestrator.core.agent_loop import submission_loop
from src.orchestrator.core import model_switcher
from src.orchestrator.core.session import OpType
from src.orchestrator.core.tools import ToolRouter
from src.orchestrator.utils.reliability_checks import check_training_script_save_pattern
from src.orchestrator.utils.terminal_display import (
    get_console,
...
async def main():
    ...
    from src.orchestrator.core import hf_router_catalog
