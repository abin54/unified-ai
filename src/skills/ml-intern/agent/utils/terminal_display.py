...
def print_banner(model: str | None = None, hf_user: str | None = None) -> None:
    ...
    from src.orchestrator.utils.particle_logo import run_particle_logo
    from src.orchestrator.utils.crt_boot import run_boot_sequence
...
def format_plan_display() -> str:
    ...
    from src.skills.ml.plan_tool import get_current_plan
