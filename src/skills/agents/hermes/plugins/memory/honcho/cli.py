...
from src.skills.agents.hermes_cli.memory_setup import cmd_setup_provider
...
def register_cli(subparser) -> None:
    ...
    subs.add_parser(
        "migrate",
        help="Step-by-step migration guide from src.skills.agents.openclaw-honcho to Hermes Honcho",
    )
