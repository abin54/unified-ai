...
try:
from src.skills.agents.hermes_cli import __version__ as HERMES_VERSION
except Exception:
...
class HermesACPAgent(acp.Agent):
    ...
    def _build_model_state(self, state: SessionState) -> SessionModelState | None:
        ...
        try:
from src.skills.agents.hermes_cli.models import curated_models_for_provider, normalize_provider, provider_label
    ...
    def _resolve_model_selection(raw_model: str, current_provider: str) -> tuple[str, str]:
        ...
        try:
from src.skills.agents.hermes_cli.models import detect_provider_for_model, parse_model_input
