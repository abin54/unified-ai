...
from src.skills.agents.hermes_cli.plugins import _get_disabled_plugins, get_plugin_manager
...
from src.skills.agents.hermes_cli.plugins import discover_plugins, get_plugin_manager
