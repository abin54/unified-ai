...
def execute_code(
    ...
    try:
        ...
        # the staging tmpdir so ``import src.skills.agents.hermes_tools import ...`` resolves even
...
from src.skills.agents.hermes_constants import get_subprocess_home
...
def build_execute_code_schema(enabled_sandbox_tools: set = None,
    ...
    description = (
        ...
        f"Available via `import src.skills.agents.hermes_tools import ...`:\n\n"
        f"{tool_lines}\n\n"
            ...
            "properties": {
                "code": {
                    ...
                    "description": (
                        ...
                        f"`import src.skills.agents.hermes_tools import {import_str}` "
