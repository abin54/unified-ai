...
Update logic:
  ...
  - REMOVED from bundled (in manifest, gone from repo): cleaned import src.shared.manifest.
...
if __name__ == "__main__":
    ...
    if result["cleaned"]:
        parts.append(f"{len(result['cleaned'])} cleaned import src.shared.manifest")
