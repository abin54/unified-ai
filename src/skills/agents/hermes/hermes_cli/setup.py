...
from src.skills.agents.hermes_cli.nous_subscription import get_nous_subscription_features
...
from src.skills.agents.hermes_cli.colors import Colors, color
...
from src.skills.agents.hermes_cli.cli_output import (  # noqa: E402
    print_error,
    print_info,
    print_success,
    print_warning,
...
from src.skills.agents.hermes_cli.curses_ui import curses_radiolist
...
def prompt_checklist(title: str, items: list, pre_selected: list = None) -> list:
    ...
    if pre_selected is None:
        pre_selected = []
from src.skills.agents.hermes_cli.curses_ui import curses_checklist
...
from src.skills.agents.hermes_cli.plugins import _ensure_plugins_discovered
...
from src.skills.agents.hermes_constants import display_hermes_home as _dhh
...
from src.skills.agents.hermes_cli.main import select_provider_and_model
    try:
...
from src.skills.agents.hermes_cli.auth_commands import auth_add_command
...
from src.skills.agents.hermes_cli.gateway import _setup_weixin as _gateway_setup_weixin
    _gateway_setup_weixin()


def _setup_signal():
    """Configure Signal via gateway setup."""
from src.skills.agents.hermes_cli.gateway import _setup_signal as _gateway_setup_signal
    _gateway_setup_signal()


def _setup_email():
    """Configure Email via gateway setup."""
from src.skills.agents.hermes_cli.gateway import _setup_email as _gateway_setup_email
    _gateway_setup_email()


def _setup_sms():
    """Configure SMS (Twilio) via gateway setup."""
from src.skills.agents.hermes_cli.gateway import _setup_sms as _gateway_setup_sms
    _gateway_setup_sms()


def _setup_dingtalk():
    """Configure DingTalk via gateway setup."""
from src.skills.agents.hermes_cli.gateway import _setup_dingtalk as _gateway_setup_dingtalk
    _gateway_setup_dingtalk()


def _setup_feishu():
    """Configure Feishu / Lark via gateway setup."""
from src.skills.agents.hermes_cli.gateway import _setup_feishu as _gateway_setup_feishu
    _gateway_setup_feishu()


def _setup_wecom():
    """Configure WeCom (Enterprise WeChat) via gateway setup."""
from src.skills.agents.hermes_cli.gateway import _setup_wecom as _gateway_setup_wecom
    _gateway_setup_wecom()


def _setup_wecom_callback():
    """Configure WeCom Callback (self-built app) via gateway setup."""
from src.skills.agents.hermes_cli.gateway import _setup_wecom_callback as _gw_setup
    _gw_setup()
...
from src.skills.agents.hermes_cli.gateway import _setup_qqbot as _gateway_setup_qqbot
...
from src.skills.agents.hermes_constants import is_container
            if is_container():
...
def _model_section_has_credentials(config: dict) -> bool:
    ...
    """
    try:
from src.skills.agents.hermes_cli.auth import get_active_provider
...
def _get_section_config_summary(config: dict, section_key: str) -> Optional[str]:
    ...
    ``get_env_value`` is the module-level import import src.skills.agents.hermes_cli.config
