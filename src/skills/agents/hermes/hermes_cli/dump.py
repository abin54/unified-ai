...
from src.skills.agents.hermes_cli.config import get_hermes_home, get_env_path, get_project_root, load_config
...
def _gateway_status() -> str:
    ...
    try:
from src.skills.agents.hermes_cli.gateway import get_gateway_runtime_snapshot
