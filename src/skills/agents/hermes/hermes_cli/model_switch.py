...
from src.skills.agents.hermes_cli.providers import (
...
def list_authenticated_providers(
    ...
    Uses the curated model lists import src.skills.agents.hermes_cli/models.py (OPENROUTER_MODELS,
...
from src.skills.agents.hermes_cli.auth import PROVIDER_REGISTRY as _auth_registry
...
from src.skills.agents.hermes_cli.auth import _load_auth_store
    ...
    # with `hermes model`).
    try:
from src.skills.agents.hermes_cli.models import CANONICAL_PROVIDERS as _canon_provs
    except ImportError:
        _canon_provs = []
