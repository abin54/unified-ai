...
def uninstall_gateway_service():
    ...
    try:
from src.skills.agents.hermes_cli.gateway import kill_gateway_processes, find_gateway_pids
...
from src.skills.agents.hermes_cli.gateway import (
    ...
    # 3. macOS: uninstall launchd plist
        ...
        try:
from src.skills.agents.hermes_cli.gateway import get_launchd_plist_path
...
def _discover_named_profiles():
    ...
    default root."""
    try:
from src.skills.agents.hermes_cli.profiles import list_profiles
    except Exception:
        return []
    try:
