...
from src.skills.agents.hermes_cli.default_soul import DEFAULT_SOUL_MD
...
# Re-export import src.skills.agents.hermes_constants — canonical definition lives there.
from src.skills.agents.hermes_constants import get_hermes_home  # noqa: F811,E402
