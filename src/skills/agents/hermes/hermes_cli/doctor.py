...
from src.skills.agents.hermes_cli.config import get_project_root, get_hermes_home, get_env_path
...
from src.skills.agents.hermes_cli.models import _HERMES_USER_AGENT
from src.skills.agents.hermes_constants import OPENROUTER_MODELS_URL
...
from src.skills.agents.hermes_constants import is_termux as _is_termux
...
from src.skills.agents.hermes_cli.auth import PROVIDER_REGISTRY
                ...
                pass
            try:
from src.skills.agents.hermes_cli.config import get_compatible_custom_providers as _compatible_custom_providers
from src.skills.agents.hermes_cli.providers import resolve_provider_full as _resolve_provider_full
            except Exception:
            ...
            if canonical_provider and canonical_provider not in ("auto", "custom", "openrouter"):
                try:
from src.skills.agents.hermes_cli.auth import PROVIDER_REGISTRY, get_auth_status
    ...
    if config_path.exists():
        try:
from src.skills.agents.hermes_cli.config import check_config_version, migrate_config
        ...
        try:
from src.skills.agents.hermes_cli.config import validate_config_structure
...
from src.skills.agents.hermes_cli.config import get_env_value
    ...
    # =========================================================================
    try:
from src.skills.agents.hermes_cli.profiles import list_profiles, _get_wrapper_dir, profile_exists
        import re as _re
