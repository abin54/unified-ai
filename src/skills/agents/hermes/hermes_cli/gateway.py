...
from src.skills.agents.hermes_constants import is_container, is_termux, is_wsl
...
from src.skills.agents.hermes_cli.main import cmd_whatsapp
    import argparse
...
from src.skills.agents.hermes_cli.setup import (
    ...
    if method == 0:
        ...
        try:
from src.skills.agents.hermes_cli.dingtalk_auth import dingtalk_qr_auth
