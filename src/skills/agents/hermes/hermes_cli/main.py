...
def _apply_profile_override() -> None:
    ...
    if profile_name is None:
        try:
from src.skills.agents.hermes_constants import get_default_hermes_root
    ...
    if profile_name is not None:
        try:
from src.skills.agents.hermes_cli.profiles import resolve_profile_env
...
from src.skills.agents.hermes_cli.config import get_hermes_home
from src.skills.agents.hermes_cli.env_loader import load_hermes_dotenv
...
try:
from src.skills.agents.hermes_logging import setup_logging as _setup_logging
...
try:
from src.skills.agents.hermes_cli.config import load_config as _load_config_early
from src.skills.agents.hermes_constants import apply_ipv4_preference as _apply_ipv4
...
from src.skills.agents.hermes_cli import __version__, __release_date__
from src.skills.agents.hermes_constants import AI_GATEWAY_BASE_URL, OPENROUTER_BASE_URL
...
from src.skills.agents.hermes_cli.config import get_env_path, get_hermes_home, load_config
from src.skills.agents.hermes_cli.auth import get_auth_status

    # Determine whether Hermes itself has been explicitly configured (model
    # in config that isn't the hardcoded default). Used below to gate external
    # tool credentials (Claude Code, Codex CLI) that shouldn't silently skip
    # the setup wizard on a fresh install.
from src.skills.agents.hermes_cli.config import DEFAULT_CONFIG
...
from src.skills.agents.hermes_cli.auth import PROVIDER_REGISTRY
...
def _resolve_last_session(source: str = "cli") -> Optional[str]:
    ...
    try:
from src.skills.agents.hermes_state import SessionDB
...
def cmd_chat(args):
    ...
    if not _has_any_provider_configured():
        ...
        print()
from src.skills.agents.hermes_cli.setup import (
    ...
    try:
from src.skills.agents.hermes_cli.banner import prefetch_update_check
...
from src.skills.agents.hermes_cli.gateway import gateway_command
...
from src.skills.agents.hermes_cli.config import get_env_value, save_env_value
...
from src.skills.agents.hermes_cli.setup import run_setup_wizard
...
def select_provider_and_model(args=None):
    ...
    persistence.
    """
from src.skills.agents.hermes_cli.auth import (
        resolve_provider,
        AuthError,
        format_auth_error,
    )
from src.skills.agents.hermes_cli.config import (
        get_compatible_custom_providers,
        load_config,
        get_env_value,
    )
from src.skills.agents.hermes_cli.providers import resolve_provider_full
    ...
    if active == "openrouter" and get_env_value("OPENAI_BASE_URL"):
        active = "custom"
from src.skills.agents.hermes_cli.models import CANONICAL_PROVIDERS, _PROVIDER_LABELS
...
def _clear_stale_openai_base_url():
    ...
    """
from src.skills.agents.hermes_cli.config import get_env_value, save_env_value, load_config
...
def _save_aux_choice(
    ...
    *,
    ...
    """
from src.skills.agents.hermes_cli.config import load_config, save_config
...
def _aux_config_menu() -> None:
    ...
    """
from src.skills.agents.hermes_cli.config import load_config
...
def _aux_select_for_task(task: str) -> None:
    ...
    """
from src.skills.agents.hermes_cli.config import load_config
from src.skills.agents.hermes_cli.model_switch import list_authenticated_providers
...
from src.skills.agents.hermes_cli.auth import _prompt_model_selection
from src.skills.agents.hermes_cli.models import get_pricing_for_provider
...
def _prompt_provider_choice(choices, *, default=0):
    ...
    """
    try:
from src.skills.agents.hermes_cli.setup import _curses_prompt_choice
...
from src.skills.agents.hermes_cli.config import get_env_value, save_env_value
    ...
    if not api_key:
        ...
        print("API key saved.")
        print()
from src.skills.agents.hermes_cli.models import model_ids, get_pricing_for_provider
...
from src.skills.agents.hermes_cli.config import get_env_value, save_env_value
    ...
    if not api_key:
        ...
        print("API key saved.")
        print()
from src.skills.agents.hermes_cli.models import ai_gateway_model_ids, get_pricing_for_provider
...
from src.skills.agents.hermes_cli.nous_subscription import prompt_enable_tool_gateway
...
from src.skills.agents.hermes_cli.models import (
        _PROVIDER_MODELS,
...
from src.skills.agents.hermes_cli.auth import DEFAULT_NOUS_PORTAL_URL
...
from src.skills.agents.hermes_cli.codex_models import get_codex_model_ids
    ...
    if not _codex_token:
        try:
from src.skills.agents.hermes_cli.auth import resolve_codex_runtime_credentials
...
from src.skills.agents.hermes_cli.models import fetch_api_models
...
from src.skills.agents.hermes_cli.models import _PROVIDER_MODELS
...
def _model_flow_custom(config):
    ...
    """
from src.skills.agents.hermes_cli.auth import _save_model_choice, deactivate_provider
from src.skills.agents.hermes_cli.config import get_env_value, load_config, save_config
    ...
    if _looks_local and not _url_lower.endswith("/v1"):
        ...
        print()
from src.skills.agents.hermes_cli.models import probe_api_models
...
from src.skills.agents.hermes_cli.config import load_config, save_config
    ...
    try:
        ...
        idx = menu.show()
from src.skills.agents.hermes_cli.curses_ui import flush_stdin
...
from src.skills.agents.hermes_cli.config import save_env_value, load_config, save_config
from src.skills.agents.hermes_cli.models import (
        fetch_api_models,
    ...
    if not api_key:
        ...
        if choice == "1":
            try:
from src.skills.agents.hermes_cli.copilot_auth import copilot_device_code_login
            ...
            # Validate token type
            try:
from src.skills.agents.hermes_cli.copilot_auth import validate_copilot_token
...
from src.skills.agents.hermes_cli.config import get_env_value, save_env_value, load_config, save_config
from src.skills.agents.hermes_cli.models import fetch_api_models
...
from src.skills.agents.hermes_cli.models import fetch_ollama_cloud_models
...
from src.skills.agents.hermes_constants import display_hermes_home as _dhh_fn
...
from src.skills.agents.hermes_cli.auth import get_anthropic_key
...
from src.skills.agents.hermes_cli.auth import login_command
...
from src.skills.agents.hermes_cli.auth import logout_command
...
from src.skills.agents.hermes_cli.auth_commands import auth_command
...
from src.skills.agents.hermes_cli.status import show_status
...
def cmd_cron(args):
    """Cron job management."""
from src.skills.agents.hermes_cli.cron import cron_command
...
from src.skills.agents.hermes_cli.webhook import webhook_command
...
from src.skills.agents.hermes_cli.hooks import hooks_command
    hooks_command(args)


def cmd_doctor(args):
    """Check configuration and dependencies."""
from src.skills.agents.hermes_cli.doctor import run_doctor
...
from src.skills.agents.hermes_cli.dump import run_dump
...
from src.skills.agents.hermes_cli.debug import run_debug
...
from src.skills.agents.hermes_cli.config import config_command
...
from src.skills.agents.hermes_cli.backup import run_quick_backup

        run_quick_backup(args)
    else:
from src.skills.agents.hermes_cli.backup import run_backup
...
from src.skills.agents.hermes_cli.backup import run_import
...
def cmd_version(args):
    ...
    try:
from src.skills.agents.hermes_cli.banner import check_for_updates
from src.skills.agents.hermes_cli.config import recommended_update_command
...
from src.skills.agents.hermes_cli.uninstall import run_uninstall
...
from src.skills.agents.hermes_constants import get_hermes_home
...
def _update_via_zip(args):
    ...
    try:
        ...
        if result.get("cleaned"):
            print(f"  − {len(result['cleaned'])} removed import src.shared.manifest")
...
from src.skills.agents.hermes_cli.config import get_hermes_home as _get_hermes_home
...
def cmd_update(args):
    ...
    """
from src.skills.agents.hermes_cli.config import is_managed, managed_error
...
def _cmd_update_impl(args, gateway_mode: bool):
    ...
    try:
        ...
        try:
            import importlib
            import src.skills.agents.hermes_constants as _hc
        ...
        try:
from src.skills.agents.hermes_cli.profiles import (
                list_profiles,
...
from src.skills.agents.hermes_cli.config import (
        ...
        try:
from src.skills.agents.hermes_cli.gateway import (
                is_macos,
            ...
            try:
from src.skills.agents.hermes_constants import (
...
from src.skills.agents.hermes_constants import display_hermes_home
...
from src.skills.agents.hermes_cli.profiles import profile_exists
...
from src.skills.agents.hermes_cli.profiles import rename_profile
...
from src.skills.agents.hermes_cli.profiles import export_profile
...
from src.skills.agents.hermes_cli.profiles import import_profile
...
def cmd_dashboard(args):
    ...
    if "HERMES_WEB_DIST" not in os.environ:
        if not _build_web_ui(PROJECT_ROOT / "web", fatal=True):
            sys.exit(1)
from src.skills.agents.hermes_cli.web_server import start_server
...
from src.skills.agents.hermes_cli.completion import generate_bash, generate_zsh, generate_fish
...
from src.skills.agents.hermes_cli.logs import tail_log, list_logs
...
from src.skills.agents.hermes_cli.pairing import pairing_command
...
from src.skills.agents.hermes_cli.skills_config import skills_command as skills_config_command

            skills_config_command(args)
        else:
from src.skills.agents.hermes_cli.skills_hub import skills_command
...
from src.skills.agents.hermes_cli.plugins_cmd import plugins_command
...
from src.skills.agents.hermes_constants import get_hermes_home, display_hermes_home
...
from src.skills.agents.hermes_cli.memory_setup import memory_command
...
from src.skills.agents.hermes_cli.tools_config import tools_disable_enable_command

            tools_disable_enable_command(args)
        else:
            _require_tty("tools")
from src.skills.agents.hermes_cli.tools_config import tools_command
    ...
    def cmd_mcp(args):
from src.skills.agents.hermes_cli.mcp_config import mcp_command
...
from src.skills.agents.hermes_state import SessionDB
    ...
    def cmd_claw(args):
from src.skills.agents.hermes_cli.claw import claw_command
...
from src.skills.agents.hermes_cli.config import get_container_exec_info
    ...
    if (
        ...
        try:
from src.skills.agents.hermes_cli.plugins import discover_plugins
            discover_plugins()
        except Exception:
            logger.debug(
