...
from src.skills.agents.hermes_cli import auth as auth_mod
...
def _copilot_runtime_api_mode(model_cfg: Dict[str, Any], api_key: str) -> str:
    ...
    try:
from src.skills.agents.hermes_cli.models import copilot_model_api_mode
...
from src.skills.agents.hermes_cli.models import opencode_model_api_mode
