...
from src.skills.agents.hermes_cli.config import get_hermes_home, get_config_path, read_raw_config
...
def _resolve_api_key_provider_secret(
    ...
    if provider_id == "copilot":
        ...
        try:
from src.skills.agents.hermes_cli.copilot_auth import resolve_copilot_token
...
def _prompt_model_selection(
    ...
    """
from src.skills.agents.hermes_cli.models import _format_price_per_mtok
...
def _save_model_choice(model_id: str) -> None:
    ...
    """
from src.skills.agents.hermes_cli.config import save_config, load_config
