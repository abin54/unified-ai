...
def _codex_curated_models() -> list[str]:
    ...
    """
from src.skills.agents.hermes_cli.codex_models import DEFAULT_CODEX_MODELS, _add_forward_compat_models
...
def check_nous_free_tier() -> bool:
    ...
    try:
from src.skills.agents.hermes_cli.auth import get_provider_auth_state, resolve_nous_runtime_credentials
...
from src.skills.agents.hermes_constants import AI_GATEWAY_BASE_URL
...
def list_available_providers() -> list[dict[str, str]]:
    ...
    for pid in provider_order:
        ...
        has_creds = False
        try:
from src.skills.agents.hermes_cli.auth import get_auth_status, has_usable_secret
            if pid == "custom":
...
from src.skills.agents.hermes_cli.auth import PROVIDER_REGISTRY
        ...
        if not has_creds:
            try:
from src.skills.agents.hermes_cli.auth import _load_auth_store
...
def _resolve_copilot_catalog_api_key() -> str:
    ...
    try:
from src.skills.agents.hermes_cli.auth import resolve_api_key_provider_credentials
...
from src.skills.agents.hermes_cli.auth import resolve_codex_runtime_credentials
    ...
    if normalized == "nous":
        ...
        try:
from src.skills.agents.hermes_cli.auth import fetch_nous_models, resolve_nous_runtime_credentials
            creds = resolve_nous_runtime_credentials()
            if creds:
...
def copilot_default_headers() -> dict[str, str]:
    ...
    """
    try:
from src.skills.agents.hermes_cli.copilot_auth import copilot_request_headers
