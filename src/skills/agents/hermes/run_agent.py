...
from src.skills.agents.hermes_cli.timeouts import (
...
from src.skills.agents.hermes_cli import __version__ as _HERMES_VERSION
...
from src.skills.agents.hermes_cli.model_normalize import (
        ...
        self._cache_ttl = "5m"
        try:
from src.skills.agents.hermes_cli.config import load_config as _load_pc_cfg
...
from src.skills.agents.hermes_logging import setup_logging, setup_verbose_logging
        ...
        if self.api_mode == "anthropic_messages":
            ...
            try:
from src.skills.agents.hermes_cli.config import load_config as _load_br_cfg
...
from src.skills.agents.hermes_cli.models import copilot_default_headers
...
from src.skills.agents.hermes_cli.auth import PROVIDER_REGISTRY
        ...
        try:
from src.skills.agents.hermes_cli.config import load_config as _load_agent_config
...
from src.skills.agents.hermes_cli.config import get_compatible_custom_providers
        ...
        if _engine_name != "compressor":
            ...
            if _selected_engine is None:
                try:
from src.skills.agents.hermes_cli.plugins import get_plugin_context_engine
    ...
    def switch_model(self, new_model, new_provider, api_key='', base_url='', api_mode=''):
        ...
        turn-scoped).
        """
from src.skills.agents.hermes_cli.providers import determine_api_mode
    ...
    def _provider_model_requires_responses_api(
        ...
        *,
        ...
        if normalized_provider == "copilot":
            try:
from src.skills.agents.hermes_cli.models import _should_use_copilot_responses_api
    ...
    def _strip_think_blocks(self, content: str) -> str:
        ...
        Ported from src.skills.agents.openclaw/openclaw#67318. The ``<function>`` variant is
...
from src.skills.agents.hermes_time import now as _hermes_now
        now = _hermes_now()
...
from src.skills.agents.hermes_cli.auth import resolve_codex_runtime_credentials
    ...
    def _try_refresh_nous_client_credentials(self, *, force: bool = True) -> bool:
        ...
        try:
from src.skills.agents.hermes_cli.auth import resolve_nous_runtime_credentials
...
from src.skills.agents.hermes_cli.models import copilot_default_headers
    ...
    def _try_activate_fallback(self) -> bool:
        ...
        try:
            ...
            try:
from src.skills.agents.hermes_cli.model_normalize import normalize_model_for_provider
    ...
    def _supports_reasoning_extra_body(self) -> bool:
        ...
        if (
            ...
            try:
from src.skills.agents.hermes_cli.models import github_model_reasoning_efforts
...
from src.skills.agents.hermes_cli.models import github_model_reasoning_efforts
    ...
    def _invoke_tool(self, function_name: str, function_args: dict, effective_task_id: str,
        ...
        try:
from src.skills.agents.hermes_cli.plugins import get_pre_tool_call_block_message
...
from src.skills.agents.hermes_logging import set_session_context
