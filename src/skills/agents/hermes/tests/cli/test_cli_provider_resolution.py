...
from src.skills.agents.hermes_cli import main as hermes_main
...
from src.skills.agents.hermes_cli.main import _auto_provider_name
...
def test_save_custom_provider_uses_provided_name(monkeypatch, tmp_path):
    ...
    import yaml
from src.skills.agents.hermes_cli.main import _save_custom_provider
