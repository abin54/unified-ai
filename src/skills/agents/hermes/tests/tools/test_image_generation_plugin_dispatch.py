...
from src.orchestrator import image_gen_registry
...
class TestPluginDispatch:
    def test_dispatch_routes_to_codex_provider(self, monkeypatch, tmp_path):
        ...
        from src.orchestrator import image_gen_registry as registry_module
from src.skills.agents.hermes_cli import plugins as plugins_module
