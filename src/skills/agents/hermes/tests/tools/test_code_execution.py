...
class TestExecuteCode(unittest.TestCase):
    ...
    def test_repo_root_modules_are_importable(self):
        """Sandboxed scripts can import src.skills.ml.vision.stable_diffusion.modules that live at the repo root."""
        result = self._run('import src.skills.agents.hermes_constants; print(hermes_constants.__file__)')
        self.assertEqual(result["status"], "success")
    ...
    def test_single_tool_call(self):
        ...
        code = """
from src.skills.agents.hermes_tools import terminal
...
"""
    ...
    def test_multi_tool_chain(self):
        ...
        code = """
from src.skills.agents.hermes_tools import terminal, read_file
r1 = terminal("ls")
...
"""
    ...
    def test_web_search_tool(self):
        ...
        code = """
from src.skills.agents.hermes_tools import web_search
...
"""
    ...
    def test_json_parse_helper(self):
        ...
        code = r"""
from src.skills.agents.hermes_tools import json_parse
...
"""
    ...
    def test_shell_quote_helper(self):
        ...
        code = """
from src.skills.agents.hermes_tools import shell_quote
...
"""
    ...
    def test_retry_helper_success(self):
        ...
        code = """
from src.skills.agents.hermes_tools import retry
counter = [0]
def flaky():
    counter[0] += 1
...
class TestExecuteCodeEdgeCases(unittest.TestCase):
    ...
    def test_none_enabled_tools_uses_all(self):
        ...
        code = (
            "import src.skills.agents.hermes_tools import terminal, web_search, read_file\n"
    ...
    def test_empty_enabled_tools_uses_all(self):
        ...
        code = (
            "import src.skills.agents.hermes_tools import terminal, web_search\n"
            "print('imports ok')\n"
        )
        with patch("model_tools.handle_function_call",
                    return_value=json.dumps({"ok": True})):
    ...
    def test_nonoverlapping_tools_fallback(self):
        ...
        code = (
            "import src.skills.agents.hermes_tools import terminal\n"
            "print('fallback ok')\n"
        )
        with patch("model_tools.handle_function_call",
                    return_value=json.dumps({"ok": True})):
