...
from src.skills.agents.hermes_cli.auth import resolve_provider
...
from src.skills.agents.hermes_cli.providers import ALIASES
...
from src.skills.agents.hermes_cli.providers import TRANSPORT_TO_API_MODE
