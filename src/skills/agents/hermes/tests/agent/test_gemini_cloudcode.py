...
class TestClientCredResolution:
    ...
    def test_falls_back_to_scrape_when_defaults_wiped(self, tmp_path, monkeypatch):
        ...
        from src.orchestrator import google_oauth
...
class TestLoadCodeAssist:
    def test_parses_response(self, monkeypatch):
        from src.orchestrator import google_code_assist
...
from src.skills.agents.hermes_cli.auth_commands import _OAUTH_CAPABLE_PROVIDERS
...
from src.skills.agents.hermes_cli.config import OPTIONAL_ENV_VARS
