...
from src.skills.agents.hermes_cli.tools_config import _estimate_tool_tokens, _tool_token_cache

    # Clear cache to force fresh computation
    import src.skills.agents.hermes_cli.tools_config as tc
...
def test_status_fn_returns_formatted_token_count(monkeypatch):
    ...
    import src.skills.agents.hermes_cli.tools_config as tc
from src.skills.agents.hermes_cli.tools_config import CONFIGURABLE_TOOLSETS
...
from src.skills.agents.hermes_cli.curses_ui import _numbered_fallback
