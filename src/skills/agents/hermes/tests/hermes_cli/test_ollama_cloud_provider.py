...
from src.skills.agents.hermes_cli.auth import PROVIDER_REGISTRY, resolve_provider, resolve_api_key_provider_credentials
from src.skills.agents.hermes_cli.models import _PROVIDER_MODELS, _PROVIDER_LABELS, _PROVIDER_ALIASES, normalize_provider
...
from src.skills.agents.hermes_cli.models import fetch_ollama_cloud_models, _save_ollama_cloud_cache
...
from src.skills.agents.hermes_cli.providers import HERMES_OVERLAYS
...
from src.skills.agents.hermes_cli.providers import normalize_provider as np
        assert np("ollama") == "custom"  # bare "ollama" = local
        assert np("ollama-cloud") == "ollama-cloud"

    def test_label_override(self):
from src.skills.agents.hermes_cli.providers import _LABEL_OVERRIDES
...
from src.skills.agents.hermes_cli.providers import get_provider
