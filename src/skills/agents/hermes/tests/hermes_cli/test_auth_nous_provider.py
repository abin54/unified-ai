...
from src.skills.agents.hermes_cli.auth import AuthError, get_provider_auth_state, resolve_nous_runtime_credentials
...
from src.skills.agents.hermes_cli.auth import _resolve_verify
...
def test_get_nous_auth_status_checks_credential_pool(tmp_path, monkeypatch):
    ...
    """
from src.skills.agents.hermes_cli.auth import get_nous_auth_status
...
class TestLoginNousSkipKeepsCurrent:
    ...
    def _patch_login_internals(self, monkeypatch, *, prompt_returns):
        ...
        import src.skills.agents.hermes_cli.auth as auth_mod
        import src.skills.agents.hermes_cli.models as models_mod
        import src.skills.agents.hermes_cli.nous_subscription as ns
    ...
    def test_skip_keep_current_preserves_provider_and_model(self, tmp_path, monkeypatch):
        ...
        import argparse
        import yaml
from src.skills.agents.hermes_cli.auth import PROVIDER_REGISTRY, _login_nous
...
def test_persist_nous_credentials_writes_both_pool_and_providers(tmp_path, monkeypatch):
    ...
    """
from src.skills.agents.hermes_cli.auth import persist_nous_credentials, NOUS_DEVICE_CODE_SOURCE
...
def test_persist_nous_credentials_allows_recovery_from_401(tmp_path, monkeypatch):
    ...
    """
from src.skills.agents.hermes_cli.auth import persist_nous_credentials, resolve_nous_runtime_credentials
