...
from src.skills.agents.hermes_cli import setup as setup_mod
from src.skills.agents.hermes_cli.setup import setup_model_provider
...
def test_setup_gateway_skips_service_install_when_systemctl_missing(monkeypatch, capsys):
    ...
    import src.skills.agents.hermes_cli.gateway as gateway_mod
...
def test_setup_gateway_in_container_shows_docker_guidance(monkeypatch, capsys):
    ...
    import src.skills.agents.hermes_constants
...
from src.skills.agents.hermes_cli.setup import setup_terminal_backend
