...
from src.skills.agents.hermes_cli import __version__
...
def test_check_for_updates_no_git_dir(tmp_path, monkeypatch):
    ...
    import src.skills.agents.hermes_cli.banner as banner
...
from src.skills.agents.hermes_cli.main import _invalidate_update_cache
