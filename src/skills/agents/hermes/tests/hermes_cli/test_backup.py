...
from src.skills.agents.hermes_cli.backup import _should_exclude
...
from src.skills.agents.hermes_cli.backup import _validate_backup_zip
...
from src.skills.agents.hermes_cli.backup import run_backup, run_import
...
class TestFormatSize:
    def test_bytes(self):
from src.skills.agents.hermes_cli.backup import _format_size
...
from src.skills.agents.hermes_cli.backup import _validate_backup_zip
    ...
    def test_detect_prefix_hermes(self):
        ...
        import io
from src.skills.agents.hermes_cli.backup import _detect_prefix
...
from src.skills.agents.hermes_cli.backup import run_import
    ...
    def test_import_without_profiles_module(self, tmp_path, monkeypatch):
        ...
        import src.skills.agents.hermes_cli.backup as backup_mod
...
from src.skills.agents.hermes_cli.backup import _safe_copy_db
...
from src.skills.agents.hermes_cli.backup import create_quick_snapshot
...
from src.skills.agents.hermes_cli.backup import create_quick_snapshot, list_quick_snapshots
...
from src.skills.agents.hermes_cli.backup import create_quick_snapshot, restore_quick_snapshot
        snap_id = create_quick_snapshot(hermes_home=hermes_home)
...
from src.skills.agents.hermes_cli.backup import restore_quick_snapshot
        assert restore_quick_snapshot("nonexistent", hermes_home=hermes_home) is False

    def test_auto_prune(self, hermes_home):
from src.skills.agents.hermes_cli.backup import create_quick_snapshot, list_quick_snapshots, _QUICK_DEFAULT_KEEP
...
from src.skills.agents.hermes_cli.backup import create_quick_snapshot, prune_quick_snapshots, list_quick_snapshots
        for i in range(10):
            create_quick_snapshot(label=f"s{i}", hermes_home=hermes_home)
