...
from src.skills.agents.hermes_cli import skin_engine
...
from src.skills.agents.hermes_cli.skin_engine import load_skin
...
from src.skills.agents.hermes_cli.skin_engine import _BUILTIN_SKINS, _build_skin_config
...
from src.skills.agents.hermes_cli.skin_engine import set_active_skin, get_active_skin, get_active_skin_name
...
from src.skills.agents.hermes_cli.skin_engine import list_skins
        skins = list_skins()
...
from src.skills.agents.hermes_cli.skin_engine import init_skin_from_config, get_active_skin_name
...
from src.skills.agents.hermes_cli.skin_engine import load_skin, _skins_dir
...
from src.skills.agents.hermes_cli.skin_engine import set_active_skin
        from agent.display import get_skin_tool_prefix
...
from src.skills.agents.hermes_cli.skin_engine import set_active_skin, get_active_prompt_symbol

        set_active_skin("ares")
        assert get_active_prompt_symbol() == "⚔ ❯ "

    def test_active_help_header_ares(self):
from src.skills.agents.hermes_cli.skin_engine import set_active_skin, get_active_help_header

        set_active_skin("ares")
        assert get_active_help_header() == "(⚔) Available Commands"

    def test_active_goodbye_ares(self):
from src.skills.agents.hermes_cli.skin_engine import set_active_skin, get_active_goodbye

        set_active_skin("ares")
        assert get_active_goodbye() == "Farewell, warrior! ⚔"

    def test_prompt_toolkit_style_overrides_cover_tui_classes(self):
from src.skills.agents.hermes_cli.skin_engine import set_active_skin, get_prompt_toolkit_style_overrides
        set_active_skin("ares")
...
from src.skills.agents.hermes_cli.skin_engine import (
            set_active_skin,
            get_active_skin,
