...
from src.skills.agents.hermes_cli.plugins_cmd import (
    _copy_example_files,
    _read_manifest,
    _repo_name_from_url,
    _resolve_git_url,
...
from src.skills.agents.hermes_cli.plugins_cmd import cmd_install
        import argparse
...
from src.skills.agents.hermes_cli.plugins_cmd import cmd_update
...
from src.skills.agents.hermes_cli.plugins_cmd import cmd_remove
...
from src.skills.agents.hermes_cli.plugins_cmd import cmd_list
...
from src.skills.agents.hermes_cli.plugins_cmd import _copy_example_files
...
from src.skills.agents.hermes_cli.plugins_cmd import _prompt_plugin_env_vars
        from unittest.mock import MagicMock
...
from src.skills.agents.hermes_cli.plugins_cmd import _get_current_memory_provider
...
from src.skills.agents.hermes_cli.plugins_cmd import _get_current_context_engine
    ...
    def test_save_memory_provider(self, tmp_path, monkeypatch):
        ...
        config_file = tmp_path / "config.yaml"
        config_file.write_text("memory:\n  provider: ''\n")
from src.skills.agents.hermes_cli.plugins_cmd import _save_memory_provider
    ...
    def test_save_context_engine(self, tmp_path, monkeypatch):
        ...
        config_file = tmp_path / "config.yaml"
        config_file.write_text("context:\n  engine: compressor\n")
from src.skills.agents.hermes_cli.plugins_cmd import _save_context_engine
...
from src.skills.agents.hermes_cli.plugins_cmd import _discover_memory_providers
    ...
    def test_discover_context_engines_empty(self):
        ...
        with patch("plugins.context_engine.discover_context_engines",
                    side_effect=ImportError("no module")):
from src.skills.agents.hermes_cli.plugins_cmd import _discover_context_engines
