...
from src.skills.agents.hermes_cli.auth_commands import auth_remove_command
...
from src.skills.agents.hermes_cli.auth_commands import auth_reset_command
...
from src.skills.agents.hermes_cli.auth_commands import auth_list_command
...
from src.skills.agents.hermes_cli.auth import suppress_credential_source, unsuppress_credential_source, is_source_suppressed
...
def test_unsuppress_credential_source_returns_false_when_absent(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("HERMES_HOME", str(tmp_path / "hermes"))
    _write_auth_store(tmp_path, {"version": 1})
from src.skills.agents.hermes_cli.auth import unsuppress_credential_source
...
def test_auth_add_clears_env_suppression_for_provider(tmp_path, monkeypatch):
    ...
    from types import SimpleNamespace
from src.skills.agents.hermes_cli.auth import is_source_suppressed
from src.skills.agents.hermes_cli.auth_commands import auth_add_command
...
def test_seed_from_singletons_respects_copilot_suppression(tmp_path, monkeypatch):
    ...
    import src.skills.agents.hermes_cli.copilot_auth as ca
...
def test_seed_from_singletons_respects_qwen_suppression(tmp_path, monkeypatch):
    ...
    import src.skills.agents.hermes_cli.auth as ha
