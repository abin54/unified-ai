...
from src.skills.agents.hermes_cli.copilot_auth import _try_gh_cli_token
...
from src.skills.agents.hermes_cli import config as config_module
...
from src.skills.agents.hermes_cli.main import _PROVIDER_MODELS
...
from src.skills.agents.hermes_cli.main import _PROVIDER_MODELS as main_models
from src.skills.agents.hermes_cli.models import _PROVIDER_MODELS as models_models
...
from src.skills.agents.hermes_cli.models import _PROVIDER_ALIASES
        assert _PROVIDER_ALIASES.get("hf") == "huggingface"
        assert _PROVIDER_ALIASES.get("hugging-face") == "huggingface"

    def test_provider_label(self):
from src.skills.agents.hermes_cli.models import _PROVIDER_LABELS
