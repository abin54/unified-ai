...
from src.skills.agents.hermes_cli.mcp_config import cmd_mcp_list
...
from src.skills.agents.hermes_cli.mcp_config import cmd_mcp_remove
...
from src.skills.agents.hermes_cli.mcp_config import cmd_mcp_add
...
from src.skills.agents.hermes_cli.mcp_config import cmd_mcp_add
    ...
    def test_add_preset_fills_transport(self, tmp_path, capsys, monkeypatch):
        ...
        monkeypatch.setattr("builtins.input", lambda _: "")
from src.skills.agents.hermes_cli.mcp_config import cmd_mcp_add
from src.skills.agents.hermes_cli.config import read_raw_config
...
class TestMcpTest:
    def test_test_not_found(self, tmp_path, capsys):
        _seed_config(tmp_path, {})
from src.skills.agents.hermes_cli.mcp_config import cmd_mcp_test
...
from src.skills.agents.hermes_cli.mcp_config import _save_mcp_server, _get_mcp_servers
...
from src.skills.agents.hermes_cli.mcp_config import (
            _save_mcp_server,
            _remove_mcp_server,
            _get_mcp_servers,
        )
...
from src.skills.agents.hermes_cli.mcp_config import _remove_mcp_server

        assert _remove_mcp_server("ghost") is False

    def test_env_key_for_server(self):
from src.skills.agents.hermes_cli.mcp_config import _env_key_for_server
...
class TestMcpLogin:
    def test_login_rejects_unknown_server(self, tmp_path, capsys):
        _seed_config(tmp_path, {})
from src.skills.agents.hermes_cli.mcp_config import cmd_mcp_login
