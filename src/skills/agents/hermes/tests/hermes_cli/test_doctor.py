...
import src.skills.agents.hermes_cli.doctor as doctor
import src.skills.agents.hermes_cli.gateway as gateway_cli
from src.skills.agents.hermes_cli import doctor as doctor_mod
from src.skills.agents.hermes_cli.doctor import _has_provider_env_config
...
class TestDoctorMemoryProviderSection:
    ...
    def _run_doctor_and_capture(self, monkeypatch, tmp_path, provider=""):
        ...
        try:
from src.skills.agents.hermes_cli import auth as _auth_mod
