...
import src.skills.agents.hermes_cli.models as _models_mod
...
from src.skills.agents.hermes_cli.models import _openrouter_model_supports_tools
...
from src.skills.agents.hermes_cli.models import _find_openrouter_slug
        with patch("hermes_cli.models.fetch_openrouter_models", return_value=LIVE_OPENROUTER_MODELS):
...
from src.skills.agents.hermes_cli.models import fetch_nous_recommended_models
