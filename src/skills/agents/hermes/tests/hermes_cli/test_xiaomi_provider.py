...
from src.skills.agents.hermes_cli.models import normalize_provider
        assert normalize_provider("mimo") == "xiaomi"
        assert normalize_provider("xiaomi-mimo") == "xiaomi"

    def test_normalize_provider_providers_py(self):
from src.skills.agents.hermes_cli.providers import normalize_provider
        assert normalize_provider("mimo") == "xiaomi"
        assert normalize_provider("xiaomi-mimo") == "xiaomi"
...
from src.skills.agents.hermes_cli.models import _PROVIDER_MODELS
    ...
    def test_list_agentic_models_mock(self, monkeypatch):
        ...
        from src.orchestrator import models_dev as md
...
from src.skills.agents.hermes_cli.model_normalize import _VENDOR_PREFIXES
...
from src.skills.agents.hermes_cli.model_normalize import _MATCHING_PREFIX_STRIP_PROVIDERS
...
from src.skills.agents.hermes_cli.model_normalize import _LOWERCASE_MODEL_PROVIDERS
...
from src.skills.agents.hermes_cli.doctor import _PROVIDER_ENV_HINTS
...
from src.skills.agents.hermes_cli.providers import HERMES_OVERLAYS, TRANSPORT_TO_API_MODE
        overlay = HERMES_OVERLAYS["xiaomi"]
