...
from src.skills.agents.hermes_cli.completion import _walk, generate_bash, generate_zsh, generate_fish
...
class TestSubcommandDrift:
    def test_SUBCOMMANDS_covers_required_commands(self):
        ...
        """
        import inspect
from src.skills.agents.hermes_cli.main import _coalesce_session_name_args
