...
import src.skills.agents.hermes_cli.providers as providers_mod
from src.skills.agents.hermes_cli.model_switch import list_authenticated_providers, switch_model
