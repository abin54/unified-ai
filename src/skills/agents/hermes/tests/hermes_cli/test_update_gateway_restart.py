...
import src.skills.agents.hermes_cli.main as cli_main
from src.skills.agents.hermes_cli.main import cmd_update
...
class TestGatewayModeWritesExitCodeEarly:
    ...
    def test_exit_code_written_in_gateway_mode(
        ...
        import src.skills.agents.hermes_cli.config as _cfg
