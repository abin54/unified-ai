...
import src.skills.agents.hermes_cli.main, these tests mock the delegation point and verify
that the setup wizard correctly syncs config from disk after the call.
"""

from __future__ import annotations

from src.skills.agents.hermes_cli.config import load_config, save_config, save_env_value
from src.skills.agents.hermes_cli.nous_subscription import NousFeatureState, NousSubscriptionFeatures
from src.skills.agents.hermes_cli.setup import _print_setup_summary, setup_model_provider
...
def test_setup_same_provider_rotation_strategy_saved_for_multi_credential_pool(tmp_path, monkeypatch):
    ...
    import src.skills.agents.hermes_cli.main as _main_mod
    import src.skills.agents.hermes_cli.setup as _setup_mod
