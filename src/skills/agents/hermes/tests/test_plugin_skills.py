...
from src.skills.agents.hermes_cli import plugins as plugins_mod
from src.skills.agents.hermes_cli.plugins import PluginManager
...
from src.skills.agents.hermes_cli import plugins as plugins_mod
from src.skills.agents.hermes_cli.plugins import PluginContext, PluginManager, PluginManifest
