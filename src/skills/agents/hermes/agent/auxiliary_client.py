...
from src.skills.agents.hermes_constants import OPENROUTER_BASE_URL
...
def _read_codex_access_token() -> Optional[str]:
    ...
    try:
from src.skills.agents.hermes_cli.auth import _read_codex_tokens
...
def _resolve_api_key_provider() -> Tuple[Optional[OpenAI], Optional[str]]:
    ...
    """
    try:
from src.skills.agents.hermes_cli.auth import PROVIDER_REGISTRY, resolve_api_key_provider_credentials
    except ImportError:
    ...
    for provider_id, pconfig in PROVIDER_REGISTRY.items():
        ...
        if provider_id == "anthropic":
            ...
            try:
from src.skills.agents.hermes_cli.auth import is_provider_explicitly_configured
...
def _try_nous(vision: bool = False) -> Tuple[Optional[OpenAI], Optional[str]]:
    ...
    model = _NOUS_MODEL
    try:
from src.skills.agents.hermes_cli.models import get_nous_recommended_aux_model
...
from src.skills.agents.hermes_cli.models import copilot_default_headers
    ...
    try:
from src.skills.agents.hermes_cli.runtime_provider import _get_named_custom_provider
