...
def _resolve_positive_anthropic_max_tokens(value) -> Optional[int]:
    ...
    finite positive number. Ported from src.skills.agents.openclaw/openclaw#66664.
...
def _resolve_anthropic_messages_max_tokens(
    ...
    Ported from src.skills.agents.openclaw/openclaw#66664 (resolveAnthropicMessagesMaxTokens).
    """
