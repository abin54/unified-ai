...
def _seed_from_singletons(provider: str, entries: List[PooledCredential]) -> Tuple[bool, Set[str]]:
    ...
    try:
from src.skills.agents.hermes_cli.auth import is_source_suppressed as _is_suppressed
    except ImportError:
...
from src.skills.agents.hermes_cli.copilot_auth import resolve_copilot_token
        ...
        try:
from src.skills.agents.hermes_cli.auth import resolve_qwen_runtime_credentials
...
def _seed_from_env(provider: str, entries: List[PooledCredential]) -> Tuple[bool, Set[str]]:
    ...
    try:
from src.skills.agents.hermes_cli.auth import is_source_suppressed as _is_source_suppressed
    except ImportError:
