...
def run(
    ...
    from src.skills.agents.autogpt.app.main import run_auto_gpt
...
def serve(
    ...
    """
    # Put imports inside function to avoid importing everything when starting the CLI
    from src.skills.agents.autogpt.app.main import run_auto_gpt_server
...
def config(env_file: Optional[Path]) -> None:
    ...
    """
    from src.skills.agents.autogpt.app.settings import SettingsUI
