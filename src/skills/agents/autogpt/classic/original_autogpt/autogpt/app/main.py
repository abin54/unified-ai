...
from src.skills.agents.autogpt.agent_factory.configurators import configure_agent_with_state, create_agent
from src.skills.agents.autogpt.agents.agent_manager import AgentManager
from src.skills.agents.autogpt.agents.prompt_strategies.one_shot import AssistantThoughts
from src.skills.agents.autogpt.app.config import (
    AppConfig,
    ConfigBuilder,
...
if TYPE_CHECKING:
    from src.skills.agents.autogpt.agents.agent import Agent
    from src.skills.agents.autogpt.app.ui.protocol import UIProvider
...
async def run_auto_gpt(
    ...
    def prompt_permission(
        ...
        """
        from src.skills.agents.autogpt.app.ui.rich_select import RichSelect
