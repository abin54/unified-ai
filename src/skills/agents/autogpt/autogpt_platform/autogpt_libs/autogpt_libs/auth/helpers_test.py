...
from src.skills.agents.autogpt_libs.auth.helpers import add_auth_responses_to_openapi
from src.skills.agents.autogpt_libs.auth.jwt_utils import bearer_jwt_auth
...
def test_add_auth_responses_to_openapi_basic():
    ...
    from src.skills.agents.autogpt_libs.auth.dependencies import requires_user
...
def test_add_auth_responses_to_openapi_with_security():
    ...
    from src.skills.agents.autogpt_libs.auth.dependencies import get_user_id
...
def test_add_auth_responses_to_openapi_existing_responses():
    ...
    from src.skills.agents.autogpt_libs.auth.jwt_utils import get_jwt_payload
...
def test_add_auth_responses_to_openapi_multiple_security_schemes():
    ...
    from src.skills.agents.autogpt_libs.auth.dependencies import requires_admin_user, requires_user
    from src.skills.agents.autogpt_libs.auth.models import User
